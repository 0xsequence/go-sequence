...
func TestGetIntentConfigurationSignature(t *testing.T) {
	...
	t.Run("signature matches subdigest", func(t *testing.T) {
		...
		signature, err := sequence.GetIntentConfigurationSignature(eoa1.Address(), []*v3.CallsPayload{&payload}, &payload)
		require.NoError(t, err)
	...
	t.Run("different transactions produce different signatures", func(t *testing.T) {
		...
		sig1, err := sequence.GetIntentConfigurationSignature(eoa1.Address(), []*v3.CallsPayload{&payload1}, &payload1)
		require.NoError(t, err)

		sig2, err := sequence.GetIntentConfigurationSignature(eoa1.Address(), []*v3.CallsPayload{&payload2}, &payload2)
		require.NoError(t, err)
	...
	t.Run("same transactions produce same signatures", func(t *testing.T) {
		...
		sig1, err := sequence.GetIntentConfigurationSignature(eoa1.Address(), []*v3.CallsPayload{&payload}, &payload)
		require.NoError(t, err)

		sig2, err := sequence.GetIntentConfigurationSignature(eoa1.Address(), []*v3.CallsPayload{&payload}, &payload)
		require.NoError(t, err)
...
func TestGetIntentConfigurationSignature_MultipleTransactions(t *testing.T) {
	...
	// Create a signature
	sig, err := sequence.GetIntentConfigurationSignature(eoa1.Address(), []*v3.CallsPayload{&payload1}, &payload1)
	require.NoError(t, err)
...
func TestIntentTransactionToGuestModuleDeployAndCall(t *testing.T) {
	...
	intentConfigSig, err := sequence.GetIntentConfigurationSignature(mainSigner, []*v3.CallsPayload{&payload}, &payload)
	require.NoError(t, err)
...
func TestIntentTransactionToGuestModuleDeployAndCallMultiplePayloads(t *testing.T) {
	...
	for i, payload := range payloads {
		...
		intentConfigSig, err := sequence.GetIntentConfigurationSignature(mainSigner, payloads, payload)
		require.NoError(t, err)
