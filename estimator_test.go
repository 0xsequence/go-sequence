...
func TestEstimateSequenceMultipleSigners(t *testing.T) {
	...
	t.Run("v2", func(t *testing.T) {
		...
		walletConfig := &v2.WalletConfig{
			Threshold_: 3,
			Tree: v2.WalletConfigTreeNodes(
				&v2.WalletConfigTreeAddressLeaf{Weight: 2, Address: eoa1.Address()},
				&v2.WalletConfigTreeAddressLeaf{Weight: 5, Address: eoa2.Address()},
				&v2.WalletConfigTreeAddressLeaf{Weight: 1, Address: eoa3.Address()},
			),
		}
...
func TestEstimateSequenceNestedSigners(t *testing.T) {
	...
	t.Run("v2", func(t *testing.T) {
		...
		wal2, err := testChain.V2DummySequenceWallet(1)
		assert.NoError(t, err)
		...
		walletConfig := &v2.WalletConfig{
			...
			Tree: v2.WalletConfigTreeNodes(
				&v2.WalletConfigTreeAddressLeaf{Weight: 2, Address: eoa1.Address()},
				&v2.WalletConfigTreeAddressLeaf{Weight: 1, Address: wal2.Address()},
				&v2.WalletConfigTreeAddressLeaf{Weight: 2, Address: eoa3.Address()},
			),
		}
