...
func WebRPCSchemaHash() string {
	return "1bfcfbfaf0d9cbc4cb88e71af967670e1c5506aa"
}
...
type API interface {
	...
	GetRevealTxData(ctx context.Context, contractAddress string, chainId uint64, userAddress string) (string, error)
...
func (c *aPIClient) GetRevealTxData(ctx context.Context, contractAddress string, chainId uint64, userAddress string) (string, error) {
	in := struct {
		Arg0 string `json:"contractAddress"`
		Arg1 uint64 `json:"chainId"`
		Arg2 string `json:"userAddress"`
