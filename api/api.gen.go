// sequence-api v0.4.0 729aea557f4217e40cfa22f401f7c52ae1916924
// --
...
func WebRPCSchemaHash() string {
	return "729aea557f4217e40cfa22f401f7c52ae1916924"
}
...
func (c *aPIClient) UpdateOffchainInventory(ctx context.Context, inventory *OffchainInventory) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[74], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
