...
const WebrpcHeaderValue = "webrpc@v0.23.2;gen-golang@v0.17.0;sequence-api@v0.4.0"
...
func WebRPCSchemaHash() string {
	return "1ac0fac314dfe117706d15f13a63d49bdcec048e"
}
...
type API interface {
	...
	GetSwapQuoteV2(ctx context.Context, userAddress string, buyCurrencyAddress string, sellCurrencyAddress string, buyAmount string, chainId uint64, includeApprove bool, slippagePercentage *uint64) (*SwapQuote, error)
	//
	// Chain abstraction
	//
...
func (c *aPIClient) GetSwapQuoteV2(ctx context.Context, userAddress string, buyCurrencyAddress string, sellCurrencyAddress string, buyAmount string, chainId uint64, includeApprove bool, slippagePercentage *uint64) (*SwapQuote, error) {
	in := struct {
		Arg0 string  `json:"userAddress"`
		Arg1 string  `json:"buyCurrencyAddress"`
		Arg2 string  `json:"sellCurrencyAddress"`
