...
func WebRPCSchemaHash() string {
	return "e67451ff0658525eee95e441caca27bcab2752af"
}
...
type API interface {
	...
	GetLifiSwapRoutes(ctx context.Context, chainId uint64, toTokenAddress string, walletAddress string) ([]*LifiSwapRoute, error)
...
func (c *aPIClient) GetLifiSwapRoutes(ctx context.Context, chainId uint64, toTokenAddress string, walletAddress string) ([]*LifiSwapRoute, error) {
	in := struct {
		Arg0 uint64 `json:"chainId"`
		Arg1 string `json:"toTokenAddress"`
		Arg2 string `json:"walletAddress"`
	}{chainId, toTokenAddress, walletAddress}
	out := struct {
