// sequence-api v0.4.0 6982b401100a3d0b3e6856f4301b8712d1ff4378
// --
...
func WebRPCSchemaHash() string {
	return "6982b401100a3d0b3e6856f4301b8712d1ff4378"
}
...
const (
	SmartRampTxnStatus_UNKNOWN    SmartRampTxnStatus = 0
	SmartRampTxnStatus_SUCCESSFUL SmartRampTxnStatus = 1
	SmartRampTxnStatus_FAILED     SmartRampTxnStatus = 2
)
...
func (x SmartRampTxnStatus) String() string {
	return SmartRampTxnStatus_name[uint32(x)]
}

func (x SmartRampTxnStatus) MarshalJSON() ([]byte, error) {
	buf := bytes.NewBufferString(`"`)
	buf.WriteString(SmartRampTxnStatus_name[uint32(x)])
	buf.WriteString(`"`)
	return buf.Bytes(), nil
}
...
func (x *SmartRampTxnStatus) UnmarshalJSON(b []byte) error {
	...
	*x = SmartRampTxnStatus(SmartRampTxnStatus_value[j])
	return nil
}
...
type PayCard struct {
	...
	CardFirstNameToken       string        `json:"cardFirstNameToken" db:"card_first_name_token"`
	CardLastNameToken        string        `json:"cardLastNameToken" db:"card_last_name_token"`
	...
	ContactProvince          string        `json:"contactProvinceToken" db:"contact_province"`
	ContactPostalCodeToken   string        `json:"contactPostalCodeToken" db:"contact_postal_code_token"`
	ContactCountryCode       string        `json:"contactCountryCodeToken" db:"contact_country_code"`
	ContactEmail             string        `json:"contactEmailToken" db:"contact_email"`
...
type SmartRampQuoteRequest struct {
	...
	TokensBoughtAmounts      []string `json:"tokensBoughtAmounts"`
	MaxCurrency              string   `json:"maxCurrency"`
	ExtraFeeRecipients       []string `json:"extraFeeRecipients"`
	ExtraFeeAmounts          []string `json:"extraFeeAmounts"`
}
...
type SmartRampQuoteDetails struct {
	...
	CountryIsSupported bool                   `json:"countryIsSupported"`
...
type SmartRampPurchaseReceipt struct {
	...
	TxnSuccessful      SmartRampTxnStatus   `json:"txnSuccessful"`
}
...
type SmartRampOrder struct {
	...
	ErrorReason        string                 `json:"errorReason,omitempty" db:"error_reason"`
	...
	TxnSuccessful      SmartRampTxnStatus     `json:"txnSuccessful" db:"txn_successful"`
	UpdatedAt          *time.Time             `json:"updatedAt,omitempty" db:"updated_at,omitempty"`
	CreatedAt          *time.Time             `json:"createdAt,omitempty" db:"created_at,omitempty"`
}
