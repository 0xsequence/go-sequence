...
func WebRPCSchemaHash() string {
	return "8e3575e965dc76a152d48e0b6660271db4d0c5be"
}
...
type ContractCall struct {
	...
	Args      []*ContractCallArg `json:"args"`
}

type ContractCallArg struct {
...
type API interface {
	...
	GetAuthToken(ctx context.Context, ewtString string) (bool, string, string, *User, error)
...
func (c *aPIClient) GetAuthToken(ctx context.Context, ewtString string) (bool, string, string, *User, error) {
	in := struct {
...
func (c *aPIClient) GetInviteInfo(ctx context.Context) (*InviteInfo, error) {
	...
	err := doJSONRequest(ctx, c.client, c.urls[14], nil, &out)
	return out.Ret0, err
}
