...
func WebRPCSchemaHash() string {
	return "9e439c112c52a5710d0d53747f39d2d58a811bbe"
}
...
type API interface {
	...
	GetSwapQuoteV2(ctx context.Context, userAddress string, buyCurrencyAddress string, sellCurrencyAddress string, buyAmount *string, sellAmount *string, chainId uint64, includeApprove bool, slippagePercentage *uint64) (*SwapQuoteV2, error)
...
func (c *aPIClient) GetSwapQuoteV2(ctx context.Context, userAddress string, buyCurrencyAddress string, sellCurrencyAddress string, buyAmount *string, sellAmount *string, chainId uint64, includeApprove bool, slippagePercentage *uint64) (*SwapQuoteV2, error) {
	in := struct {
		Arg0 string  `json:"userAddress"`
		Arg1 string  `json:"buyCurrencyAddress"`
		Arg2 string  `json:"sellCurrencyAddress"`
	...
	out := struct {
		Ret0 *SwapQuoteV2 `json:"swapQuote"`
	}{}
...
func (c *aPIClient) GetLifiChains(ctx context.Context) ([]uint64, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[70], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *aPIClient) ListCurrencyGroups(ctx context.Context) ([]*CurrencyGroup, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[73], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *aPIClient) UpdateOffchainInventory(ctx context.Context, inventory *OffchainInventory) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[77], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
