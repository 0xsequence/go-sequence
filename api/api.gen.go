...
func WebRPCSchemaHash() string {
	return "ab3b6841bf983fa51a24df4cee18536199f115c3"
}
...
type SecondaryCheckoutOptionsParams struct {
...
type API interface {
	...
	GetLifiSwapRoutes(ctx context.Context, chainId uint64, toTokenAddress string, toTokenAmount string, walletAddress string) ([]*LifiSwapRoute, error)
	...
	GetPack(ctx context.Context, contractAddress string, chainId uint64) (*Pack, error)
	DeletePack(ctx context.Context, contractAddress string, chainId uint64) (bool, error)
	UpdatePackContent(ctx context.Context, pack *Pack) (string, error)
	CheckoutOptionsSecondary(ctx context.Context, chainId uint64, wallet string, params []*SecondaryCheckoutOptionsParams) (*CheckoutOptions, error)
...
func (c *aPIClient) TransakGetSupportedNFTCheckoutChains(ctx context.Context) ([]*TransakChain, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[45], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *aPIClient) GetInviteInfo(ctx context.Context) (*InviteInfo, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[51], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *aPIClient) GetLifiChains(ctx context.Context) ([]uint64, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[63], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *aPIClient) GetLifiSwapRoutes(ctx context.Context, chainId uint64, toTokenAddress string, toTokenAmount string, walletAddress string) ([]*LifiSwapRoute, error) {
	in := struct {
		Arg0 uint64 `json:"chainId"`
		Arg1 string `json:"toTokenAddress"`
		Arg2 string `json:"toTokenAmount"`
		Arg3 string `json:"walletAddress"`
	}{chainId, toTokenAddress, toTokenAmount, walletAddress}
	out := struct {
...
func (c *aPIClient) ListCurrencyGroups(ctx context.Context) ([]*CurrencyGroup, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[67], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *aPIClient) UpdateOffchainInventory(ctx context.Context, inventory *OffchainInventory) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[71], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *aPIClient) GetPack(ctx context.Context, contractAddress string, chainId uint64) (*Pack, error) {
	in := struct {
...
func (c *aPIClient) DeletePack(ctx context.Context, contractAddress string, chainId uint64) (bool, error) {
	in := struct {
		Arg0 string `json:"contractAddress"`
		Arg1 uint64 `json:"chainId"`
	}{contractAddress, chainId}
...
func (c *aPIClient) CheckoutOptionsSecondary(ctx context.Context, chainId uint64, wallet string, params []*SecondaryCheckoutOptionsParams) (*CheckoutOptions, error) {
	in := struct {
		Arg0 uint64                            `json:"chainId"`
		Arg1 string                            `json:"wallet"`
		Arg2 []*SecondaryCheckoutOptionsParams `json:"params"`
