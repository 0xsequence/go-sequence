// sequence-api v0.4.0 be6c012ef706898d27bf8ed21ec1d4c0e5c93430
// --
...
func WebRPCSchemaHash() string {
	return "be6c012ef706898d27bf8ed21ec1d4c0e5c93430"
}
...
type FortePayCreateIntent struct {
	...
	Seller          *FortePayWallet `json:"seller"`
	TransactionType string          `json:"transactionType"`
}
...
func (c *aPIClient) ListCurrencyGroups(ctx context.Context) ([]*CurrencyGroup, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[68], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *aPIClient) UpdateOffchainInventory(ctx context.Context, inventory *OffchainInventory) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[72], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
