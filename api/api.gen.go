...
func WebRPCSchemaHash() string {
	return "416e853bb8f0c0c743846ac941ea7f53b5f0683d"
}
...
type LifiToken struct {
	...
	PriceUSD prototyp.BigInt `json:"priceUsd"`
...
type API interface {
	...
	GetLifiSwapRoutes(ctx context.Context, chainId uint64, toTokenAddress string) ([]*LifiSwapRoute, error)
	GetLifiSwapQuote(ctx context.Context, userAddress string, buyCurrencyAddress string, sellCurrencyAddress string, buyAmount *string, sellAmount *string, chainId uint64, includeApprove bool, slippagePercentage *uint64) (*LifiSwapQuote, error)
	//
...
func (c *aPIClient) GetLifiSwapRoutes(ctx context.Context, chainId uint64, toTokenAddress string) ([]*LifiSwapRoute, error) {
	in := struct {
		Arg0 uint64 `json:"chainId"`
...
func (c *aPIClient) GetLifiSwapQuote(ctx context.Context, userAddress string, buyCurrencyAddress string, sellCurrencyAddress string, buyAmount *string, sellAmount *string, chainId uint64, includeApprove bool, slippagePercentage *uint64) (*LifiSwapQuote, error) {
	in := struct {
		...
		Arg4 *string `json:"sellAmount"`
		Arg5 uint64  `json:"chainId"`
		Arg6 bool    `json:"includeApprove"`
		Arg7 *uint64 `json:"slippagePercentage"`
	}{userAddress, buyCurrencyAddress, sellCurrencyAddress, buyAmount, sellAmount, chainId, includeApprove, slippagePercentage}
	out := struct {
