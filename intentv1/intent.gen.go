...
func WebRPCSchemaHash() string {
	return "b0dc5c3bceb25d04f130e1807829bd8110a0a3e4"
}
...
type SessionPacketProof struct {
...
type IntentDataOpenSession struct {
	SessionId string              `json:"sessionId"`
	Proof     *SessionPacketProof `json:"proof"`
}
...
type IntentDataSign struct {
	Network string `json:"network"`
	Message string `json:"message"`
}

type IntentDataTransaction struct {
	Network      string        `json:"network"`
