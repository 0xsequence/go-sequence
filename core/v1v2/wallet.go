...
func GenericNewWallet[C core.WalletConfig](walletOptions WalletOptions[C], signers ...sequence.Signer) (*Wallet[C], error) {
	...
	for _, signer := range signers {
		_, canSignMessage := signer.(sequence.MessageSigner)
		_, canSignDigest := signer.(sequence.DigestSigner)
...
func V1NewWallet(walletOptions WalletOptions[*v1.WalletConfig], signers ...sequence.Signer) (*Wallet[*v1.WalletConfig], error) {
	return GenericNewWallet[*v1.WalletConfig](walletOptions, signers...)
}

func V2NewWallet(walletOptions WalletOptions[*v2.WalletConfig], signers ...sequence.Signer) (*Wallet[*v2.WalletConfig], error) {
	return GenericNewWallet[*v2.WalletConfig](walletOptions, signers...)
}

func V3NewWallet(walletOptions WalletOptions[*v3.WalletConfig], signers ...sequence.Signer) (*Wallet[*v3.WalletConfig], error) {
	return GenericNewWallet[*v3.WalletConfig](walletOptions, signers...)
}

func NewWallet(walletOptions WalletOptions[*v2.WalletConfig], signers ...sequence.Signer) (*Wallet[*v2.WalletConfig], error) {
	return V2NewWallet(walletOptions, signers...)
}

func GenericNewWalletSingleOwner[C core.WalletConfig](owner sequence.Signer, optContext ...WalletContext) (*Wallet[C], error) {
	var typeOfWallet C
	...
	_, canSignMessage := owner.(sequence.MessageSigner)
	_, canSignDigest := owner.(sequence.DigestSigner)
	if !canSignMessage && !canSignDigest {
...
func V1NewWalletSingleOwner(owner sequence.Signer, optContext ...WalletContext) (*Wallet[*v1.WalletConfig], error) {
...
func V2NewWalletSingleOwner(owner sequence.Signer, optContext ...WalletContext) (*Wallet[*v2.WalletConfig], error) {
...
func V3NewWalletSingleOwner(owner sequence.Signer, optContext ...WalletContext) (*Wallet[*v3.WalletConfig], error) {
...
func NewWalletSingleOwner(owner sequence.Signer, optContext ...WalletContext) (*Wallet[*v2.WalletConfig], error) {
...
func (w *Wallet[C]) UseSigners(signers ...sequence.Signer) (*Wallet[C], error) {
	ww, err := GenericNewWallet(WalletOptions[C]{
		Config:          w.config,
		Context:         &w.context,
		SkipSortSigners: w.skipSortSigners,
...
func (w *Wallet[C]) GetSigner(address common.Address) (sequence.Signer, bool) {
	for _, s := range w.signers {
...
var _ sequence.MessageSigner = (*Wallet[*v1.WalletConfig])(nil)
var _ sequence.MessageSigner = (*Wallet[*v2.WalletConfig])(nil)
var _ sequence.MessageSigner = (*Wallet[*v3.WalletConfig])(nil)
...
var _ sequence.DigestSigner = (*Wallet[*v1.WalletConfig])(nil)
var _ sequence.DigestSigner = (*Wallet[*v2.WalletConfig])(nil)
var _ sequence.DigestSigner = (*Wallet[*v3.WalletConfig])(nil)
