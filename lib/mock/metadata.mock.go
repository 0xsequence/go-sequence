...
// Source: ../../services/metadata (interfaces: MetadataClient)
//
// Generated by this command:
//
//	mockgen -destination metadata.mock.go -package mock -mock_names MetadataClient=Metadata ../../services/metadata MetadataClient
//
...
import (
	...
	metadata "github.com/0xsequence/go-sequence/services/metadata"
	gomock "go.uber.org/mock/gomock"
)

// Metadata is a mock of MetadataClient interface.
...
func (m *Metadata) RefreshTokenMetadata(ctx context.Context, chainID, contractAddress string, tokenIDs []string, newMints *bool) (uint64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RefreshTokenMetadata", ctx, chainID, contractAddress, tokenIDs, newMints)
	ret0, _ := ret[0].(uint64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MetadataMockRecorder) RefreshTokenMetadata(ctx, chainID, contractAddress, tokenIDs, newMints any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RefreshTokenMetadata", reflect.TypeOf((*Metadata)(nil).RefreshTokenMetadata), ctx, chainID, contractAddress, tokenIDs, newMints)
}
