...
// Version: faa12009cbc85599b7f1ba9a6f75e588a8a5114a
package networks
...
var (
	...
	SONIC = Network{
		...
		Title:   "Sonic",
		Type:    NetworkTypeMainnet,
		LogoURL: "https://assets.sequence.info/images/networks/medium/146.webp",
		BlockExplorer: &BlockExplorerConfig{
			Name:    "Sonic",
	...
	HYPEREVM = Network{
		...
		Title:   "HyperEVM",
		Type:    NetworkTypeMainnet,
		LogoURL: "https://assets.sequence.info/images/networks/medium/999.webp",
		BlockExplorer: &BlockExplorerConfig{
			Name:    "HyperEVM",
	...
	TEMPO = Network{
		...
		Title:   "Tempo",
		Type:    NetworkTypeMainnet,
		LogoURL: "https://assets.sequence.info/images/networks/medium/4217.webp",
		BlockExplorer: &BlockExplorerConfig{
			Name:    "Tempo",
	...
	ARC = Network{
		...
		Title:   "ARC",
		Type:    NetworkTypeMainnet,
		LogoURL: "https://assets.sequence.info/images/networks/medium/5042.webp",
		NativeToken: &Currency{
			Symbol:   "USDC",
			Name:     "USDC",
			Decimals: 18,
	...
	BERACHAIN = Network{
		...
		Title:   "Berachain",
		Type:    NetworkTypeMainnet,
		LogoURL: "https://assets.sequence.info/images/networks/medium/80094.webp",
		BlockExplorer: &BlockExplorerConfig{
			Name:    "Berachain",
	...
	SKALE_BASE_TESTNET = Network{
		ChainID: 324705682,
		Name:    "skale-base-testnet",
		Title:   "Skale Base Testnet",
		Type:    NetworkTypeTestnet,
		LogoURL: "https://assets.sequence.info/images/networks/medium/324705682.webp",
		BlockExplorer: &BlockExplorerConfig{
			Name:    "Skale Base Testnet",
...
var ByChainID = map[uint64]*Network{
	1:          &MAINNET,
	3:          &ROPSTEN,
	4:          &RINKEBY,
	5:          &GOERLI,
