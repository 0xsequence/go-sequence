// marketplace-api v0-25.12.1+61b56ff 2026dbd876859644c798db4befaac01d792408b1
// --
...
func WebRPCSchemaVersion() string {
	return "v0-25.12.1+61b56ff"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "2026dbd876859644c798db4befaac01d792408b1"
}
...
type AdminClient interface {
	...
	AddCollectibles(ctx context.Context, chainId string, itemsContractAddress string, tokenIds []BigInt) error
}
...
type MarketplaceClient interface {
	...
	GetCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt) (*TokenMetadata, error)
	GetLowestPriceOfferForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error)
	GetHighestPriceOfferForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error)
	GetLowestPriceListingForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error)
	GetHighestPriceListingForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error)
	ListListingsForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter, page *Page) ([]*Order, *Page, error)
	ListOffersForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter, page *Page) ([]*Order, *Page, error)
	...
	GetCountOfListingsForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (uint64, error)
	GetCountOfOffersForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (uint64, error)
	// Deprecated: Please use GetLowestPriceOfferForCollectible instead.
	GetCollectibleLowestOffer(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error)
	// Deprecated: Please use GetHighestPriceOfferForCollectible instead.
	GetCollectibleHighestOffer(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error)
	// Deprecated: Please use GetLowestPriceListingForCollectible instead.
	GetCollectibleLowestListing(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error)
	// Deprecated: Please use GetHighestPriceListingForCollectible instead.
	GetCollectibleHighestListing(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error)
	// Deprecated: Please use ListListingsForCollectible instead.
	ListCollectibleListings(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter, page *Page) ([]*Order, *Page, error)
	// Deprecated: Please use ListOffersForCollectible instead.
	ListCollectibleOffers(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter, page *Page) ([]*Order, *Page, error)
	// checkout process
	GenerateBuyTransaction(ctx context.Context, chainId string, collectionAddress string, buyer string, marketplace MarketplaceKind, ordersData []*OrderData, additionalFees []*AdditionalFee, walletType *WalletKind, useWithTrails bool) (*GenerateBuySellTransactionResponse, []*Step, error)
	GenerateSellTransaction(ctx context.Context, chainId string, collectionAddress string, seller string, marketplace MarketplaceKind, ordersData []*OrderData, additionalFees []*AdditionalFee, walletType *WalletKind, useWithTrails bool) (*GenerateBuySellTransactionResponse, []*Step, error)
	...
	GetPrimarySaleItem(ctx context.Context, chainId string, primarySaleContractAddress string, tokenId BigInt) (*CollectiblePrimarySaleItem, error)
...
type CreateReq struct {
	...
	PricePerToken   prototyp.BigInt `json:"pricePerToken"`
}
...
type GenerateBuySellTransactionResponse struct {
	Steps               []*Step `json:"steps"`
	CanBeUsedWithTrails bool    `json:"canBeUsedWithTrails"`
}
...
func (c *adminClient) AddCollectibles(ctx context.Context, chainId string, itemsContractAddress string, tokenIds []BigInt) error {
	in := struct {
		Arg0 string   `json:"chainId"`
		Arg1 string   `json:"itemsContractAddress"`
		Arg2 []BigInt `json:"tokenIds"`
...
func (c *marketplaceClient) GetCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt) (*TokenMetadata, error) {
	in := struct {
		Arg0 string `json:"chainId"`
		Arg1 string `json:"contractAddress"`
		Arg2 BigInt `json:"tokenId"`
...
func (c *marketplaceClient) GetLowestPriceOfferForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetHighestPriceOfferForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetLowestPriceListingForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetHighestPriceListingForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) ListListingsForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter, page *Page) ([]*Order, *Page, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) ListOffersForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter, page *Page) ([]*Order, *Page, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetCountOfListingsForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (uint64, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetCountOfOffersForCollectible(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (uint64, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetCollectibleLowestOffer(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetCollectibleHighestOffer(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetCollectibleLowestListing(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GetCollectibleHighestListing(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter) (*Order, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) ListCollectibleListings(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter, page *Page) ([]*Order, *Page, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) ListCollectibleOffers(ctx context.Context, chainId string, contractAddress string, tokenId BigInt, filter *OrderFilter, page *Page) ([]*Order, *Page, error) {
	in := struct {
		Arg0 string       `json:"chainId"`
		Arg1 string       `json:"contractAddress"`
		Arg2 BigInt       `json:"tokenId"`
...
func (c *marketplaceClient) GenerateBuyTransaction(ctx context.Context, chainId string, collectionAddress string, buyer string, marketplace MarketplaceKind, ordersData []*OrderData, additionalFees []*AdditionalFee, walletType *WalletKind, useWithTrails bool) (*GenerateBuySellTransactionResponse, []*Step, error) {
	in := struct {
		Arg0 string           `json:"chainId"`
		...
		Arg7 bool             `json:"useWithTrails"`
	}{chainId, collectionAddress, buyer, marketplace, ordersData, additionalFees, walletType, useWithTrails}
	out := struct {
		Ret0 *GenerateBuySellTransactionResponse `json:"resp"`
		Ret1 []*Step                             `json:"steps"`
	}{}
...
func (c *marketplaceClient) GenerateSellTransaction(ctx context.Context, chainId string, collectionAddress string, seller string, marketplace MarketplaceKind, ordersData []*OrderData, additionalFees []*AdditionalFee, walletType *WalletKind, useWithTrails bool) (*GenerateBuySellTransactionResponse, []*Step, error) {
	in := struct {
		Arg0 string           `json:"chainId"`
		Arg1 string           `json:"collectionAddress"`
		...
		Arg6 *WalletKind      `json:"walletType"`
		Arg7 bool             `json:"useWithTrails"`
	}{chainId, collectionAddress, seller, marketplace, ordersData, additionalFees, walletType, useWithTrails}
	out := struct {
		Ret0 *GenerateBuySellTransactionResponse `json:"resp"`
		Ret1 []*Step                             `json:"steps"`
	}{}
...
func (c *marketplaceClient) SyncOrder(ctx context.Context, chainId string, order *Order) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[36], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *marketplaceClient) SyncOrders(ctx context.Context, chainId string, orders []*Order) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[37], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *marketplaceClient) GetPrimarySaleItem(ctx context.Context, chainId string, primarySaleContractAddress string, tokenId BigInt) (*CollectiblePrimarySaleItem, error) {
	in := struct {
		Arg0 string `json:"chainId"`
...
const WebrpcHeaderValue = "webrpc@v0.31.2;gen-golang@v0.23.3;marketplace-api@v0-25.12.1+61b56ff"
