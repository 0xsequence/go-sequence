...
const WebrpcHeaderValue = "webrpc@v0.25.4;gen-golang@v0.19.0;marketplace-api@v0.0.0-1ecb14ce28259b0a60c8b90d3e247aced7bcdfad"
...
func WebRPCSchemaHash() string {
	return "1ecb14ce28259b0a60c8b90d3e247aced7bcdfad"
}
...
var methods = map[string]method{
	...
	"/rpc/Marketplace/GetCollectionActiveListingsCurrencies": {
		name:        "GetCollectionActiveListingsCurrencies",
		service:     "Marketplace",
		annotations: map[string]string{"auth": "Public+"},
	},
	"/rpc/Marketplace/GetCollectionActiveOffersCurrencies": {
		name:        "GetCollectionActiveOffersCurrencies",
		service:     "Marketplace",
		annotations: map[string]string{"auth": "Public+"},
	},
	...
	"/rpc/Marketplace/ListOrdersWithCollectibles": {
		name:        "ListOrdersWithCollectibles",
		service:     "Marketplace",
		annotations: map[string]string{"auth": "Public+"},
	},
	"/rpc/Marketplace/GetCountOfAllOrders": {
		name:        "GetCountOfAllOrders",
		service:     "Marketplace",
		annotations: map[string]string{"auth": "Public+"},
	},
	"/rpc/Marketplace/GetCountOfFilteredOrders": {
		name:        "GetCountOfFilteredOrders",
		service:     "Marketplace",
		annotations: map[string]string{"auth": "Public+"},
	},
