// marketplace-api  3e134a7f4d3cca0f8c20a37ae3fe54c8be0b79b5
// --
// Code generated by webrpc-gen@v0.21.0 with golang generator. DO NOT EDIT.
//
...
const WebrpcHeaderValue = "webrpc@v0.21.0;gen-golang@v0.16.0;marketplace-api@v0.0.0-3e134a7f4d3cca0f8c20a37ae3fe54c8be0b79b5"
...
func WebRPCSchemaHash() string {
	return "3e134a7f4d3cca0f8c20a37ae3fe54c8be0b79b5"
}
...
var (
	methods = map[string]method{
		...
		"/rpc/Marketplace/GetCollectibleLowestOffer": {
			...
			Service:     "Marketplace",
			Annotations: map[string]string{"auth": "ApiKeyAuth", "deprecated": "GetLowestPriceOfferForCollectible"},
		},
		"/rpc/Marketplace/GetCollectibleHighestOffer": {
			Name:        "GetCollectibleHighestOffer",
			Service:     "Marketplace",
			Annotations: map[string]string{"deprecated": "GetHighestPriceOfferForCollectible"},
		},
		"/rpc/Marketplace/GetCollectibleLowestListing": {
			Name:        "GetCollectibleLowestListing",
			Service:     "Marketplace",
			Annotations: map[string]string{"deprecated": "GetLowestPriceListingForCollectible"},
		},
		"/rpc/Marketplace/GetCollectibleHighestListing": {
			Name:        "GetCollectibleHighestListing",
			Service:     "Marketplace",
			Annotations: map[string]string{"deprecated": "GetHighestPriceListingForCollectible"},
		},
		"/rpc/Marketplace/ListCollectibleListings": {
			Name:        "ListCollectibleListings",
			Service:     "Marketplace",
			Annotations: map[string]string{"deprecated": "ListListingsForCollectible"},
		},
		"/rpc/Marketplace/ListCollectibleOffers": {
			Name:        "ListCollectibleOffers",
			Service:     "Marketplace",
			Annotations: map[string]string{"deprecated": "ListOffersForCollectible"},
		},
		...
		"/rpc/Marketplace/ListCollectiblesWithLowestListing": {
			...
			Service:     "Marketplace",
			Annotations: map[string]string{"deprecated": "ListCollectibles"},
		},
...
type Marketplace interface {
	...
	GenerateSellTransaction(ctx context.Context, collectionAddress string, buyer string, marketplace MarketplaceKind, ordersData []*OrderData, additionalFees []*AdditionalFee, walletType *WalletKind) ([]*Step, error)
...
func (c *marketplaceClient) GenerateSellTransaction(ctx context.Context, collectionAddress string, buyer string, marketplace MarketplaceKind, ordersData []*OrderData, additionalFees []*AdditionalFee, walletType *WalletKind) ([]*Step, error) {
	in := struct {
		Arg0 string           `json:"collectionAddress"`
		Arg1 string           `json:"buyer"`
		Arg2 MarketplaceKind  `json:"marketplace"`
...
func (c *marketplaceClient) SyncOrder(ctx context.Context, order *Order) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[23], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *marketplaceClient) SyncOrders(ctx context.Context, orders []*Order) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[24], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
