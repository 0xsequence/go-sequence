// marketplace-api  c76c63043261af54053aa9d49186bc1862b1f212
// --
...
const WebrpcHeaderValue = "webrpc@v0.25.4;gen-golang@v0.19.0;marketplace-api@v0.0.0-c76c63043261af54053aa9d49186bc1862b1f212"
...
func WebRPCSchemaHash() string {
	return "c76c63043261af54053aa9d49186bc1862b1f212"
}
...
type Marketplace interface {
	...
	Execute(ctx context.Context, signature string, method string, endpoint string, executeType ExecuteType, body interface{}) (string, error)
	...
	SupportedMarketplaces(ctx context.Context) ([]MarketplaceKind, error)
}
...
func (c *adminClient) UpdateCollection(ctx context.Context, collection *Collection) (*Collection, error) {
	in := struct {
		Arg0 *Collection `json:"collection"`
	}{collection}
...
func (c *marketplaceClient) GetCollectionDetail(ctx context.Context, contractAddress string) (*Collection, error) {
	in := struct {
...
func (c *marketplaceClient) Execute(ctx context.Context, signature string, method string, endpoint string, executeType ExecuteType, body interface{}) (string, error) {
	in := struct {
		Arg0 string      `json:"signature"`
		Arg1 string      `json:"method"`
		Arg2 string      `json:"endpoint"`
		Arg3 ExecuteType `json:"executeType"`
		Arg4 interface{} `json:"body"`
	}{signature, method, endpoint, executeType, body}
...
func (c *marketplaceClient) ListCollectionActivities(ctx context.Context, contractAddress string, page *Page) ([]*Activity, *Page, error) {
	in := struct {
		Arg0 string `json:"contractAddress"`
		Arg1 *Page  `json:"page"`
...
func (c *marketplaceClient) ListCollectibleActivities(ctx context.Context, contractAddress string, tokenId string, page *Page) ([]*Activity, *Page, error) {
	in := struct {
		Arg0 string `json:"contractAddress"`
		Arg1 string `json:"tokenId"`
		Arg2 *Page  `json:"page"`
