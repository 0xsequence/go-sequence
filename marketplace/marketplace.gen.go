...
// --
// Code generated by webrpc-gen@v0.23.2 with golang generator. DO NOT EDIT.
//
...
const WebrpcHeaderValue = "webrpc@v0.23.2;gen-golang@v0.17.0;marketplace-api@v0.0.0-6779d2bf0321c42c065fb99e6b65d64f8e7edf2b"
...
func WebRPCSchemaHash() string {
	return "6779d2bf0321c42c065fb99e6b65d64f8e7edf2b"
}
...
var methods = map[string]method{
	...
	"/rpc/Marketplace/GetCollectibleLowestOffer": {
		...
		Service:     "Marketplace",
		Annotations: map[string]string{"auth": "Public", "deprecated": "GetLowestPriceOfferForCollectible"},
	},
	"/rpc/Marketplace/GetCollectibleHighestOffer": {
		Name:        "GetCollectibleHighestOffer",
		Service:     "Marketplace",
		Annotations: map[string]string{"auth": "Public", "deprecated": "GetHighestPriceOfferForCollectible"},
	},
	"/rpc/Marketplace/GetCollectibleLowestListing": {
		Name:        "GetCollectibleLowestListing",
		Service:     "Marketplace",
		Annotations: map[string]string{"auth": "Public", "deprecated": "GetLowestPriceListingForCollectible"},
	},
	"/rpc/Marketplace/GetCollectibleHighestListing": {
		Name:        "GetCollectibleHighestListing",
		Service:     "Marketplace",
		Annotations: map[string]string{"auth": "Public", "deprecated": "GetHighestPriceListingForCollectible"},
	},
	"/rpc/Marketplace/ListCollectibleListings": {
		Name:        "ListCollectibleListings",
		Service:     "Marketplace",
		Annotations: map[string]string{"auth": "Public", "deprecated": "ListListingsForCollectible"},
	},
	"/rpc/Marketplace/ListCollectibleOffers": {
		Name:        "ListCollectibleOffers",
		Service:     "Marketplace",
		Annotations: map[string]string{"auth": "Public", "deprecated": "ListOffersForCollectible"},
	},
...
func (c *marketplaceClient) ListListingsForCollectible(ctx context.Context, contractAddress string, tokenId string, filter *OrderFilter, skipRealtimeSync bool, page *Page) ([]*Order, *Page, error) {
	in := struct {
		Arg0 string       `json:"contractAddress"`
		Arg1 string       `json:"tokenId"`
		Arg2 *OrderFilter `json:"filter"`
		Arg3 bool         `json:"skipRealtimeSync"`
		Arg4 *Page        `json:"page"`
	}{contractAddress, tokenId, filter, skipRealtimeSync, page}
	out := struct {
...
func (c *marketplaceClient) ListOffersForCollectible(ctx context.Context, contractAddress string, tokenId string, filter *OrderFilter, skipRealtimeSync bool, page *Page) ([]*Order, *Page, error) {
	in := struct {
		Arg0 string       `json:"contractAddress"`
		Arg1 string       `json:"tokenId"`
		Arg2 *OrderFilter `json:"filter"`
