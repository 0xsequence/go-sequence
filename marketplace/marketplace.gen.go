...
const WebrpcHeaderValue = "webrpc@v0.25.4;gen-golang@v0.19.0;marketplace-api@v0.0.0-562ae69c8e00898eea9e9e9d38f207f12bb4fafe"
...
type Order struct {
	...
	CollectionID  uint64          `json:"-" db:"collection_id"`
...
type Admin interface {
	...
	SyncCollection(ctx context.Context, chainId string, projectId uint64, contractAddress string) (*Collection, error)
...
func (c *adminClient) SyncCollection(ctx context.Context, chainId string, projectId uint64, contractAddress string) (*Collection, error) {
	in := struct {
		Arg0 string `json:"chainId"`
		Arg1 uint64 `json:"projectId"`
		Arg2 string `json:"contractAddress"`
