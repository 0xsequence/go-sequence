...
const WebrpcHeaderValue = "webrpc@v0.21.0;gen-golang@v0.16.0;marketplace-api@v0.0.0-c4b7ef1ced16008a3b9f68056173ffb008f08a3c"
...
func WebRPCSchemaHash() string {
	return "c4b7ef1ced16008a3b9f68056173ffb008f08a3c"
}
...
func (c *marketplaceClient) SyncOrder(ctx context.Context, order *Order) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[25], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *marketplaceClient) SyncOrders(ctx context.Context, orders []*Order) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[26], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
