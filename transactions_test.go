...
func TestTransactionToGuestModuleBasic(t *testing.T) {
	...
	t.Run("v3", func(t *testing.T) {
		...
		metaTxnID, err := v3.HashPayload(sender.Address(), testChain.ChainID(), payload)
		assert.NoError(t, err)

		metaTxnHash := common.BytesToHash(metaTxnID[:])
		metaTxnIDStr := sequence.MetaTxnID(metaTxnHash.Hex())
		...
		result, _, _, err := sequence.FetchMetaTransactionReceipt(context.Background(), testChain.ReceiptsListener, metaTxnIDStr)
		assert.NoError(t, err)
...
func TestTransactionToGuestModuleDeployAndCall(t *testing.T) {
	...
	t.Run("v3", func(t *testing.T) {
		...
		metaTxnID, err := v3.HashPayload(wallet.Address(), testChain.ChainID(), payload)
		assert.NoError(t, err)
...
func TestRawTransactionsEncoding(t *testing.T) {
	data, err := hex.DecodeString("")
	assert.NoError(t, err)
