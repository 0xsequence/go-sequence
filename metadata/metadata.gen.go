...
func WebRPCSchemaHash() string {
	return "3f6b0f4aa1a7b58488e9399c277fc17995d74f5a"
}
...
type Metadata interface {
	...
	SearchTokenMetadata(ctx context.Context, chainID string, contractAddress string, filter string, page *Page) (*Page, []*TokenMetadata, error)
	SearchTokenIDs(ctx context.Context, chainID string, contractAddress string, filter string, page *Page) (*Page, []string, error)
...
func (c *metadataClient) SearchTokenMetadata(ctx context.Context, chainID string, contractAddress string, filter string, page *Page) (*Page, []*TokenMetadata, error) {
	in := struct {
		Arg0 string `json:"chainID"`
		Arg1 string `json:"contractAddress"`
		Arg2 string `json:"filter"`
		Arg3 *Page  `json:"page"`
...
func (c *metadataClient) SearchTokenIDs(ctx context.Context, chainID string, contractAddress string, filter string, page *Page) (*Page, []string, error) {
	in := struct {
		Arg0 string `json:"chainID"`
		Arg1 string `json:"contractAddress"`
		Arg2 string `json:"filter"`
