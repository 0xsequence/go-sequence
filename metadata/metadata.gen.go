...
const WebrpcHeaderValue = "webrpc@v0.23.2;gen-golang@v0.17.0;sequence-metadata@v0.4.0"
...
func WebRPCSchemaHash() string {
	return "9594f86f8681f364dd514a1bd7cae1c1dc77e3de"
}
...
const (
	...
	Source_SEQUENCE_BUILDER_COLLECTIONS      Source = 0x81
)
...
var Source_name = map[uint8]string{
	...
	0x81: "SEQUENCE_BUILDER_COLLECTIONS",
}
...
var Source_value = map[string]uint8{
	...
	"SEQUENCE_BUILDER_COLLECTIONS":      0x81,
}
...
type Metadata interface {
	...
	RefreshContractTokens(ctx context.Context, chainHandle string, contractAddress string, tokenIDs []string) (*uint64, error)
...
func (c *metadataClient) RefreshContractTokens(ctx context.Context, chainHandle string, contractAddress string, tokenIDs []string) (*uint64, error) {
	in := struct {
		Arg0 string   `json:"chainHandle"`
		Arg1 string   `json:"contractAddress"`
		Arg2 []string `json:"tokenIDs"`
