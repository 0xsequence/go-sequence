...
func WebRPCSchemaHash() string {
	return "eb101fbae674de87b532432e85ce7694ccee2212"
}
...
type Admin interface {
	...
	AddContractInfoOverride(ctx context.Context, chainID string, contractAddress string, contractInfoOverride *ContractInfoOverride) error
	UpdateContractInfoOverride(ctx context.Context, chainID string, contractAddress string, contractInfoOverride *ContractInfoOverride) error
	...
	SetTokenDirectoryFeatureIndex(ctx context.Context, chainID string, contractAddress string, featureIndex uint8) error
	AddContractToTokenDirectory(ctx context.Context, chainID string, contractAddress string) error
...
func (c *adminClient) AddContractInfoOverride(ctx context.Context, chainID string, contractAddress string, contractInfoOverride *ContractInfoOverride) error {
	in := struct {
		Arg0 string                `json:"chainID"`
		Arg1 string                `json:"contractAddress"`
...
func (c *adminClient) UpdateContractInfoOverride(ctx context.Context, chainID string, contractAddress string, contractInfoOverride *ContractInfoOverride) error {
	in := struct {
		Arg0 string                `json:"chainID"`
		Arg1 string                `json:"contractAddress"`
		Arg2 *ContractInfoOverride `json:"contractInfoOverride"`
...
func (c *adminClient) SetTokenDirectoryFeatureIndex(ctx context.Context, chainID string, contractAddress string, featureIndex uint8) error {
	in := struct {
		Arg0 string `json:"chainID"`
		Arg1 string `json:"contractAddress"`
...
func (c *adminClient) AddContractToTokenDirectory(ctx context.Context, chainID string, contractAddress string) error {
	in := struct {
		Arg0 string `json:"chainID"`
		Arg1 string `json:"contractAddress"`
	}{chainID, contractAddress}
