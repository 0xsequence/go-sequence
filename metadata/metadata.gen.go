// sequence-metadata v0.4.0 7cd2d21d284379078f35906687a348ebecb44a36
// --
// Code generated by webrpc-gen@v0.20.3 with golang generator. DO NOT EDIT.
//
// webrpc-gen -schema=proto/metadata.ridl -target=golang -pkg=metadata -server -client -out=proto/clients/metadata.gen.go
package metadata
...
func WebRPCSchemaHash() string {
	return "7cd2d21d284379078f35906687a348ebecb44a36"
}
...
func (s *metadataServer) serveGetContractInfoJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.Metadata.GetContractInfo(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *metadataServer) serveGetContractInfoBatchJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.Metadata.GetContractInfoBatch(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
