// sequence-metadata v0.4.0 cfb30e2d7e41a5270c5c51c7fc4369234fc7b3f3
// --
...
func WebRPCSchemaHash() string {
	return "cfb30e2d7e41a5270c5c51c7fc4369234fc7b3f3"
}
...
type Metadata interface {
	...
	RefreshTokenMetadata(ctx context.Context, chainID string, contractAddress string, tokenIDs []string, refreshAll *bool) (map[string]bool, error)
	...
	SearchMetadata(ctx context.Context, filter string) ([]*TokenMetadata, []*ContractInfo, error)
...
func (c *metadataClient) RefreshTokenMetadata(ctx context.Context, chainID string, contractAddress string, tokenIDs []string, refreshAll *bool) (map[string]bool, error) {
	in := struct {
		Arg0 string   `json:"chainID"`
		Arg1 string   `json:"contractAddress"`
		Arg2 []string `json:"tokenIDs"`
	...
	out := struct {
		Ret0 map[string]bool `json:"status"`
	}{}
...
func (c *metadataClient) SearchMetadata(ctx context.Context, filter string) ([]*TokenMetadata, []*ContractInfo, error) {
	in := struct {
