// sequence-metadata v0.4.0 1672b357567e66d10c8d9392638f9089c26a3082
// --
// Code generated by webrpc-gen@v0.14.0-dev with golang@v0.10.0 generator. DO NOT EDIT.
//
// webrpc-gen -schema=./proto/metadata.ridl -target=golang@v0.10.0 -pkg=metadata -client -out=../../go-sequence/metadata/metadata.gen.go
package metadata
...
func WebRPCSchemaHash() string {
	return "1672b357567e66d10c8d9392638f9089c26a3082"
}
...
type Collection struct {
	...
	ProjectID     uint64              `json:"project_id,omitempty" db:"project_id"`
	Name          string              `json:"name,omitempty" db:"name"`
	Description   string              `json:"description,omitempty" db:"description"`
	TitleImageUrl string              `json:"title_image_url,omitempty" db:"title_image_url"`
	ExternalLink  string              `json:"external_link,omitempty" db:"external_link"`
	Private       bool                `json:"private,omitempty" db:"private"`
	RevealKey     string              `json:"reveal_key,omitempty" db:"reveal_key"`
...
type Token struct {
	CollectionID  uint64          `json:"collectionId" db:"collection_id"`
	TokenID       prototyp.BigInt `json:"tokenId" db:"token_id"`
	TokenMetadata *TokenMetadata  `json:"tokenMetadata" db:"metadata"`
...
type Collections interface {
	...
	PublishCollectionTokens(ctx context.Context, projectId *uint64, collectionId uint64) (*Collection, error)
	UnpublishCollectionTokens(ctx context.Context, projectId *uint64, collectionId uint64) (*Collection, error)
	...
	CreateToken(ctx context.Context, projectId *uint64, collectionId uint64, token *TokenMetadata) (*TokenMetadata, []*Asset, error)
	...
	UpdateToken(ctx context.Context, projectId *uint64, collectionId uint64, token *TokenMetadata) (*TokenMetadata, error)
...
var WebRPCServices = map[string][]string{
	...
	"Collections": {
		...
		"PublishCollection",
		"UnpublishCollection",
		"PublishCollectionTokens",
		"UnpublishCollectionTokens",
		"CreateAsset",
		"GetAsset",
		"UpdateAsset",
		"DeleteAsset",
...
func NewCollectionsClient(addr string, client HTTPClient) Collections {
	...
	urls := [18]string{
		...
		prefix + "PublishCollectionTokens",
		prefix + "UnpublishCollectionTokens",
		prefix + "CreateAsset",
		prefix + "GetAsset",
		prefix + "UpdateAsset",
		prefix + "DeleteAsset",
...
func (c *collectionsClient) PublishCollection(ctx context.Context, projectId *uint64, collectionId uint64) (*Collection, error) {
	in := struct {
		Arg0 *uint64 `json:"projectId"`
		Arg1 uint64  `json:"collectionId"`
	}{projectId, collectionId}
...
func (c *collectionsClient) PublishCollectionTokens(ctx context.Context, projectId *uint64, collectionId uint64) (*Collection, error) {
	in := struct {
		Arg0 *uint64 `json:"projectId"`
		Arg1 uint64  `json:"collectionId"`
	}{projectId, collectionId}
...
func (c *collectionsClient) UnpublishCollectionTokens(ctx context.Context, projectId *uint64, collectionId uint64) (*Collection, error) {
	in := struct {
		Arg0 *uint64 `json:"projectId"`
		Arg1 uint64  `json:"collectionId"`
	}{projectId, collectionId}
...
func (c *collectionsClient) CreateToken(ctx context.Context, projectId *uint64, collectionId uint64, token *TokenMetadata) (*TokenMetadata, []*Asset, error) {
	in := struct {
		Arg0 *uint64        `json:"projectId"`
		Arg1 uint64         `json:"collectionId"`
		Arg2 *TokenMetadata `json:"token"`
	}{projectId, collectionId, token}
	out := struct {
...
func (c *collectionsClient) UpdateToken(ctx context.Context, projectId *uint64, collectionId uint64, token *TokenMetadata) (*TokenMetadata, error) {
	in := struct {
		Arg0 *uint64        `json:"projectId"`
		Arg1 uint64         `json:"collectionId"`
		Arg2 *TokenMetadata `json:"token"`
