// sequence-metadata v0.4.0 2ca197b5777be8adc30b6de15a8fa6c1c504c71f
// --
...
func WebRPCSchemaHash() string {
	return "2ca197b5777be8adc30b6de15a8fa6c1c504c71f"
}
...
type TokenMetadataStatus uint32

const (
	TokenMetadataStatus_NOT_AVAILABLE TokenMetadataStatus = 0
	TokenMetadataStatus_STALE         TokenMetadataStatus = 1
	TokenMetadataStatus_AVAILABLE     TokenMetadataStatus = 2
)

var TokenMetadataStatus_name = map[uint32]string{
	0: "NOT_AVAILABLE",
	1: "STALE",
	2: "AVAILABLE",
}

var TokenMetadataStatus_value = map[string]uint32{
	"NOT_AVAILABLE": 0,
	"STALE":         1,
	"AVAILABLE":     2,
}

func (x TokenMetadataStatus) String() string {
	return TokenMetadataStatus_name[uint32(x)]
}

func (x TokenMetadataStatus) MarshalText() ([]byte, error) {
	return []byte(TokenMetadataStatus_name[uint32(x)]), nil
}

func (x *TokenMetadataStatus) UnmarshalText(b []byte) error {
	*x = TokenMetadataStatus(TokenMetadataStatus_value[string(b)])
	return nil
}

func (x *TokenMetadataStatus) Is(values ...TokenMetadataStatus) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
type TokenMetadata struct {
	...
	Status      TokenMetadataStatus `json:"status"`
	QueuedAt    *time.Time          `json:"queuedAt"`
