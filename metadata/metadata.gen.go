// sequence-metadata v0.4.0 f9f09c18a3354025773308abe3e74f46847bc342
// --
// Code generated by webrpc-gen@v0.25.2 with golang generator. DO NOT EDIT.
//
...
const WebrpcHeaderValue = "webrpc@v0.25.2;gen-golang@v0.18.3;sequence-metadata@v0.4.0"
...
func WebRPCSchemaHash() string {
	return "f9f09c18a3354025773308abe3e74f46847bc342"
}
...
type Metadata interface {
	...
	SearchTokenMetadataByQuery(ctx context.Context, q string, chainID *string, page *Page) ([]*TokenMetadata, *Page, error)
...
type Admin interface {
	...
	GetContractInfoOverrides(ctx context.Context, chainID *string, page *Page) ([]*ContractInfo, *Page, error)
	AddContractInfoOverride(ctx context.Context, contractInfoOverride *ContractInfo) error
	UpdateContractInfoOverride(ctx context.Context, contractInfoOverride *ContractInfo) error
	RemoveContractInfoOverride(ctx context.Context, chainID string, contractAddress string) error
	// Token Directory
	AddContractToTokenDirectory(ctx context.Context, chainID string, contractAddress string, featureIndex int) error
	RemoveContractFromTokenDirectory(ctx context.Context, chainID string, contractAddress string) error
...
func (c *metadataClient) SearchTokenMetadataByQuery(ctx context.Context, q string, chainID *string, page *Page) ([]*TokenMetadata, *Page, error) {
	in := struct {
		Arg0 string  `json:"q"`
		Arg1 *string `json:"chainID"`
		Arg2 *Page   `json:"page"`
...
func (c *adminClient) GetContractInfoOverrides(ctx context.Context, chainID *string, page *Page) ([]*ContractInfo, *Page, error) {
	in := struct {
		Arg0 *string `json:"chainID"`
		Arg1 *Page   `json:"page"`
	}{chainID, page}
	out := struct {
		Ret0 []*ContractInfo `json:"contractInfoOverrides"`
		Ret1 *Page           `json:"page"`
	}{}
...
func (c *adminClient) AddContractInfoOverride(ctx context.Context, contractInfoOverride *ContractInfo) error {
	in := struct {
		Arg0 *ContractInfo `json:"contractInfoOverride"`
...
func (c *adminClient) UpdateContractInfoOverride(ctx context.Context, contractInfoOverride *ContractInfo) error {
	in := struct {
		Arg0 *ContractInfo `json:"contractInfoOverride"`
	}{contractInfoOverride}
...
func (c *adminClient) RemoveContractInfoOverride(ctx context.Context, chainID string, contractAddress string) error {
	in := struct {
		Arg0 string `json:"chainID"`
		Arg1 string `json:"contractAddress"`
	}{chainID, contractAddress}
...
func (c *adminClient) AddContractToTokenDirectory(ctx context.Context, chainID string, contractAddress string, featureIndex int) error {
	in := struct {
		Arg0 string `json:"chainID"`
		Arg1 string `json:"contractAddress"`
		Arg2 int    `json:"featureIndex"`
...
func (c *adminClient) RemoveContractFromTokenDirectory(ctx context.Context, chainID string, contractAddress string) error {
	in := struct {
		Arg0 string `json:"chainID"`
		Arg1 string `json:"contractAddress"`
	}{chainID, contractAddress}
