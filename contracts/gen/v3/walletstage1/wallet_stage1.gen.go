...
// WalletStage1AbortedIterator is returned from FilterAborted and is used to iterate over the raw logs and unpacked data for Aborted events raised by the WalletStage1 contract.
type WalletStage1AbortedIterator struct {
	Event *WalletStage1Aborted // Event containing the contract specifics and raw log
...
func (it *WalletStage1AbortedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WalletStage1Aborted)
...
func (it *WalletStage1AbortedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WalletStage1AbortedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WalletStage1Aborted represents a Aborted event raised by the WalletStage1 contract.
type WalletStage1Aborted struct {
	OpHash [32]byte
	Index  *big.Int
...
func (_WalletStage1 *WalletStage1Filterer) FilterAborted(opts *bind.FilterOpts) (*WalletStage1AbortedIterator, error) {

	logs, sub, err := _WalletStage1.contract.FilterLogs(opts, "Aborted")
	if err != nil {
		return nil, err
	}
	return &WalletStage1AbortedIterator{contract: _WalletStage1.contract, event: "Aborted", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Aborted(bytes32 _opHash, uint256 _index)
func (_WalletStage1 *WalletStage1Filterer) WatchAborted(opts *bind.WatchOpts, sink chan<- *WalletStage1Aborted) (event.Subscription, error) {

	logs, sub, err := _WalletStage1.contract.WatchLogs(opts, "Aborted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(WalletStage1Aborted)
				if err := _WalletStage1.contract.UnpackLog(event, "Aborted", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Aborted(bytes32 _opHash, uint256 _index)
func (_WalletStage1 *WalletStage1Filterer) ParseAborted(log types.Log) (*WalletStage1Aborted, error) {
	event := new(WalletStage1Aborted)
	if err := _WalletStage1.contract.UnpackLog(event, "Aborted", log); err != nil {
		return nil, err
	}
...
// WalletStage1FailedIterator is returned from FilterFailed and is used to iterate over the raw logs and unpacked data for Failed events raised by the WalletStage1 contract.
type WalletStage1FailedIterator struct {
	Event *WalletStage1Failed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *WalletStage1FailedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WalletStage1Failed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *WalletStage1FailedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WalletStage1FailedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WalletStage1Failed represents a Failed event raised by the WalletStage1 contract.
type WalletStage1Failed struct {
	OpHash [32]byte
	Index  *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_WalletStage1 *WalletStage1Filterer) FilterFailed(opts *bind.FilterOpts) (*WalletStage1FailedIterator, error) {

	logs, sub, err := _WalletStage1.contract.FilterLogs(opts, "Failed")
	if err != nil {
		return nil, err
	}
	return &WalletStage1FailedIterator{contract: _WalletStage1.contract, event: "Failed", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Failed(bytes32 _opHash, uint256 _index)
func (_WalletStage1 *WalletStage1Filterer) WatchFailed(opts *bind.WatchOpts, sink chan<- *WalletStage1Failed) (event.Subscription, error) {

	logs, sub, err := _WalletStage1.contract.WatchLogs(opts, "Failed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(WalletStage1Failed)
				if err := _WalletStage1.contract.UnpackLog(event, "Failed", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Failed(bytes32 _opHash, uint256 _index)
func (_WalletStage1 *WalletStage1Filterer) ParseFailed(log types.Log) (*WalletStage1Failed, error) {
	event := new(WalletStage1Failed)
	if err := _WalletStage1.contract.UnpackLog(event, "Failed", log); err != nil {
		return nil, err
	}
...
// WalletStage1SkippedIterator is returned from FilterSkipped and is used to iterate over the raw logs and unpacked data for Skipped events raised by the WalletStage1 contract.
type WalletStage1SkippedIterator struct {
	Event *WalletStage1Skipped // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *WalletStage1SkippedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WalletStage1Skipped)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *WalletStage1SkippedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WalletStage1SkippedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WalletStage1Skipped represents a Skipped event raised by the WalletStage1 contract.
type WalletStage1Skipped struct {
	OpHash [32]byte
	Index  *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_WalletStage1 *WalletStage1Filterer) FilterSkipped(opts *bind.FilterOpts) (*WalletStage1SkippedIterator, error) {

	logs, sub, err := _WalletStage1.contract.FilterLogs(opts, "Skipped")
	if err != nil {
		return nil, err
	}
	return &WalletStage1SkippedIterator{contract: _WalletStage1.contract, event: "Skipped", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Skipped(bytes32 _opHash, uint256 _index)
func (_WalletStage1 *WalletStage1Filterer) WatchSkipped(opts *bind.WatchOpts, sink chan<- *WalletStage1Skipped) (event.Subscription, error) {

	logs, sub, err := _WalletStage1.contract.WatchLogs(opts, "Skipped")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(WalletStage1Skipped)
				if err := _WalletStage1.contract.UnpackLog(event, "Skipped", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Skipped(bytes32 _opHash, uint256 _index)
func (_WalletStage1 *WalletStage1Filterer) ParseSkipped(log types.Log) (*WalletStage1Skipped, error) {
	event := new(WalletStage1Skipped)
	if err := _WalletStage1.contract.UnpackLog(event, "Skipped", log); err != nil {
		return nil, err
	}
...
// WalletStage1SuccessIterator is returned from FilterSuccess and is used to iterate over the raw logs and unpacked data for Success events raised by the WalletStage1 contract.
type WalletStage1SuccessIterator struct {
	Event *WalletStage1Success // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *WalletStage1SuccessIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(WalletStage1Success)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *WalletStage1SuccessIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *WalletStage1SuccessIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// WalletStage1Success represents a Success event raised by the WalletStage1 contract.
type WalletStage1Success struct {
	OpHash [32]byte
	Index  *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_WalletStage1 *WalletStage1Filterer) FilterSuccess(opts *bind.FilterOpts) (*WalletStage1SuccessIterator, error) {

	logs, sub, err := _WalletStage1.contract.FilterLogs(opts, "Success")
	if err != nil {
		return nil, err
	}
	return &WalletStage1SuccessIterator{contract: _WalletStage1.contract, event: "Success", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Success(bytes32 _opHash, uint256 _index)
func (_WalletStage1 *WalletStage1Filterer) WatchSuccess(opts *bind.WatchOpts, sink chan<- *WalletStage1Success) (event.Subscription, error) {

	logs, sub, err := _WalletStage1.contract.WatchLogs(opts, "Success")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(WalletStage1Success)
				if err := _WalletStage1.contract.UnpackLog(event, "Success", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Success(bytes32 _opHash, uint256 _index)
func (_WalletStage1 *WalletStage1Filterer) ParseSuccess(log types.Log) (*WalletStage1Success, error) {
	event := new(WalletStage1Success)
	if err := _WalletStage1.contract.UnpackLog(event, "Success", log); err != nil {
		return nil, err
	}
