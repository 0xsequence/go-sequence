...
// Stage2ModuleMetaData contains all meta data concerning the Stage2Module contract.
var Stage2ModuleMetaData = &bind.MetaData{
...
// Stage2ModuleABI is the input ABI used to generate the binding from.
// Deprecated: Use Stage2ModuleMetaData.ABI instead.
var Stage2ModuleABI = Stage2ModuleMetaData.ABI

// Stage2ModuleBin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use Stage2ModuleMetaData.Bin instead.
var Stage2ModuleBin = Stage2ModuleMetaData.Bin

// DeployStage2Module deploys a new Ethereum contract, binding an instance of Stage2Module to it.
func DeployStage2Module(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *Stage2Module, error) {
	parsed, err := Stage2ModuleMetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(Stage2ModuleBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &Stage2Module{Stage2ModuleCaller: Stage2ModuleCaller{contract: contract}, Stage2ModuleTransactor: Stage2ModuleTransactor{contract: contract}, Stage2ModuleFilterer: Stage2ModuleFilterer{contract: contract}}, nil
}

// Stage2Module is an auto generated Go binding around an Ethereum contract.
type Stage2Module struct {
	Stage2ModuleCaller     // Read-only binding to the contract
	Stage2ModuleTransactor // Write-only binding to the contract
	Stage2ModuleFilterer   // Log filterer for contract events
}

// Stage2ModuleCaller is an auto generated read-only Go binding around an Ethereum contract.
type Stage2ModuleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Stage2ModuleTransactor is an auto generated write-only Go binding around an Ethereum contract.
type Stage2ModuleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Stage2ModuleFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type Stage2ModuleFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Stage2ModuleSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type Stage2ModuleSession struct {
	Contract     *Stage2Module     // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// Stage2ModuleCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type Stage2ModuleCallerSession struct {
	Contract *Stage2ModuleCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts       // Call options to use throughout this session
}

// Stage2ModuleTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type Stage2ModuleTransactorSession struct {
	Contract     *Stage2ModuleTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts       // Transaction auth options to use throughout this session
}

// Stage2ModuleRaw is an auto generated low-level Go binding around an Ethereum contract.
type Stage2ModuleRaw struct {
	Contract *Stage2Module // Generic contract binding to access the raw methods on
}

// Stage2ModuleCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type Stage2ModuleCallerRaw struct {
	Contract *Stage2ModuleCaller // Generic read-only contract binding to access the raw methods on
}

// Stage2ModuleTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type Stage2ModuleTransactorRaw struct {
	Contract *Stage2ModuleTransactor // Generic write-only contract binding to access the raw methods on
}

// NewStage2Module creates a new instance of Stage2Module, bound to a specific deployed contract.
func NewStage2Module(address common.Address, backend bind.ContractBackend) (*Stage2Module, error) {
	contract, err := bindStage2Module(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &Stage2Module{Stage2ModuleCaller: Stage2ModuleCaller{contract: contract}, Stage2ModuleTransactor: Stage2ModuleTransactor{contract: contract}, Stage2ModuleFilterer: Stage2ModuleFilterer{contract: contract}}, nil
}

// NewStage2ModuleCaller creates a new read-only instance of Stage2Module, bound to a specific deployed contract.
func NewStage2ModuleCaller(address common.Address, caller bind.ContractCaller) (*Stage2ModuleCaller, error) {
	contract, err := bindStage2Module(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleCaller{contract: contract}, nil
}

// NewStage2ModuleTransactor creates a new write-only instance of Stage2Module, bound to a specific deployed contract.
func NewStage2ModuleTransactor(address common.Address, transactor bind.ContractTransactor) (*Stage2ModuleTransactor, error) {
	contract, err := bindStage2Module(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleTransactor{contract: contract}, nil
}

// NewStage2ModuleFilterer creates a new log filterer instance of Stage2Module, bound to a specific deployed contract.
func NewStage2ModuleFilterer(address common.Address, filterer bind.ContractFilterer) (*Stage2ModuleFilterer, error) {
	contract, err := bindStage2Module(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleFilterer{contract: contract}, nil
}

// bindStage2Module binds a generic wrapper to an already deployed contract.
func bindStage2Module(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := Stage2ModuleMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
// returns.
func (_Stage2Module *Stage2ModuleRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Stage2Module.Contract.Stage2ModuleCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Stage2Module *Stage2ModuleRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Stage2Module.Contract.Stage2ModuleTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_Stage2Module *Stage2ModuleRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Stage2Module.Contract.Stage2ModuleTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_Stage2Module *Stage2ModuleCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Stage2Module.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Stage2Module *Stage2ModuleTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Stage2Module.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_Stage2Module *Stage2ModuleTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Stage2Module.Contract.contract.Transact(opts, method, params...)
}

// GetImplementation is a free data retrieval call binding the contract method 0xaaf10f42.
//
// Solidity: function getImplementation() view returns(address)
func (_Stage2Module *Stage2ModuleCaller) GetImplementation(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "getImplementation")
...
//
// Solidity: function getImplementation() view returns(address)
func (_Stage2Module *Stage2ModuleSession) GetImplementation() (common.Address, error) {
	return _Stage2Module.Contract.GetImplementation(&_Stage2Module.CallOpts)
}

// GetImplementation is a free data retrieval call binding the contract method 0xaaf10f42.
//
// Solidity: function getImplementation() view returns(address)
func (_Stage2Module *Stage2ModuleCallerSession) GetImplementation() (common.Address, error) {
	return _Stage2Module.Contract.GetImplementation(&_Stage2Module.CallOpts)
}
...
func (_Stage2Module *Stage2ModuleCaller) ImageHash(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "imageHash")
...
//
// Solidity: function imageHash() view returns(bytes32)
func (_Stage2Module *Stage2ModuleSession) ImageHash() ([32]byte, error) {
	return _Stage2Module.Contract.ImageHash(&_Stage2Module.CallOpts)
}

// ImageHash is a free data retrieval call binding the contract method 0x51605d80.
//
// Solidity: function imageHash() view returns(bytes32)
func (_Stage2Module *Stage2ModuleCallerSession) ImageHash() ([32]byte, error) {
	return _Stage2Module.Contract.ImageHash(&_Stage2Module.CallOpts)
}
...
func (_Stage2Module *Stage2ModuleCaller) IsValidSapientSignature(opts *bind.CallOpts, _payload PayloadDecoded, _signature []byte) ([32]byte, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "isValidSapientSignature", _payload, _signature)
...
//
// Solidity: function isValidSapientSignature((uint8,bool,(address,uint256,bytes,uint256,bool,bool,uint256)[],uint256,uint256,bytes,bytes32,bytes32,address[]) _payload, bytes _signature) view returns(bytes32)
func (_Stage2Module *Stage2ModuleSession) IsValidSapientSignature(_payload PayloadDecoded, _signature []byte) ([32]byte, error) {
	return _Stage2Module.Contract.IsValidSapientSignature(&_Stage2Module.CallOpts, _payload, _signature)
}

// IsValidSapientSignature is a free data retrieval call binding the contract method 0xca707850.
//
// Solidity: function isValidSapientSignature((uint8,bool,(address,uint256,bytes,uint256,bool,bool,uint256)[],uint256,uint256,bytes,bytes32,bytes32,address[]) _payload, bytes _signature) view returns(bytes32)
func (_Stage2Module *Stage2ModuleCallerSession) IsValidSapientSignature(_payload PayloadDecoded, _signature []byte) ([32]byte, error) {
	return _Stage2Module.Contract.IsValidSapientSignature(&_Stage2Module.CallOpts, _payload, _signature)
}
...
func (_Stage2Module *Stage2ModuleCaller) IsValidSignature(opts *bind.CallOpts, _hash [32]byte, _signature []byte) ([4]byte, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "isValidSignature", _hash, _signature)
...
//
// Solidity: function isValidSignature(bytes32 _hash, bytes _signature) view returns(bytes4)
func (_Stage2Module *Stage2ModuleSession) IsValidSignature(_hash [32]byte, _signature []byte) ([4]byte, error) {
	return _Stage2Module.Contract.IsValidSignature(&_Stage2Module.CallOpts, _hash, _signature)
}

// IsValidSignature is a free data retrieval call binding the contract method 0x1626ba7e.
//
// Solidity: function isValidSignature(bytes32 _hash, bytes _signature) view returns(bytes4)
func (_Stage2Module *Stage2ModuleCallerSession) IsValidSignature(_hash [32]byte, _signature []byte) ([4]byte, error) {
	return _Stage2Module.Contract.IsValidSignature(&_Stage2Module.CallOpts, _hash, _signature)
}
...
func (_Stage2Module *Stage2ModuleCaller) OnERC1155BatchReceived(opts *bind.CallOpts, arg0 common.Address, arg1 common.Address, arg2 []*big.Int, arg3 []*big.Int, arg4 []byte) ([4]byte, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "onERC1155BatchReceived", arg0, arg1, arg2, arg3, arg4)
...
//
// Solidity: function onERC1155BatchReceived(address , address , uint256[] , uint256[] , bytes ) pure returns(bytes4)
func (_Stage2Module *Stage2ModuleSession) OnERC1155BatchReceived(arg0 common.Address, arg1 common.Address, arg2 []*big.Int, arg3 []*big.Int, arg4 []byte) ([4]byte, error) {
	return _Stage2Module.Contract.OnERC1155BatchReceived(&_Stage2Module.CallOpts, arg0, arg1, arg2, arg3, arg4)
}

// OnERC1155BatchReceived is a free data retrieval call binding the contract method 0xbc197c81.
//
// Solidity: function onERC1155BatchReceived(address , address , uint256[] , uint256[] , bytes ) pure returns(bytes4)
func (_Stage2Module *Stage2ModuleCallerSession) OnERC1155BatchReceived(arg0 common.Address, arg1 common.Address, arg2 []*big.Int, arg3 []*big.Int, arg4 []byte) ([4]byte, error) {
	return _Stage2Module.Contract.OnERC1155BatchReceived(&_Stage2Module.CallOpts, arg0, arg1, arg2, arg3, arg4)
}
...
func (_Stage2Module *Stage2ModuleCaller) OnERC1155Received(opts *bind.CallOpts, arg0 common.Address, arg1 common.Address, arg2 *big.Int, arg3 *big.Int, arg4 []byte) ([4]byte, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "onERC1155Received", arg0, arg1, arg2, arg3, arg4)
...
//
// Solidity: function onERC1155Received(address , address , uint256 , uint256 , bytes ) pure returns(bytes4)
func (_Stage2Module *Stage2ModuleSession) OnERC1155Received(arg0 common.Address, arg1 common.Address, arg2 *big.Int, arg3 *big.Int, arg4 []byte) ([4]byte, error) {
	return _Stage2Module.Contract.OnERC1155Received(&_Stage2Module.CallOpts, arg0, arg1, arg2, arg3, arg4)
}

// OnERC1155Received is a free data retrieval call binding the contract method 0xf23a6e61.
//
// Solidity: function onERC1155Received(address , address , uint256 , uint256 , bytes ) pure returns(bytes4)
func (_Stage2Module *Stage2ModuleCallerSession) OnERC1155Received(arg0 common.Address, arg1 common.Address, arg2 *big.Int, arg3 *big.Int, arg4 []byte) ([4]byte, error) {
	return _Stage2Module.Contract.OnERC1155Received(&_Stage2Module.CallOpts, arg0, arg1, arg2, arg3, arg4)
}
...
func (_Stage2Module *Stage2ModuleCaller) OnERC721Received(opts *bind.CallOpts, arg0 common.Address, arg1 common.Address, arg2 *big.Int, arg3 []byte) ([4]byte, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "onERC721Received", arg0, arg1, arg2, arg3)
...
//
// Solidity: function onERC721Received(address , address , uint256 , bytes ) pure returns(bytes4)
func (_Stage2Module *Stage2ModuleSession) OnERC721Received(arg0 common.Address, arg1 common.Address, arg2 *big.Int, arg3 []byte) ([4]byte, error) {
	return _Stage2Module.Contract.OnERC721Received(&_Stage2Module.CallOpts, arg0, arg1, arg2, arg3)
}

// OnERC721Received is a free data retrieval call binding the contract method 0x150b7a02.
//
// Solidity: function onERC721Received(address , address , uint256 , bytes ) pure returns(bytes4)
func (_Stage2Module *Stage2ModuleCallerSession) OnERC721Received(arg0 common.Address, arg1 common.Address, arg2 *big.Int, arg3 []byte) ([4]byte, error) {
	return _Stage2Module.Contract.OnERC721Received(&_Stage2Module.CallOpts, arg0, arg1, arg2, arg3)
}
...
func (_Stage2Module *Stage2ModuleCaller) ReadHook(opts *bind.CallOpts, signature [4]byte) (common.Address, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "readHook", signature)
...
//
// Solidity: function readHook(bytes4 signature) view returns(address)
func (_Stage2Module *Stage2ModuleSession) ReadHook(signature [4]byte) (common.Address, error) {
	return _Stage2Module.Contract.ReadHook(&_Stage2Module.CallOpts, signature)
}

// ReadHook is a free data retrieval call binding the contract method 0x1a9b2337.
//
// Solidity: function readHook(bytes4 signature) view returns(address)
func (_Stage2Module *Stage2ModuleCallerSession) ReadHook(signature [4]byte) (common.Address, error) {
	return _Stage2Module.Contract.ReadHook(&_Stage2Module.CallOpts, signature)
}
...
func (_Stage2Module *Stage2ModuleCaller) ReadNonce(opts *bind.CallOpts, _space *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "readNonce", _space)
...
//
// Solidity: function readNonce(uint256 _space) view returns(uint256)
func (_Stage2Module *Stage2ModuleSession) ReadNonce(_space *big.Int) (*big.Int, error) {
	return _Stage2Module.Contract.ReadNonce(&_Stage2Module.CallOpts, _space)
}

// ReadNonce is a free data retrieval call binding the contract method 0x8c3f5563.
//
// Solidity: function readNonce(uint256 _space) view returns(uint256)
func (_Stage2Module *Stage2ModuleCallerSession) ReadNonce(_space *big.Int) (*big.Int, error) {
	return _Stage2Module.Contract.ReadNonce(&_Stage2Module.CallOpts, _space)
}
...
func (_Stage2Module *Stage2ModuleCaller) RecoverPartialSignature(opts *bind.CallOpts, _payload PayloadDecoded, _signature []byte) (struct {
	Threshold    *big.Int
	Weight       *big.Int
	IsValidImage bool
	ImageHash    [32]byte
	...
	var out []interface{}
	err := _Stage2Module.contract.Call(opts, &out, "recoverPartialSignature", _payload, _signature)
...
//
// Solidity: function recoverPartialSignature((uint8,bool,(address,uint256,bytes,uint256,bool,bool,uint256)[],uint256,uint256,bytes,bytes32,bytes32,address[]) _payload, bytes _signature) view returns(uint256 threshold, uint256 weight, bool isValidImage, bytes32 imageHash, uint256 checkpoint, bytes32 opHash)
func (_Stage2Module *Stage2ModuleSession) RecoverPartialSignature(_payload PayloadDecoded, _signature []byte) (struct {
	Threshold    *big.Int
	Weight       *big.Int
	IsValidImage bool
	ImageHash    [32]byte
	...
	return _Stage2Module.Contract.RecoverPartialSignature(&_Stage2Module.CallOpts, _payload, _signature)
}

// RecoverPartialSignature is a free data retrieval call binding the contract method 0xad55366b.
//
// Solidity: function recoverPartialSignature((uint8,bool,(address,uint256,bytes,uint256,bool,bool,uint256)[],uint256,uint256,bytes,bytes32,bytes32,address[]) _payload, bytes _signature) view returns(uint256 threshold, uint256 weight, bool isValidImage, bytes32 imageHash, uint256 checkpoint, bytes32 opHash)
func (_Stage2Module *Stage2ModuleCallerSession) RecoverPartialSignature(_payload PayloadDecoded, _signature []byte) (struct {
	Threshold    *big.Int
	Weight       *big.Int
	IsValidImage bool
	ImageHash    [32]byte
...
func (_Stage2Module *Stage2ModuleTransactor) AddHook(opts *bind.TransactOpts, signature [4]byte, implementation common.Address) (*types.Transaction, error) {
	return _Stage2Module.contract.Transact(opts, "addHook", signature, implementation)
}

// AddHook is a paid mutator transaction binding the contract method 0xb93ea7ad.
//
// Solidity: function addHook(bytes4 signature, address implementation) returns()
func (_Stage2Module *Stage2ModuleSession) AddHook(signature [4]byte, implementation common.Address) (*types.Transaction, error) {
	return _Stage2Module.Contract.AddHook(&_Stage2Module.TransactOpts, signature, implementation)
}

// AddHook is a paid mutator transaction binding the contract method 0xb93ea7ad.
//
// Solidity: function addHook(bytes4 signature, address implementation) returns()
func (_Stage2Module *Stage2ModuleTransactorSession) AddHook(signature [4]byte, implementation common.Address) (*types.Transaction, error) {
	return _Stage2Module.Contract.AddHook(&_Stage2Module.TransactOpts, signature, implementation)
}
...
func (_Stage2Module *Stage2ModuleTransactor) Execute(opts *bind.TransactOpts, _payload []byte, _signature []byte) (*types.Transaction, error) {
	return _Stage2Module.contract.Transact(opts, "execute", _payload, _signature)
}

// Execute is a paid mutator transaction binding the contract method 0x1f6a1eb9.
//
// Solidity: function execute(bytes _payload, bytes _signature) returns()
func (_Stage2Module *Stage2ModuleSession) Execute(_payload []byte, _signature []byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.Execute(&_Stage2Module.TransactOpts, _payload, _signature)
}

// Execute is a paid mutator transaction binding the contract method 0x1f6a1eb9.
//
// Solidity: function execute(bytes _payload, bytes _signature) returns()
func (_Stage2Module *Stage2ModuleTransactorSession) Execute(_payload []byte, _signature []byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.Execute(&_Stage2Module.TransactOpts, _payload, _signature)
}
...
func (_Stage2Module *Stage2ModuleTransactor) RemoveHook(opts *bind.TransactOpts, signature [4]byte) (*types.Transaction, error) {
	return _Stage2Module.contract.Transact(opts, "removeHook", signature)
}

// RemoveHook is a paid mutator transaction binding the contract method 0x4fcf3eca.
//
// Solidity: function removeHook(bytes4 signature) returns()
func (_Stage2Module *Stage2ModuleSession) RemoveHook(signature [4]byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.RemoveHook(&_Stage2Module.TransactOpts, signature)
}

// RemoveHook is a paid mutator transaction binding the contract method 0x4fcf3eca.
//
// Solidity: function removeHook(bytes4 signature) returns()
func (_Stage2Module *Stage2ModuleTransactorSession) RemoveHook(signature [4]byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.RemoveHook(&_Stage2Module.TransactOpts, signature)
}
...
func (_Stage2Module *Stage2ModuleTransactor) SelfExecute(opts *bind.TransactOpts, _payload []byte) (*types.Transaction, error) {
	return _Stage2Module.contract.Transact(opts, "selfExecute", _payload)
}

// SelfExecute is a paid mutator transaction binding the contract method 0x6ea44577.
//
// Solidity: function selfExecute(bytes _payload) returns()
func (_Stage2Module *Stage2ModuleSession) SelfExecute(_payload []byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.SelfExecute(&_Stage2Module.TransactOpts, _payload)
}

// SelfExecute is a paid mutator transaction binding the contract method 0x6ea44577.
//
// Solidity: function selfExecute(bytes _payload) returns()
func (_Stage2Module *Stage2ModuleTransactorSession) SelfExecute(_payload []byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.SelfExecute(&_Stage2Module.TransactOpts, _payload)
}
...
func (_Stage2Module *Stage2ModuleTransactor) SetStaticSignature(opts *bind.TransactOpts, _hash [32]byte, _address common.Address, _timestamp *big.Int) (*types.Transaction, error) {
	return _Stage2Module.contract.Transact(opts, "setStaticSignature", _hash, _address, _timestamp)
}

// SetStaticSignature is a paid mutator transaction binding the contract method 0xf727ef1c.
//
// Solidity: function setStaticSignature(bytes32 _hash, address _address, uint96 _timestamp) returns()
func (_Stage2Module *Stage2ModuleSession) SetStaticSignature(_hash [32]byte, _address common.Address, _timestamp *big.Int) (*types.Transaction, error) {
	return _Stage2Module.Contract.SetStaticSignature(&_Stage2Module.TransactOpts, _hash, _address, _timestamp)
}

// SetStaticSignature is a paid mutator transaction binding the contract method 0xf727ef1c.
//
// Solidity: function setStaticSignature(bytes32 _hash, address _address, uint96 _timestamp) returns()
func (_Stage2Module *Stage2ModuleTransactorSession) SetStaticSignature(_hash [32]byte, _address common.Address, _timestamp *big.Int) (*types.Transaction, error) {
	return _Stage2Module.Contract.SetStaticSignature(&_Stage2Module.TransactOpts, _hash, _address, _timestamp)
}
...
func (_Stage2Module *Stage2ModuleTransactor) TokenReceived(opts *bind.TransactOpts, arg0 common.Address, arg1 *big.Int, arg2 []byte) (*types.Transaction, error) {
	return _Stage2Module.contract.Transact(opts, "tokenReceived", arg0, arg1, arg2)
}

// TokenReceived is a paid mutator transaction binding the contract method 0x8943ec02.
//
// Solidity: function tokenReceived(address , uint256 , bytes ) returns()
func (_Stage2Module *Stage2ModuleSession) TokenReceived(arg0 common.Address, arg1 *big.Int, arg2 []byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.TokenReceived(&_Stage2Module.TransactOpts, arg0, arg1, arg2)
}

// TokenReceived is a paid mutator transaction binding the contract method 0x8943ec02.
//
// Solidity: function tokenReceived(address , uint256 , bytes ) returns()
func (_Stage2Module *Stage2ModuleTransactorSession) TokenReceived(arg0 common.Address, arg1 *big.Int, arg2 []byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.TokenReceived(&_Stage2Module.TransactOpts, arg0, arg1, arg2)
}
...
func (_Stage2Module *Stage2ModuleTransactor) UpdateImageHash(opts *bind.TransactOpts, _imageHash [32]byte) (*types.Transaction, error) {
	return _Stage2Module.contract.Transact(opts, "updateImageHash", _imageHash)
}

// UpdateImageHash is a paid mutator transaction binding the contract method 0x29561426.
//
// Solidity: function updateImageHash(bytes32 _imageHash) returns()
func (_Stage2Module *Stage2ModuleSession) UpdateImageHash(_imageHash [32]byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.UpdateImageHash(&_Stage2Module.TransactOpts, _imageHash)
}

// UpdateImageHash is a paid mutator transaction binding the contract method 0x29561426.
//
// Solidity: function updateImageHash(bytes32 _imageHash) returns()
func (_Stage2Module *Stage2ModuleTransactorSession) UpdateImageHash(_imageHash [32]byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.UpdateImageHash(&_Stage2Module.TransactOpts, _imageHash)
}
...
func (_Stage2Module *Stage2ModuleTransactor) UpdateImplementation(opts *bind.TransactOpts, _implementation common.Address) (*types.Transaction, error) {
	return _Stage2Module.contract.Transact(opts, "updateImplementation", _implementation)
}

// UpdateImplementation is a paid mutator transaction binding the contract method 0x025b22bc.
//
// Solidity: function updateImplementation(address _implementation) returns()
func (_Stage2Module *Stage2ModuleSession) UpdateImplementation(_implementation common.Address) (*types.Transaction, error) {
	return _Stage2Module.Contract.UpdateImplementation(&_Stage2Module.TransactOpts, _implementation)
}

// UpdateImplementation is a paid mutator transaction binding the contract method 0x025b22bc.
//
// Solidity: function updateImplementation(address _implementation) returns()
func (_Stage2Module *Stage2ModuleTransactorSession) UpdateImplementation(_implementation common.Address) (*types.Transaction, error) {
	return _Stage2Module.Contract.UpdateImplementation(&_Stage2Module.TransactOpts, _implementation)
}
...
func (_Stage2Module *Stage2ModuleTransactor) Fallback(opts *bind.TransactOpts, calldata []byte) (*types.Transaction, error) {
	return _Stage2Module.contract.RawTransact(opts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() payable returns()
func (_Stage2Module *Stage2ModuleSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.Fallback(&_Stage2Module.TransactOpts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() payable returns()
func (_Stage2Module *Stage2ModuleTransactorSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _Stage2Module.Contract.Fallback(&_Stage2Module.TransactOpts, calldata)
}
...
func (_Stage2Module *Stage2ModuleTransactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Stage2Module.contract.RawTransact(opts, nil) // calldata is disallowed for receive function
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_Stage2Module *Stage2ModuleSession) Receive() (*types.Transaction, error) {
	return _Stage2Module.Contract.Receive(&_Stage2Module.TransactOpts)
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_Stage2Module *Stage2ModuleTransactorSession) Receive() (*types.Transaction, error) {
	return _Stage2Module.Contract.Receive(&_Stage2Module.TransactOpts)
}

// Stage2ModuleAbortedIterator is returned from FilterAborted and is used to iterate over the raw logs and unpacked data for Aborted events raised by the Stage2Module contract.
type Stage2ModuleAbortedIterator struct {
	Event *Stage2ModuleAborted // Event containing the contract specifics and raw log
...
func (it *Stage2ModuleAbortedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleAborted)
...
func (it *Stage2ModuleAbortedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleAbortedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleAborted represents a Aborted event raised by the Stage2Module contract.
type Stage2ModuleAborted struct {
	OpHash [32]byte
	Index  *big.Int
...
func (_Stage2Module *Stage2ModuleFilterer) FilterAborted(opts *bind.FilterOpts) (*Stage2ModuleAbortedIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "Aborted")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleAbortedIterator{contract: _Stage2Module.contract, event: "Aborted", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Aborted(bytes32 _opHash, uint256 _index)
func (_Stage2Module *Stage2ModuleFilterer) WatchAborted(opts *bind.WatchOpts, sink chan<- *Stage2ModuleAborted) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "Aborted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(Stage2ModuleAborted)
				if err := _Stage2Module.contract.UnpackLog(event, "Aborted", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Aborted(bytes32 _opHash, uint256 _index)
func (_Stage2Module *Stage2ModuleFilterer) ParseAborted(log types.Log) (*Stage2ModuleAborted, error) {
	event := new(Stage2ModuleAborted)
	if err := _Stage2Module.contract.UnpackLog(event, "Aborted", log); err != nil {
		return nil, err
	}
...
// Stage2ModuleDefinedHookIterator is returned from FilterDefinedHook and is used to iterate over the raw logs and unpacked data for DefinedHook events raised by the Stage2Module contract.
type Stage2ModuleDefinedHookIterator struct {
	Event *Stage2ModuleDefinedHook // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Stage2ModuleDefinedHookIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleDefinedHook)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Stage2ModuleDefinedHookIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleDefinedHookIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleDefinedHook represents a DefinedHook event raised by the Stage2Module contract.
type Stage2ModuleDefinedHook struct {
	Signature      [4]byte
...
func (_Stage2Module *Stage2ModuleFilterer) FilterDefinedHook(opts *bind.FilterOpts) (*Stage2ModuleDefinedHookIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "DefinedHook")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleDefinedHookIterator{contract: _Stage2Module.contract, event: "DefinedHook", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event DefinedHook(bytes4 signature, address implementation)
func (_Stage2Module *Stage2ModuleFilterer) WatchDefinedHook(opts *bind.WatchOpts, sink chan<- *Stage2ModuleDefinedHook) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "DefinedHook")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Stage2ModuleDefinedHook)
				if err := _Stage2Module.contract.UnpackLog(event, "DefinedHook", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event DefinedHook(bytes4 signature, address implementation)
func (_Stage2Module *Stage2ModuleFilterer) ParseDefinedHook(log types.Log) (*Stage2ModuleDefinedHook, error) {
	event := new(Stage2ModuleDefinedHook)
	if err := _Stage2Module.contract.UnpackLog(event, "DefinedHook", log); err != nil {
		return nil, err
	}
...
// Stage2ModuleFailedIterator is returned from FilterFailed and is used to iterate over the raw logs and unpacked data for Failed events raised by the Stage2Module contract.
type Stage2ModuleFailedIterator struct {
	Event *Stage2ModuleFailed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Stage2ModuleFailedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleFailed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Stage2ModuleFailedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleFailedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleFailed represents a Failed event raised by the Stage2Module contract.
type Stage2ModuleFailed struct {
	OpHash [32]byte
	Index  *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_Stage2Module *Stage2ModuleFilterer) FilterFailed(opts *bind.FilterOpts) (*Stage2ModuleFailedIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "Failed")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleFailedIterator{contract: _Stage2Module.contract, event: "Failed", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Failed(bytes32 _opHash, uint256 _index)
func (_Stage2Module *Stage2ModuleFilterer) WatchFailed(opts *bind.WatchOpts, sink chan<- *Stage2ModuleFailed) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "Failed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Stage2ModuleFailed)
				if err := _Stage2Module.contract.UnpackLog(event, "Failed", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Failed(bytes32 _opHash, uint256 _index)
func (_Stage2Module *Stage2ModuleFilterer) ParseFailed(log types.Log) (*Stage2ModuleFailed, error) {
	event := new(Stage2ModuleFailed)
	if err := _Stage2Module.contract.UnpackLog(event, "Failed", log); err != nil {
		return nil, err
	}
...
// Stage2ModuleImageHashUpdatedIterator is returned from FilterImageHashUpdated and is used to iterate over the raw logs and unpacked data for ImageHashUpdated events raised by the Stage2Module contract.
type Stage2ModuleImageHashUpdatedIterator struct {
	Event *Stage2ModuleImageHashUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Stage2ModuleImageHashUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleImageHashUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Stage2ModuleImageHashUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleImageHashUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleImageHashUpdated represents a ImageHashUpdated event raised by the Stage2Module contract.
type Stage2ModuleImageHashUpdated struct {
...
func (_Stage2Module *Stage2ModuleFilterer) FilterImageHashUpdated(opts *bind.FilterOpts) (*Stage2ModuleImageHashUpdatedIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "ImageHashUpdated")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleImageHashUpdatedIterator{contract: _Stage2Module.contract, event: "ImageHashUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ImageHashUpdated(bytes32 newImageHash)
func (_Stage2Module *Stage2ModuleFilterer) WatchImageHashUpdated(opts *bind.WatchOpts, sink chan<- *Stage2ModuleImageHashUpdated) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "ImageHashUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Stage2ModuleImageHashUpdated)
				if err := _Stage2Module.contract.UnpackLog(event, "ImageHashUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ImageHashUpdated(bytes32 newImageHash)
func (_Stage2Module *Stage2ModuleFilterer) ParseImageHashUpdated(log types.Log) (*Stage2ModuleImageHashUpdated, error) {
	event := new(Stage2ModuleImageHashUpdated)
	if err := _Stage2Module.contract.UnpackLog(event, "ImageHashUpdated", log); err != nil {
		return nil, err
	}
...
// Stage2ModuleImplementationUpdatedIterator is returned from FilterImplementationUpdated and is used to iterate over the raw logs and unpacked data for ImplementationUpdated events raised by the Stage2Module contract.
type Stage2ModuleImplementationUpdatedIterator struct {
	Event *Stage2ModuleImplementationUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Stage2ModuleImplementationUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleImplementationUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Stage2ModuleImplementationUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleImplementationUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleImplementationUpdated represents a ImplementationUpdated event raised by the Stage2Module contract.
type Stage2ModuleImplementationUpdated struct {
...
func (_Stage2Module *Stage2ModuleFilterer) FilterImplementationUpdated(opts *bind.FilterOpts) (*Stage2ModuleImplementationUpdatedIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "ImplementationUpdated")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleImplementationUpdatedIterator{contract: _Stage2Module.contract, event: "ImplementationUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ImplementationUpdated(address newImplementation)
func (_Stage2Module *Stage2ModuleFilterer) WatchImplementationUpdated(opts *bind.WatchOpts, sink chan<- *Stage2ModuleImplementationUpdated) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "ImplementationUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Stage2ModuleImplementationUpdated)
				if err := _Stage2Module.contract.UnpackLog(event, "ImplementationUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ImplementationUpdated(address newImplementation)
func (_Stage2Module *Stage2ModuleFilterer) ParseImplementationUpdated(log types.Log) (*Stage2ModuleImplementationUpdated, error) {
	event := new(Stage2ModuleImplementationUpdated)
	if err := _Stage2Module.contract.UnpackLog(event, "ImplementationUpdated", log); err != nil {
		return nil, err
	}
...
// Stage2ModuleNonceChangeIterator is returned from FilterNonceChange and is used to iterate over the raw logs and unpacked data for NonceChange events raised by the Stage2Module contract.
type Stage2ModuleNonceChangeIterator struct {
	Event *Stage2ModuleNonceChange // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Stage2ModuleNonceChangeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleNonceChange)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Stage2ModuleNonceChangeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleNonceChangeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleNonceChange represents a NonceChange event raised by the Stage2Module contract.
type Stage2ModuleNonceChange struct {
	Space    *big.Int
	NewNonce *big.Int
	Raw      types.Log // Blockchain specific contextual infos
}
...
func (_Stage2Module *Stage2ModuleFilterer) FilterNonceChange(opts *bind.FilterOpts) (*Stage2ModuleNonceChangeIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "NonceChange")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleNonceChangeIterator{contract: _Stage2Module.contract, event: "NonceChange", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NonceChange(uint256 _space, uint256 _newNonce)
func (_Stage2Module *Stage2ModuleFilterer) WatchNonceChange(opts *bind.WatchOpts, sink chan<- *Stage2ModuleNonceChange) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "NonceChange")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Stage2ModuleNonceChange)
				if err := _Stage2Module.contract.UnpackLog(event, "NonceChange", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NonceChange(uint256 _space, uint256 _newNonce)
func (_Stage2Module *Stage2ModuleFilterer) ParseNonceChange(log types.Log) (*Stage2ModuleNonceChange, error) {
	event := new(Stage2ModuleNonceChange)
	if err := _Stage2Module.contract.UnpackLog(event, "NonceChange", log); err != nil {
		return nil, err
	}
...
// Stage2ModuleSkippedIterator is returned from FilterSkipped and is used to iterate over the raw logs and unpacked data for Skipped events raised by the Stage2Module contract.
type Stage2ModuleSkippedIterator struct {
	Event *Stage2ModuleSkipped // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Stage2ModuleSkippedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleSkipped)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Stage2ModuleSkippedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleSkippedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleSkipped represents a Skipped event raised by the Stage2Module contract.
type Stage2ModuleSkipped struct {
	OpHash [32]byte
	Index  *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_Stage2Module *Stage2ModuleFilterer) FilterSkipped(opts *bind.FilterOpts) (*Stage2ModuleSkippedIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "Skipped")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleSkippedIterator{contract: _Stage2Module.contract, event: "Skipped", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Skipped(bytes32 _opHash, uint256 _index)
func (_Stage2Module *Stage2ModuleFilterer) WatchSkipped(opts *bind.WatchOpts, sink chan<- *Stage2ModuleSkipped) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "Skipped")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Stage2ModuleSkipped)
				if err := _Stage2Module.contract.UnpackLog(event, "Skipped", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Skipped(bytes32 _opHash, uint256 _index)
func (_Stage2Module *Stage2ModuleFilterer) ParseSkipped(log types.Log) (*Stage2ModuleSkipped, error) {
	event := new(Stage2ModuleSkipped)
	if err := _Stage2Module.contract.UnpackLog(event, "Skipped", log); err != nil {
		return nil, err
	}
...
// Stage2ModuleStaticSignatureSetIterator is returned from FilterStaticSignatureSet and is used to iterate over the raw logs and unpacked data for StaticSignatureSet events raised by the Stage2Module contract.
type Stage2ModuleStaticSignatureSetIterator struct {
	Event *Stage2ModuleStaticSignatureSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Stage2ModuleStaticSignatureSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleStaticSignatureSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Stage2ModuleStaticSignatureSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleStaticSignatureSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleStaticSignatureSet represents a StaticSignatureSet event raised by the Stage2Module contract.
type Stage2ModuleStaticSignatureSet struct {
	Hash      [32]byte
...
func (_Stage2Module *Stage2ModuleFilterer) FilterStaticSignatureSet(opts *bind.FilterOpts) (*Stage2ModuleStaticSignatureSetIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "StaticSignatureSet")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleStaticSignatureSetIterator{contract: _Stage2Module.contract, event: "StaticSignatureSet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event StaticSignatureSet(bytes32 _hash, address _address, uint96 _timestamp)
func (_Stage2Module *Stage2ModuleFilterer) WatchStaticSignatureSet(opts *bind.WatchOpts, sink chan<- *Stage2ModuleStaticSignatureSet) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "StaticSignatureSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Stage2ModuleStaticSignatureSet)
				if err := _Stage2Module.contract.UnpackLog(event, "StaticSignatureSet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event StaticSignatureSet(bytes32 _hash, address _address, uint96 _timestamp)
func (_Stage2Module *Stage2ModuleFilterer) ParseStaticSignatureSet(log types.Log) (*Stage2ModuleStaticSignatureSet, error) {
	event := new(Stage2ModuleStaticSignatureSet)
	if err := _Stage2Module.contract.UnpackLog(event, "StaticSignatureSet", log); err != nil {
		return nil, err
	}
...
// Stage2ModuleSuccessIterator is returned from FilterSuccess and is used to iterate over the raw logs and unpacked data for Success events raised by the Stage2Module contract.
type Stage2ModuleSuccessIterator struct {
	Event *Stage2ModuleSuccess // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Stage2ModuleSuccessIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Stage2ModuleSuccess)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Stage2ModuleSuccessIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Stage2ModuleSuccessIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Stage2ModuleSuccess represents a Success event raised by the Stage2Module contract.
type Stage2ModuleSuccess struct {
	OpHash [32]byte
	Index  *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_Stage2Module *Stage2ModuleFilterer) FilterSuccess(opts *bind.FilterOpts) (*Stage2ModuleSuccessIterator, error) {

	logs, sub, err := _Stage2Module.contract.FilterLogs(opts, "Success")
	if err != nil {
		return nil, err
	}
	return &Stage2ModuleSuccessIterator{contract: _Stage2Module.contract, event: "Success", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Success(bytes32 _opHash, uint256 _index)
func (_Stage2Module *Stage2ModuleFilterer) WatchSuccess(opts *bind.WatchOpts, sink chan<- *Stage2ModuleSuccess) (event.Subscription, error) {

	logs, sub, err := _Stage2Module.contract.WatchLogs(opts, "Success")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Stage2ModuleSuccess)
				if err := _Stage2Module.contract.UnpackLog(event, "Success", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Success(bytes32 _opHash, uint256 _index)
func (_Stage2Module *Stage2ModuleFilterer) ParseSuccess(log types.Log) (*Stage2ModuleSuccess, error) {
	event := new(Stage2ModuleSuccess)
	if err := _Stage2Module.contract.UnpackLog(event, "Success", log); err != nil {
		return nil, err
	}
