// sequence-indexer v0.4.0 84ae41d7d7bbf2414cf42c51b157fb42464a9384
// --
...
func WebRPCSchemaHash() string {
	return "84ae41d7d7bbf2414cf42c51b157fb42464a9384"
}
...
type AdminClient interface {
	// Backup – starts bond DB backup in background. Only one backup at a time. Default mode incremental.
	Backup(ctx context.Context, mode *BackupMode) error
}
...
func (c *adminClient) Backup(ctx context.Context, mode *BackupMode) error {
	in := struct {
