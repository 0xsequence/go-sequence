// sequence-indexer v0.4.0 4d157093ab69a43b01dc0721f28095acc32d3bd5
// --
...
func WebRPCSchemaHash() string {
	return "4d157093ab69a43b01dc0721f28095acc32d3bd5"
}
...
type AdminClient interface {
	// GetBackupProgress – returns the progress of a backup identified by backupId.
	GetBackupProgress(ctx context.Context, backupId string) (*BackupProgress, error)
	// StartBackup – starts bond DB backup in background. Only one backup at a time. Default mode incremental.
	StartBackup(ctx context.Context, mode *BackupMode) (string, error)
}
...
const (
	BackupMode_INCREMENTAL BackupMode = 0
	BackupMode_COMPLETE    BackupMode = 1
)

var BackupMode_name = map[uint8]string{
	0: "INCREMENTAL",
	1: "COMPLETE",
}

var BackupMode_value = map[string]uint8{
	"INCREMENTAL": 0,
	"COMPLETE":    1,
}

func (x BackupMode) String() string {
	return BackupMode_name[uint8(x)]
}

func (x BackupMode) MarshalText() ([]byte, error) {
	return []byte(BackupMode_name[uint8(x)]), nil
}

func (x *BackupMode) UnmarshalText(b []byte) error {
	*x = BackupMode(BackupMode_value[string(b)])
	return nil
}

func (x *BackupMode) Is(values ...BackupMode) bool {
	if x == nil {
		return false
	}
...
const (
	BackupStatus_RUNNING   BackupStatus = 0
	BackupStatus_COMPLETED BackupStatus = 1
	BackupStatus_FAILED    BackupStatus = 2
)

var BackupStatus_name = map[uint8]string{
	0: "RUNNING",
	1: "COMPLETED",
	2: "FAILED",
}

var BackupStatus_value = map[string]uint8{
	"RUNNING":   0,
	"COMPLETED": 1,
	"FAILED":    2,
}
...
func (x BackupStatus) String() string {
	return BackupStatus_name[uint8(x)]
}

func (x BackupStatus) MarshalText() ([]byte, error) {
	return []byte(BackupStatus_name[uint8(x)]), nil
}

func (x *BackupStatus) UnmarshalText(b []byte) error {
	*x = BackupStatus(BackupStatus_value[string(b)])
	return nil
}

func (x *BackupStatus) Is(values ...BackupStatus) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
type NativeTokenBalance struct {
	...
	PriceUpdatedAt *time.Time      `json:"priceUpdatedAt,omitempty" cbor:"-"`
...
const (
	NetworkType_MAINNETS NetworkType = 0
	NetworkType_TESTNETS NetworkType = 1
	NetworkType_ALL      NetworkType = 2
)
...
func (x NetworkType) String() string {
	return NetworkType_name[uint8(x)]
}

func (x NetworkType) MarshalText() ([]byte, error) {
	return []byte(NetworkType_name[uint8(x)]), nil
}

func (x *NetworkType) UnmarshalText(b []byte) error {
	*x = NetworkType(NetworkType_value[string(b)])
	return nil
}
...
func (c *adminClient) GetBackupProgress(ctx context.Context, backupId string) (*BackupProgress, error) {
	in := struct {
		Arg0 string `json:"backupId"`
	}{backupId}
	out := struct {
		Ret0 *BackupProgress `json:"progress"`
	}{}
...
func (c *adminClient) StartBackup(ctx context.Context, mode *BackupMode) (string, error) {
	in := struct {
		Arg0 *BackupMode `json:"mode"`
	}{mode}
	out := struct {
		Ret0 string `json:"backupId"`
	}{}
...
func (c *indexerClient) GetTokenPrice(ctx context.Context, q *TokenPriceQuery) (*Price, error) {
	in := struct {
		Arg0 *TokenPriceQuery `json:"q"`
	}{q}
	out := struct {
		Ret0 *Price `json:"price"`
	}{}
...
func (c *indexerClient) GetTokenPrices(ctx context.Context, q []*TokenPriceQuery) ([]*Price, error) {
	in := struct {
		Arg0 []*TokenPriceQuery `json:"q"`
	}{q}
	out := struct {
		Ret0 []*Price `json:"prices"`
	}{}
...
func (c *indexerClient) GetTokenSupplies(ctx context.Context, contractAddress string, includeMetadata *bool, page *Page) (*Page, ContractType, []*TokenSupply, error) {
	in := struct {
		Arg0 string `json:"contractAddress"`
		Arg1 *bool  `json:"includeMetadata"`
		Arg2 *Page  `json:"page"`
	}{contractAddress, includeMetadata, page}
	out := struct {
		Ret0 *Page          `json:"page"`
		Ret1 ContractType   `json:"contractType"`
...
func (c *indexerClient) GetTokenSuppliesMap(ctx context.Context, tokenMap map[string][]string, includeMetadata *bool) (map[string][]*TokenSupply, error) {
	in := struct {
		Arg0 map[string][]string `json:"tokenMap"`
		Arg1 *bool               `json:"includeMetadata"`
	}{tokenMap, includeMetadata}
	out := struct {
...
func (c *indexerClient) ListTokenPrices(ctx context.Context, page *Page) (*Page, []*Price, error) {
	in := struct {
		Arg0 *Page `json:"page"`
	}{page}
	out := struct {
...
func (c *indexerClient) RuntimeStatus(ctx context.Context) (*RuntimeStatus, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[28], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *indexerClient) SubscribeReceipts(ctx context.Context, filter *TransactionFilter) (SubscribeReceiptsStreamReader, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[31], in, nil)
	if err != nil {
		if resp != nil {
			resp.Body.Close()
		}
...
func (c *indexerClient) SyncBalance(ctx context.Context, accountAddress string, contractAddress string, tokenID *string) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[32], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *indexerGatewayClient) GetBalanceUpdates(ctx context.Context, chainIds []uint64, networks []string, networkType *NetworkType, contractAddress string, lastBlockNumber uint64, lastBlockHash *string, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64     `json:"chainIds"`
		Arg1 []string     `json:"networks"`
		Arg2 *NetworkType `json:"networkType"`
		Arg3 string       `json:"contractAddress"`
		Arg4 uint64       `json:"lastBlockNumber"`
		Arg5 *string      `json:"lastBlockHash"`
		Arg6 *Page        `json:"page"`
	}{chainIds, networks, networkType, contractAddress, lastBlockNumber, lastBlockHash, page}
	out := struct {
		Ret0 *Page                  `json:"page"`
...
func (c *indexerGatewayClient) GetChains(ctx context.Context, networkType *NetworkType) ([]*ChainInfo, error) {
	in := struct {
		Arg0 *NetworkType `json:"networkType"`
	}{networkType}
	out := struct {
		Ret0 []*ChainInfo `json:"chains"`
	}{}
...
func (c *indexerGatewayClient) GetNativeTokenBalance(ctx context.Context, chainIds []uint64, networks []string, networkType *NetworkType, accountAddress *string, omitPrices *bool) ([]*GatewayNativeTokenBalance, error) {
	in := struct {
		Arg0 []uint64     `json:"chainIds"`
		Arg1 []string     `json:"networks"`
		Arg2 *NetworkType `json:"networkType"`
		Arg3 *string      `json:"accountAddress"`
		Arg4 *bool        `json:"omitPrices"`
...
func (c *indexerGatewayClient) GetTokenBalances(ctx context.Context, chainIds []uint64, networks []string, networkType *NetworkType, accountAddress *string, contractAddress *string, tokenID *string, includeMetadata *bool, metadataOptions *MetadataOptions, includeCollectionTokens *bool, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64         `json:"chainIds"`
		Arg1 []string         `json:"networks"`
		Arg2 *NetworkType     `json:"networkType"`
		Arg3 *string          `json:"accountAddress"`
		Arg4 *string          `json:"contractAddress"`
		Arg5 *string          `json:"tokenID"`
		Arg6 *bool            `json:"includeMetadata"`
		Arg7 *MetadataOptions `json:"metadataOptions"`
		Arg8 *bool            `json:"includeCollectionTokens"`
		Arg9 *Page            `json:"page"`
	}{chainIds, networks, networkType, accountAddress, contractAddress, tokenID, includeMetadata, metadataOptions, includeCollectionTokens, page}
	out := struct {
		Ret0 *Page                  `json:"page"`
		Ret1 []*GatewayTokenBalance `json:"balances"`
	}{}
...
func (c *indexerGatewayClient) GetTokenBalancesByContract(ctx context.Context, chainIds []uint64, networks []string, networkType *NetworkType, filter *TokenBalancesByContractFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64                       `json:"chainIds"`
		Arg1 []string                       `json:"networks"`
		Arg2 *NetworkType                   `json:"networkType"`
		Arg3 *TokenBalancesByContractFilter `json:"filter"`
		Arg4 *bool                          `json:"omitMetadata"`
		Arg5 *Page                          `json:"page"`
	}{chainIds, networks, networkType, filter, omitMetadata, page}
	out := struct {
		Ret0 *Page                  `json:"page"`
		Ret1 []*GatewayTokenBalance `json:"balances"`
	}{}
...
func (c *indexerGatewayClient) GetTokenBalancesDetails(ctx context.Context, chainIds []uint64, networks []string, networkType *NetworkType, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64             `json:"chainIds"`
		Arg1 []string             `json:"networks"`
		Arg2 *NetworkType         `json:"networkType"`
		Arg3 *TokenBalancesFilter `json:"filter"`
		Arg4 *bool                `json:"omitMetadata"`
		Arg5 *Page                `json:"page"`
	}{chainIds, networks, networkType, filter, omitMetadata, page}
	out := struct {
...
func (c *indexerGatewayClient) GetTokenPrice(ctx context.Context, q *GatewayTokenPriceQuery) (*GatewayPrice, error) {
	in := struct {
		Arg0 *GatewayTokenPriceQuery `json:"q"`
	}{q}
	out := struct {
		Ret0 *GatewayPrice `json:"price"`
	}{}
...
func (c *indexerGatewayClient) GetTokenPrices(ctx context.Context, q []*GatewayTokenPriceQuery) ([]*GatewayPrice, error) {
	in := struct {
		Arg0 []*GatewayTokenPriceQuery `json:"q"`
	}{q}
	out := struct {
		Ret0 []*GatewayPrice `json:"prices"`
	}{}
...
func (c *indexerGatewayClient) GetTransactionHistory(ctx context.Context, chainIds []uint64, networks []string, networkType *NetworkType, filter *TransactionHistoryFilter, includeMetadata *bool, metadataOptions *MetadataOptions, page *Page) (*Page, []*GatewayTransaction, error) {
	in := struct {
		Arg0 []uint64                  `json:"chainIds"`
		Arg1 []string                  `json:"networks"`
		Arg2 *NetworkType              `json:"networkType"`
		Arg3 *TransactionHistoryFilter `json:"filter"`
		Arg4 *bool                     `json:"includeMetadata"`
		Arg5 *MetadataOptions          `json:"metadataOptions"`
		Arg6 *Page                     `json:"page"`
	}{chainIds, networks, networkType, filter, includeMetadata, metadataOptions, page}
	out := struct {
		Ret0 *Page                 `json:"page"`
		Ret1 []*GatewayTransaction `json:"transactions"`
	}{}
...
func (c *indexerGatewayClient) Version(ctx context.Context) (*Version, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[12], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
