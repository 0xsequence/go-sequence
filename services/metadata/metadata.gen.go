// sequence-metadata v0.4.0 5072c9dbc6fd199251d6f61361f24926806ba1e1
// --
...
func WebRPCSchemaHash() string {
	return "5072c9dbc6fd199251d6f61361f24926806ba1e1"
}
...
func (c *metadataClient) RefreshTokenMetadata(ctx context.Context, chainID string, contractAddress string, tokenIDs []string, newMints *bool) (uint64, error) {
	in := struct {
		Arg0 string   `json:"chainID"`
		Arg1 string   `json:"contractAddress"`
		Arg2 []string `json:"tokenIDs"`
		Arg3 *bool    `json:"newMints"`
	}{chainID, contractAddress, tokenIDs, newMints}
	out := struct {
		Ret0 uint64 `json:"taskID"`
	}{}
...
const WebrpcHeaderValue = "webrpc@v0.31.0;gen-golang@v0.23.1;sequence-metadata@v0.4.0"
