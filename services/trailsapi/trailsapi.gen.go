// trails-api v1-26.1.13-e74daec9 0d952fe03ce07d60c89665bb34a732315012ba2c
// --
...
func WebRPCSchemaVersion() string {
	return "v1-26.1.13-e74daec9"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "0d952fe03ce07d60c89665bb34a732315012ba2c"
}
...
type TrailsClient interface {
	...
	GetCallsConfiguration(ctx context.Context, getCallsConfigurationRequest GetCallsConfigurationRequest) (*GetCallsConfigurationResponse, error)
...
type IntentConfiguration struct {
	...
	OriginCalls      *IntentCalls  `json:"originCalls"`
	DestinationCalls *IntentCalls  `json:"destinationCalls,omitempty"`
}
...
type QuoteIntentResponse struct {
	...
	IntentConfiguration *IntentConfiguration `json:"intentConfiguration,omitempty"`
}
...
type GetCallsConfigurationRequest struct {
	OwnerAddress prototyp.Hash `json:"ownerAddress"`
	Checkpoint   uint64        `json:"checkpoint"`
	Calls        *IntentCalls  `json:"calls"`
	// Origin configuration adds permit capability for the source token
	PermitTokenAddress     prototyp.Hash           `json:"permitTokenAddress"`
	IsOrigin               bool                    `json:"isOrigin"`
	TrailsAddressOverrides *TrailsAddressOverrides `json:"trailsAddressOverrides,omitempty"`
}

type GetCallsConfigurationResponse struct {
	Address   prototyp.Hash `json:"address"`
	ImageHash prototyp.Hash `json:"imageHash"`
	// v3.WalletConfig Same as sessions
	WalletConfiguration interface{} `json:"walletConfiguration"`
}
...
func (c *trailsClient) GetCallsConfiguration(ctx context.Context, getCallsConfigurationRequest GetCallsConfigurationRequest) (*GetCallsConfigurationResponse, error) {
	out := struct {
		Ret0 *GetCallsConfigurationResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[10], getCallsConfigurationRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetTokenPrices(ctx context.Context, getTokenPricesRequest GetTokenPricesRequest) (*GetTokenPricesResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[17], getTokenPricesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
const WebrpcHeaderValue = "webrpc@v0.31.3;gen-golang@v0.23.3;trails-api@v1-26.1.13-e74daec9"
