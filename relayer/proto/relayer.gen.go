// sequence-relayer v0.4.1 fb3b85b73856f333cbba355861050f23c7b2af48
// --
...
func WebRPCSchemaHash() string {
	return "fb3b85b73856f333cbba355861050f23c7b2af48"
}
...
type RelayerClient interface {
	...
	FeeOptionsWithBridgeGas(ctx context.Context, wallet string, to string, data string, simulate *bool, bridgeGas string) ([]*FeeOption, bool, *string, error)
	// TODO: deprecated, to be removed by https://github.com/0xsequence/stack/pull/356 at a later date
...
func (c *relayerClient) FeeOptionsWithBridgeGas(ctx context.Context, wallet string, to string, data string, simulate *bool, bridgeGas string) ([]*FeeOption, bool, *string, error) {
	in := struct {
		Arg0 string `json:"wallet"`
		Arg1 string `json:"to"`
		Arg2 string `json:"data"`
	...
	}{wallet, to, data, simulate, bridgeGas}
	out := struct {
		Ret0 []*FeeOption `json:"options"`
		Ret1 bool         `json:"sponsored"`
		Ret2 *string      `json:"quote"`
