// sequence-relayer v0.4.1 5f4ba9cfea3872be7073167aaef21a647ec36e52
// --
...
func WebRPCSchemaHash() string {
	return "5f4ba9cfea3872be7073167aaef21a647ec36e52"
}
...
type EIP7702Authorization struct {
	...
	YParity        uint64          `json:"yParity"`
	R              prototyp.BigInt `json:"r"`
	S              prototyp.BigInt `json:"s"`
}
...
func (s *relayerService) serveGetMetaTxnReceiptJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetMetaTxnReceipt(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
