...
func WebRPCSchemaHash() string {
	return "db311ae9a6a93829f172c5d6db44955c2f7ba6f0"
}
...
func (c *relayerClient) SendMetaTxn(ctx context.Context, call *MetaTxn, quote *string, projectID *uint64, preconditions []*IntentPrecondition) (bool, string, error) {
	in := struct {
		Arg0 *MetaTxn              `json:"call"`
		Arg1 *string               `json:"quote"`
		Arg2 *uint64               `json:"projectID"`
		Arg3 []*IntentPrecondition `json:"preconditions"`
...
const WebrpcHeaderValue = "webrpc@v0.30.1;gen-golang@v0.23.1;sequence-relayer@v0.4.1"
