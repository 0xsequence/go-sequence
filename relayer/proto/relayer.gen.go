// sequence-relayer v0.4.1 bbe47231e764cdbdf21f7181326c5b1709f630a3
// --
// Code generated by webrpc-gen@v0.32.2 with golang generator. DO NOT EDIT.
//
// webrpc-gen -schema=relayer.ridl -target=golang -pkg=proto -server -client -out=./relayer.gen.go
package proto
...
func WebRPCSchemaHash() string {
	return "bbe47231e764cdbdf21f7181326c5b1709f630a3"
}
...
type RelayerClient interface {
	...
	GetMetaTxnReceipt(ctx context.Context, metaTxID string) (*MetaTxnReceipt, bool, error)
	...
	FeeOptions(ctx context.Context, wallet string, to string, data string, simulate *bool, authorization *EIP7702Authorization) ([]*FeeOption, bool, *string, error)
	...
	SendMetaTxnWithBridgeGas(ctx context.Context, call *MetaTxn, quote *string, projectID *uint64, bridgeGas string, preconditions []*TransactionPrecondition) (bool, string, error)
	FeeOptionsWithBridgeGas(ctx context.Context, wallet string, to string, data string, simulate *bool, bridgeGas string, authorization *EIP7702Authorization) ([]*FeeOption, bool, *string, error)
	// TODO: deprecated, to be removed by https://github.com/0xsequence/stack/pull/356 at a later date
	...
	RepairSender(ctx context.Context, sender int, nonce uint64, operation RepairOperation) error
	...
	ListEcosystemGasSponsors(ctx context.Context, ecosystemId uint64, page *Page) (*Page, []*GasSponsor, error)
	GetEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, id uint64) (*GasSponsor, error)
	AddEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, address string, name *string, active *bool) (bool, *GasSponsor, error)
	UpdateEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, id uint64, name *string, active *bool) (bool, *GasSponsor, error)
	RemoveEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, id uint64) (bool, error)
	// Gas Sponsor Lookup
...
type RepairOperation int

const (
	RepairOperation_SKIP    RepairOperation = 0
	RepairOperation_REQUEUE RepairOperation = 1
	RepairOperation_DROP    RepairOperation = 2
)

var RepairOperation_name = map[int]string{
	0: "SKIP",
	1: "REQUEUE",
	2: "DROP",
}

var RepairOperation_value = map[string]int{
	"SKIP":    0,
	"REQUEUE": 1,
	"DROP":    2,
}

func (x RepairOperation) String() string {
	return RepairOperation_name[int(x)]
}

func (x RepairOperation) MarshalText() ([]byte, error) {
	return []byte(RepairOperation_name[int(x)]), nil
}

func (x *RepairOperation) UnmarshalText(b []byte) error {
	*x = RepairOperation(RepairOperation_value[string(b)])
	return nil
}

func (x *RepairOperation) Is(values ...RepairOperation) bool {
	if x == nil {
		return false
	}
...
const (
	...
	// waiting for receipt
	ETHTxnStatus_MINED ETHTxnStatus = 8
)
...
func (x *Order) UnmarshalText(b []byte) error {
	*x = Order(string(b))
	return nil
}

func (x *Order) Is(values ...Order) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
type SenderStatus struct {
	...
	Nonce        *NonceStatus   `json:"nonce,omitempty"`
	Current      *CurrentStatus `json:"current,omitempty"`
}

type NonceStatus struct {
	Chain   uint64 `json:"chain"`
	Mempool uint64 `json:"mempool"`
}

type CurrentStatus struct {
	Transaction string             `json:"transaction"`
	First       *TransactionStatus `json:"first"`
	Latest      *TransactionStatus `json:"latest,omitempty"`
}

type TransactionStatus struct {
	Transaction prototyp.Hash   `json:"transaction"`
	Gas         uint64          `json:"gas"`
	GasPrice    prototyp.BigInt `json:"gasPrice"`
	PriorityFee prototyp.BigInt `json:"priorityFee"`
...
// TODO: rename fields eventually (contract -> to, input -> execdata), rename struct to MetaTxnRaw
type MetaTxn struct {
	...
	Authorization *EIP7702Authorization `json:"authorization"`
}
...
type EIP7702Authorization struct {
	...
	// 0x-prefixed 65-byte r || s || yParity signature
...
type MetaTxnLog struct {
	...
	// Bridge gas (in wei) to be fronted at runtime with the transaction.
	...
	TxnArgs       TxnArgs                `json:"txnArgs" db:"txn_args"`
...
func NewRelayerClient(addr string, client HTTPClient) RelayerClient {
	...
	urls := [41]string{
		...
		prefix + "FeeTokens",
		prefix + "FeeOptions",
		prefix + "SendMetaTxnWithBridgeGas",
		prefix + "FeeOptionsWithBridgeGas",
		...
		prefix + "ListEcosystemGasSponsors",
		prefix + "GetEcosystemGasSponsor",
		prefix + "AddEcosystemGasSponsor",
		prefix + "UpdateEcosystemGasSponsor",
		prefix + "RemoveEcosystemGasSponsor",
...
func (c *relayerClient) GetMetaTxnReceipt(ctx context.Context, metaTxID string) (*MetaTxnReceipt, bool, error) {
	in := struct {
		Arg0 string `json:"metaTxID"`
	}{metaTxID}
	out := struct {
		Ret0 *MetaTxnReceipt `json:"receipt"`
		Ret1 bool            `json:"metaTxnEnqueued"`
	}{}
...
func (c *relayerClient) FeeOptions(ctx context.Context, wallet string, to string, data string, simulate *bool, authorization *EIP7702Authorization) ([]*FeeOption, bool, *string, error) {
	in := struct {
		Arg0 string                `json:"wallet"`
		Arg1 string                `json:"to"`
		Arg2 string                `json:"data"`
		Arg3 *bool                 `json:"simulate"`
		Arg4 *EIP7702Authorization `json:"authorization"`
	}{wallet, to, data, simulate, authorization}
	out := struct {
...
func (c *relayerClient) SendMetaTxnWithBridgeGas(ctx context.Context, call *MetaTxn, quote *string, projectID *uint64, bridgeGas string, preconditions []*TransactionPrecondition) (bool, string, error) {
	in := struct {
		Arg0 *MetaTxn                   `json:"call"`
		Arg1 *string                    `json:"quote"`
		Arg2 *uint64                    `json:"projectID"`
		Arg3 string                     `json:"bridgeGas"`
		Arg4 []*TransactionPrecondition `json:"preconditions"`
	}{call, quote, projectID, bridgeGas, preconditions}
	out := struct {
		Ret0 bool   `json:"status"`
		Ret1 string `json:"txnHash"`
	}{}
...
func (c *relayerClient) FeeOptionsWithBridgeGas(ctx context.Context, wallet string, to string, data string, simulate *bool, bridgeGas string, authorization *EIP7702Authorization) ([]*FeeOption, bool, *string, error) {
	in := struct {
		Arg0 string                `json:"wallet"`
		Arg1 string                `json:"to"`
		Arg2 string                `json:"data"`
		Arg3 *bool                 `json:"simulate"`
		Arg4 string                `json:"bridgeGas"`
		Arg5 *EIP7702Authorization `json:"authorization"`
	}{wallet, to, data, simulate, bridgeGas, authorization}
	out := struct {
		Ret0 []*FeeOption `json:"options"`
		Ret1 bool         `json:"sponsored"`
		Ret2 *string      `json:"quote"`
...
func (c *relayerClient) StartSender(ctx context.Context, sender int) error {
	in := struct {
...
func (c *relayerClient) RepairSender(ctx context.Context, sender int, nonce uint64, operation RepairOperation) error {
	in := struct {
		Arg0 int             `json:"sender"`
		Arg1 uint64          `json:"nonce"`
		Arg2 RepairOperation `json:"operation"`
	}{sender, nonce, operation}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[18], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *relayerClient) ListEcosystemGasSponsors(ctx context.Context, ecosystemId uint64, page *Page) (*Page, []*GasSponsor, error) {
	in := struct {
...
func (c *relayerClient) GetEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, id uint64) (*GasSponsor, error) {
	in := struct {
		Arg0 uint64 `json:"ecosystemId"`
		Arg1 uint64 `json:"id"`
	}{ecosystemId, id}
...
func (c *relayerClient) AddEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, address string, name *string, active *bool) (bool, *GasSponsor, error) {
	in := struct {
		Arg0 uint64  `json:"ecosystemId"`
		Arg1 string  `json:"address"`
		Arg2 *string `json:"name"`
		Arg3 *bool   `json:"active"`
	}{ecosystemId, address, name, active}
	out := struct {
		Ret0 bool        `json:"status"`
		Ret1 *GasSponsor `json:"gasSponsor"`
	}{}
...
func (c *relayerClient) UpdateEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, id uint64, name *string, active *bool) (bool, *GasSponsor, error) {
	in := struct {
		Arg0 uint64  `json:"ecosystemId"`
		Arg1 uint64  `json:"id"`
		Arg2 *string `json:"name"`
		Arg3 *bool   `json:"active"`
	}{ecosystemId, id, name, active}
	out := struct {
		Ret0 bool        `json:"status"`
		Ret1 *GasSponsor `json:"gasSponsor"`
	}{}
...
func (c *relayerClient) RemoveEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, id uint64) (bool, error) {
	in := struct {
		Arg0 uint64 `json:"ecosystemId"`
		Arg1 uint64 `json:"id"`
	}{ecosystemId, id}
...
func NewRelayerServer(svc RelayerServer) *relayerService {
	return &relayerService{
		RelayerServer: svc,
	}
}

func (s *relayerService) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
	...
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "Relayer")

	r = r.WithContext(ctx)

	var handler func(ctx context.Context, w http.ResponseWriter, r *http.Request)
	switch r.URL.Path {
	case "/rpc/Relayer/Ping":
		handler = s.servePingJSON
	case "/rpc/Relayer/Version":
		handler = s.serveVersionJSON
	case "/rpc/Relayer/RuntimeStatus":
		handler = s.serveRuntimeStatusJSON
	case "/rpc/Relayer/GetSequenceContext":
		handler = s.serveGetSequenceContextJSON
	case "/rpc/Relayer/GetChainID":
		handler = s.serveGetChainIDJSON
	case "/rpc/Relayer/SendMetaTxn":
		handler = s.serveSendMetaTxnJSON
	case "/rpc/Relayer/GetMetaTxnNonce":
		handler = s.serveGetMetaTxnNonceJSON
	case "/rpc/Relayer/GetMetaTxnReceipt":
		handler = s.serveGetMetaTxnReceiptJSON
	case "/rpc/Relayer/Simulate":
		handler = s.serveSimulateJSON
	case "/rpc/Relayer/SimulateV3":
		handler = s.serveSimulateV3JSON
	case "/rpc/Relayer/UpdateMetaTxnGasLimits":
		handler = s.serveUpdateMetaTxnGasLimitsJSON
	case "/rpc/Relayer/FeeTokens":
		handler = s.serveFeeTokensJSON
	case "/rpc/Relayer/FeeOptions":
		handler = s.serveFeeOptionsJSON
	case "/rpc/Relayer/SendMetaTxnWithBridgeGas":
		handler = s.serveSendMetaTxnWithBridgeGasJSON
	case "/rpc/Relayer/FeeOptionsWithBridgeGas":
		handler = s.serveFeeOptionsWithBridgeGasJSON
	case "/rpc/Relayer/GetMetaTxnNetworkFeeOptions":
		handler = s.serveGetMetaTxnNetworkFeeOptionsJSON
	case "/rpc/Relayer/StartSender":
		handler = s.serveStartSenderJSON
	case "/rpc/Relayer/StopSender":
		handler = s.serveStopSenderJSON
	case "/rpc/Relayer/RepairSender":
		handler = s.serveRepairSenderJSON
	case "/rpc/Relayer/GetMetaTransactions":
		handler = s.serveGetMetaTransactionsJSON
	case "/rpc/Relayer/GetTransactionCost":
		handler = s.serveGetTransactionCostJSON
	case "/rpc/Relayer/GetGasTank":
		handler = s.serveGetGasTankJSON
	case "/rpc/Relayer/AddGasTank":
		handler = s.serveAddGasTankJSON
	case "/rpc/Relayer/UpdateGasTank":
		handler = s.serveUpdateGasTankJSON
	case "/rpc/Relayer/NextGasTankBalanceAdjustmentNonce":
		handler = s.serveNextGasTankBalanceAdjustmentNonceJSON
	case "/rpc/Relayer/AdjustGasTankBalance":
		handler = s.serveAdjustGasTankBalanceJSON
	case "/rpc/Relayer/GetGasTankBalanceAdjustment":
		handler = s.serveGetGasTankBalanceAdjustmentJSON
	case "/rpc/Relayer/ListGasTankBalanceAdjustments":
		handler = s.serveListGasTankBalanceAdjustmentsJSON
	case "/rpc/Relayer/ListGasSponsors":
		handler = s.serveListGasSponsorsJSON
	case "/rpc/Relayer/GetGasSponsor":
		handler = s.serveGetGasSponsorJSON
	case "/rpc/Relayer/AddGasSponsor":
		handler = s.serveAddGasSponsorJSON
	case "/rpc/Relayer/UpdateGasSponsor":
		handler = s.serveUpdateGasSponsorJSON
	case "/rpc/Relayer/RemoveGasSponsor":
		handler = s.serveRemoveGasSponsorJSON
	case "/rpc/Relayer/ListEcosystemGasSponsors":
		handler = s.serveListEcosystemGasSponsorsJSON
	case "/rpc/Relayer/GetEcosystemGasSponsor":
		handler = s.serveGetEcosystemGasSponsorJSON
	case "/rpc/Relayer/AddEcosystemGasSponsor":
		handler = s.serveAddEcosystemGasSponsorJSON
	case "/rpc/Relayer/UpdateEcosystemGasSponsor":
		handler = s.serveUpdateEcosystemGasSponsorJSON
	case "/rpc/Relayer/RemoveEcosystemGasSponsor":
		handler = s.serveRemoveEcosystemGasSponsorJSON
	case "/rpc/Relayer/AddressGasSponsors":
		handler = s.serveAddressGasSponsorsJSON
	case "/rpc/Relayer/GetProjectBalance":
		handler = s.serveGetProjectBalanceJSON
	case "/rpc/Relayer/AdjustProjectBalance":
		handler = s.serveAdjustProjectBalanceJSON
	default:
...
func (s *relayerService) servePingJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "Ping")

	// Call service method implementation.
	ret0, err := s.RelayerServer.Ping(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveVersionJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "Version")

	// Call service method implementation.
	ret0, err := s.RelayerServer.Version(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveRuntimeStatusJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "RuntimeStatus")

	// Call service method implementation.
	ret0, err := s.RelayerServer.RuntimeStatus(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetSequenceContextJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetSequenceContext")

	// Call service method implementation.
	ret0, err := s.RelayerServer.GetSequenceContext(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetChainIDJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetChainID")

	// Call service method implementation.
	ret0, err := s.RelayerServer.GetChainID(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveSendMetaTxnJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "SendMetaTxn")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.SendMetaTxn(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetMetaTxnNonceJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetMetaTxnNonce")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetMetaTxnNonce(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetMetaTxnReceiptJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetMetaTxnReceipt")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.GetMetaTxnReceipt(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveSimulateJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "Simulate")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.Simulate(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveSimulateV3JSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "SimulateV3")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.SimulateV3(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveUpdateMetaTxnGasLimitsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "UpdateMetaTxnGasLimits")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.UpdateMetaTxnGasLimits(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveFeeTokensJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "FeeTokens")

	// Call service method implementation.
	ret0, ret1, ret2, err := s.RelayerServer.FeeTokens(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveFeeOptionsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "FeeOptions")
	...
	// Call service method implementation.
	ret0, ret1, ret2, err := s.RelayerServer.FeeOptions(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveSendMetaTxnWithBridgeGasJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "SendMetaTxnWithBridgeGas")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.SendMetaTxnWithBridgeGas(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveFeeOptionsWithBridgeGasJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "FeeOptionsWithBridgeGas")
	...
	// Call service method implementation.
	ret0, ret1, ret2, err := s.RelayerServer.FeeOptionsWithBridgeGas(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4, reqPayload.Arg5)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetMetaTxnNetworkFeeOptionsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetMetaTxnNetworkFeeOptions")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetMetaTxnNetworkFeeOptions(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveStartSenderJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "StartSender")
	...
	// Call service method implementation.
	err = s.RelayerServer.StartSender(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveStopSenderJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "StopSender")
	...
	// Call service method implementation.
	err = s.RelayerServer.StopSender(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveRepairSenderJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "RepairSender")
	...
	// Call service method implementation.
	err = s.RelayerServer.RepairSender(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetMetaTransactionsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetMetaTransactions")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.GetMetaTransactions(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetTransactionCostJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetTransactionCost")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetTransactionCost(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetGasTankJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetGasTank")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetGasTank(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveAddGasTankJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "AddGasTank")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.AddGasTank(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveUpdateGasTankJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "UpdateGasTank")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.UpdateGasTank(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveNextGasTankBalanceAdjustmentNonceJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "NextGasTankBalanceAdjustmentNonce")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.NextGasTankBalanceAdjustmentNonce(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveAdjustGasTankBalanceJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "AdjustGasTankBalance")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.AdjustGasTankBalance(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetGasTankBalanceAdjustmentJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetGasTankBalanceAdjustment")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetGasTankBalanceAdjustment(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveListGasTankBalanceAdjustmentsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListGasTankBalanceAdjustments")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.ListGasTankBalanceAdjustments(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveListGasSponsorsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListGasSponsors")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.ListGasSponsors(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetGasSponsorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetGasSponsor")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetGasSponsor(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveAddGasSponsorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "AddGasSponsor")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.AddGasSponsor(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveUpdateGasSponsorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "UpdateGasSponsor")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.UpdateGasSponsor(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveRemoveGasSponsorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "RemoveGasSponsor")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.RemoveGasSponsor(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveListEcosystemGasSponsorsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListEcosystemGasSponsors")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.ListEcosystemGasSponsors(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetEcosystemGasSponsorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetEcosystemGasSponsor")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetEcosystemGasSponsor(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveAddEcosystemGasSponsorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "AddEcosystemGasSponsor")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.AddEcosystemGasSponsor(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveUpdateEcosystemGasSponsorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "UpdateEcosystemGasSponsor")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.UpdateEcosystemGasSponsor(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveRemoveEcosystemGasSponsorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "RemoveEcosystemGasSponsor")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.RemoveEcosystemGasSponsor(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveAddressGasSponsorsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "AddressGasSponsors")
	...
	// Call service method implementation.
	ret0, ret1, err := s.RelayerServer.AddressGasSponsors(ctx, reqPayload.Arg0, reqPayload.Arg1)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveGetProjectBalanceJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetProjectBalance")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.GetProjectBalance(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) serveAdjustProjectBalanceJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "AdjustProjectBalance")
	...
	// Call service method implementation.
	ret0, err := s.RelayerServer.AdjustProjectBalance(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *relayerService) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
...
var methods = map[string]*method{
	...
	"/rpc/Relayer/SendMetaTxnWithBridgeGas": {
		name:        "SendMetaTxnWithBridgeGas",
		service:     "Relayer",
		annotations: map[string]string{},
	},
	"/rpc/Relayer/FeeOptionsWithBridgeGas": {
	...
	"/rpc/Relayer/StartSender": {
		name:        "StartSender",
		service:     "Relayer",
		annotations: map[string]string{},
	},
	"/rpc/Relayer/StopSender": {
		name:        "StopSender",
		service:     "Relayer",
		annotations: map[string]string{},
	},
	"/rpc/Relayer/RepairSender": {
		name:        "RepairSender",
		service:     "Relayer",
		annotations: map[string]string{},
	},
	...
	"/rpc/Relayer/ListEcosystemGasSponsors": {
		name:        "ListEcosystemGasSponsors",
		service:     "Relayer",
		annotations: map[string]string{},
	},
	"/rpc/Relayer/GetEcosystemGasSponsor": {
		name:        "GetEcosystemGasSponsor",
		service:     "Relayer",
		annotations: map[string]string{},
	},
	"/rpc/Relayer/AddEcosystemGasSponsor": {
		name:        "AddEcosystemGasSponsor",
		service:     "Relayer",
		annotations: map[string]string{},
	},
	"/rpc/Relayer/UpdateEcosystemGasSponsor": {
		name:        "UpdateEcosystemGasSponsor",
		service:     "Relayer",
		annotations: map[string]string{},
	},
	"/rpc/Relayer/RemoveEcosystemGasSponsor": {
		name:        "RemoveEcosystemGasSponsor",
		service:     "Relayer",
		annotations: map[string]string{},
	},
...
const WebrpcHeaderValue = "webrpc@v0.32.2;gen-golang@v0.24.0;sequence-relayer@v0.4.1"
