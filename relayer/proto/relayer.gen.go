// sequence-relayer v0.4.1 f727656d293708e0aef6fc567b7591894ffcf77c
// --
...
func WebRPCSchemaHash() string {
	return "f727656d293708e0aef6fc567b7591894ffcf77c"
}
...
type RelayerClient interface {
	...
	FeeOptions(ctx context.Context, wallet string, to string, data string, simulate *bool, nativeValue *string) ([]*FeeOption, bool, *string, error)
	// TODO: deprecated, to be removed by https://github.com/0xsequence/stack/pull/356 at a later date
...
type MetaTxn struct {
	...
	// Native value (in wei) to be fronted at runtime with the transaction.
	// Used for bridge fees (e.g., LayerZero messaging fees) that require msg.value.
	NativeValue *prototyp.BigInt `json:"nativeValue" db:"native_value"`
}
...
func (c *relayerClient) FeeOptions(ctx context.Context, wallet string, to string, data string, simulate *bool, nativeValue *string) ([]*FeeOption, bool, *string, error) {
	in := struct {
		Arg0 string  `json:"wallet"`
		Arg1 string  `json:"to"`
		Arg2 string  `json:"data"`
		Arg3 *bool   `json:"simulate"`
		Arg4 *string `json:"nativeValue"`
	}{wallet, to, data, simulate, nativeValue}
	out := struct {
