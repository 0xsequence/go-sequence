...
func WebRPCSchemaHash() string {
	return "b5902e32e652488166fc44a95f5cda0c67e10d82"
}
...
type RelayerClient interface {
	...
	GetMetaTransactions(ctx context.Context, projectId uint64, page *Page, includeNonSponsored *bool) (*Page, []*MetaTxnLog, error)
	...
	AddGasSponsor(ctx context.Context, projectId uint64, address string, name *string, active *bool, webhookUrl *string, webhookAuthToken *string) (bool, *GasSponsor, error)
	UpdateGasSponsor(ctx context.Context, projectId uint64, id uint64, name *string, active *bool, webhookUrl *string, webhookAuthToken *string) (bool, *GasSponsor, error)
	...
	AddEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, address string, name *string, active *bool, webhookUrl *string, webhookAuthToken *string) (bool, *GasSponsor, error)
	UpdateEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, id uint64, name *string, active *bool, webhookUrl *string, webhookAuthToken *string) (bool, *GasSponsor, error)
...
type GasSponsor struct {
	...
	WebhookAuthToken string        `json:"-" db:"webhook_auth_token"`
	UpdatedAt        *time.Time    `json:"updatedAt" db:"updated_at,omitempty"`
	CreatedAt        *time.Time    `json:"createdAt" db:"created_at,omitempty"`
...
func (c *relayerClient) GetMetaTransactions(ctx context.Context, projectId uint64, page *Page, includeNonSponsored *bool) (*Page, []*MetaTxnLog, error) {
	in := struct {
		Arg0 uint64 `json:"projectId"`
		Arg1 *Page  `json:"page"`
		Arg2 *bool  `json:"includeNonSponsored"`
	}{projectId, page, includeNonSponsored}
	out := struct {
		Ret0 *Page         `json:"page"`
...
func (c *relayerClient) AddGasSponsor(ctx context.Context, projectId uint64, address string, name *string, active *bool, webhookUrl *string, webhookAuthToken *string) (bool, *GasSponsor, error) {
	in := struct {
		Arg0 uint64  `json:"projectId"`
		Arg1 string  `json:"address"`
		Arg2 *string `json:"name"`
		Arg3 *bool   `json:"active"`
		Arg4 *string `json:"webhookUrl"`
		Arg5 *string `json:"webhookAuthToken"`
	}{projectId, address, name, active, webhookUrl, webhookAuthToken}
	out := struct {
		Ret0 bool        `json:"status"`
...
func (c *relayerClient) UpdateGasSponsor(ctx context.Context, projectId uint64, id uint64, name *string, active *bool, webhookUrl *string, webhookAuthToken *string) (bool, *GasSponsor, error) {
	in := struct {
		Arg0 uint64  `json:"projectId"`
		Arg1 uint64  `json:"id"`
		Arg2 *string `json:"name"`
		...
		Arg4 *string `json:"webhookUrl"`
		Arg5 *string `json:"webhookAuthToken"`
	}{projectId, id, name, active, webhookUrl, webhookAuthToken}
	out := struct {
		Ret0 bool        `json:"status"`
		Ret1 *GasSponsor `json:"gasSponsor"`
	}{}
...
func (c *relayerClient) AddEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, address string, name *string, active *bool, webhookUrl *string, webhookAuthToken *string) (bool, *GasSponsor, error) {
	in := struct {
		Arg0 uint64  `json:"ecosystemId"`
		Arg1 string  `json:"address"`
		Arg2 *string `json:"name"`
		...
		Arg4 *string `json:"webhookUrl"`
		Arg5 *string `json:"webhookAuthToken"`
	}{ecosystemId, address, name, active, webhookUrl, webhookAuthToken}
	out := struct {
		Ret0 bool        `json:"status"`
		Ret1 *GasSponsor `json:"gasSponsor"`
	}{}
...
func (c *relayerClient) UpdateEcosystemGasSponsor(ctx context.Context, ecosystemId uint64, id uint64, name *string, active *bool, webhookUrl *string, webhookAuthToken *string) (bool, *GasSponsor, error) {
	in := struct {
		Arg0 uint64  `json:"ecosystemId"`
		Arg1 uint64  `json:"id"`
		Arg2 *string `json:"name"`
		...
		Arg4 *string `json:"webhookUrl"`
		Arg5 *string `json:"webhookAuthToken"`
	}{ecosystemId, id, name, active, webhookUrl, webhookAuthToken}
	out := struct {
		Ret0 bool        `json:"status"`
		Ret1 *GasSponsor `json:"gasSponsor"`
	}{}
