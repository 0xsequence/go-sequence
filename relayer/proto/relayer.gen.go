// sequence-relayer v0.4.1 a868298438a2fab314581c4ba7e21b0dcca1db60
// --
...
func WebRPCSchemaHash() string {
	return "a868298438a2fab314581c4ba7e21b0dcca1db60"
}
...
type RelayerClient interface {
	...
	// Internal endpoint for service-to-service calls that require bridge gas fronting
	// Used by Trails/Excalibur for LayerZero OFT bridge transactions
	SendMetaTxnWithBridgeGas(ctx context.Context, call *MetaTxn, bridgeGas string, quote *string, projectID *uint64, preconditions []*TransactionPrecondition) (bool, string, error)
	...
	// This value will be included in the fee calculation so the relayer gets reimbursed.
	FeeOptions(ctx context.Context, wallet string, to string, data string, simulate *bool, bridgeGas *string) ([]*FeeOption, bool, *string, error)
	// TODO: deprecated, to be removed by https://github.com/0xsequence/stack/pull/356 at a later date
...
func (c *relayerClient) SendMetaTxnWithBridgeGas(ctx context.Context, call *MetaTxn, bridgeGas string, quote *string, projectID *uint64, preconditions []*TransactionPrecondition) (bool, string, error) {
	in := struct {
		Arg0 *MetaTxn                   `json:"call"`
		Arg1 string                     `json:"bridgeGas"`
		Arg2 *string                    `json:"quote"`
		Arg3 *uint64                    `json:"projectID"`
		Arg4 []*TransactionPrecondition `json:"preconditions"`
	}{call, bridgeGas, quote, projectID, preconditions}
	out := struct {
		Ret0 bool   `json:"status"`
		Ret1 string `json:"txnHash"`
	}{}
...
func (c *relayerClient) FeeOptions(ctx context.Context, wallet string, to string, data string, simulate *bool, bridgeGas *string) ([]*FeeOption, bool, *string, error) {
	in := struct {
		Arg0 string  `json:"wallet"`
		Arg1 string  `json:"to"`
