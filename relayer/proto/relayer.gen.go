...
func WebRPCSchemaHash() string {
	return "bd3705af98733b4e18f366d63a03999ffdc0c403"
}
...
func NewRelayerServer(svc Relayer) WebRPCServer {
	return &relayerServer{
		Relayer: svc,
	}
}

func (s *relayerServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	case "/rpc/Relayer/GetSequenceContext":
		s.serveGetSequenceContext(ctx, w, r)
		return
	case "/rpc/Relayer/GetChainID":
		s.serveGetChainID(ctx, w, r)
		return
	case "/rpc/Relayer/SendMetaTxn":
		s.serveSendMetaTxn(ctx, w, r)
		return
	case "/rpc/Relayer/GetMetaTxnNonce":
		s.serveGetMetaTxnNonce(ctx, w, r)
		return
	case "/rpc/Relayer/GetMetaTxnReceipt":
		s.serveGetMetaTxnReceipt(ctx, w, r)
		return
	case "/rpc/Relayer/UpdateMetaTxnGasLimits":
		s.serveUpdateMetaTxnGasLimits(ctx, w, r)
		return
	case "/rpc/Relayer/FeeTokens":
		s.serveFeeTokens(ctx, w, r)
		return
	case "/rpc/Relayer/GetMetaTxnNetworkFeeOptions":
		s.serveGetMetaTxnNetworkFeeOptions(ctx, w, r)
		return
	case "/rpc/Relayer/SentTransactions":
		s.serveSentTransactions(ctx, w, r)
		return
	case "/rpc/Relayer/PendingTransactions":
		s.servePendingTransactions(ctx, w, r)
		return
	default:
...
func (s *relayerServer) servePing(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *relayerServer) servePingJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
...
func (s *relayerServer) serveVersion(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *relayerServer) serveVersionJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.Relayer.Version(ctx)
	}()
	respContent := struct {
...
func (s *relayerServer) serveRuntimeStatus(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *relayerServer) serveRuntimeStatusJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.Relayer.RuntimeStatus(ctx)
	}()
	respContent := struct {
...
func (s *relayerServer) serveGetSequenceContext(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetSequenceContextJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *relayerServer) serveGetSequenceContextJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetSequenceContext")

	// Call service method
	var ret0 *SequenceContext
	func() {
		defer func() {
			// In case of a panic, serve a 500 error and then panic.
			if rr := recover(); rr != nil {
		...
		ret0, err = s.Relayer.GetSequenceContext(ctx)
	}()
	respContent := struct {
...
func (s *relayerServer) serveGetChainID(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *relayerServer) serveGetChainIDJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.Relayer.GetChainID(ctx)
	}()
	respContent := struct {
...
func (s *relayerServer) serveSendMetaTxn(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveSendMetaTxnJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *relayerServer) serveSendMetaTxnJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, ret1, err = s.Relayer.SendMetaTxn(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 bool   `json:"status"`
...
func (s *relayerServer) serveGetMetaTxnNonce(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetMetaTxnNonceJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *relayerServer) serveGetMetaTxnNonceJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.Relayer.GetMetaTxnNonce(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
...
func (s *relayerServer) serveGetMetaTxnReceipt(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetMetaTxnReceiptJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *relayerServer) serveGetMetaTxnReceiptJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.Relayer.GetMetaTxnReceipt(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *relayerServer) serveUpdateMetaTxnGasLimits(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveUpdateMetaTxnGasLimitsJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *relayerServer) serveUpdateMetaTxnGasLimitsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.Relayer.UpdateMetaTxnGasLimits(ctx, reqContent.Arg0, reqContent.Arg1, reqContent.Arg2)
	}()
	respContent := struct {
...
func (s *relayerServer) serveFeeTokens(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *relayerServer) serveFeeTokensJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, ret1, err = s.Relayer.FeeTokens(ctx)
	}()
	respContent := struct {
...
func (s *relayerServer) serveGetMetaTxnNetworkFeeOptions(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveGetMetaTxnNetworkFeeOptionsJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *relayerServer) serveGetMetaTxnNetworkFeeOptionsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.Relayer.GetMetaTxnNetworkFeeOptions(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
...
func (s *relayerServer) serveSentTransactions(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveSentTransactionsJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *relayerServer) serveSentTransactionsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "SentTransactions")
	reqContent := struct {
	...
	func() {
		...
		ret0, ret1, err = s.Relayer.SentTransactions(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
		Ret0 *Page          `json:"page"`
...
func (s *relayerServer) servePendingTransactions(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.servePendingTransactionsJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *relayerServer) servePendingTransactionsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "PendingTransactions")
	reqContent := struct {
		Arg0 *Page `json:"page"`
	}{}
	...
	func() {
		...
		ret0, ret1, err = s.Relayer.PendingTransactions(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 *Page          `json:"page"`
		Ret1 []*Transaction `json:"transactions"`
