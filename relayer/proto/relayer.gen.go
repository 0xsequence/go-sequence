// sequence-relayer v0.4.0 876833b8b84f37adc43adf71fb80404e604fb67c
// --
...
func WebRPCSchemaHash() string {
	return "876833b8b84f37adc43adf71fb80404e604fb67c"
}
...
type Relayer interface {
	...
	ListGasSponsors(ctx context.Context, gasTankId uint64, page *Page) (*Page, []*GasSponsor, error)
	AddGasSponsor(ctx context.Context, gasTankId uint64, address string, name *string, active *bool) (bool, *GasSponsor, error)
	...
	ReportGasSponsorUsage(ctx context.Context, gasTankId uint64, startTime *time.Time, endTime *time.Time) ([]*GasSponsorUsage, error)
...
func (c *relayerClient) ListGasSponsors(ctx context.Context, gasTankId uint64, page *Page) (*Page, []*GasSponsor, error) {
	in := struct {
		Arg0 uint64 `json:"gasTankId"`
		Arg1 *Page  `json:"page"`
	}{gasTankId, page}
	out := struct {
		Ret0 *Page         `json:"page"`
...
func (c *relayerClient) AddGasSponsor(ctx context.Context, gasTankId uint64, address string, name *string, active *bool) (bool, *GasSponsor, error) {
	in := struct {
		Arg0 uint64  `json:"gasTankId"`
		Arg1 string  `json:"address"`
		Arg2 *string `json:"name"`
		Arg3 *bool   `json:"active"`
	}{gasTankId, address, name, active}
	out := struct {
		Ret0 bool        `json:"status"`
...
func (c *relayerClient) ReportGasSponsorUsage(ctx context.Context, gasTankId uint64, startTime *time.Time, endTime *time.Time) ([]*GasSponsorUsage, error) {
	in := struct {
		Arg0 uint64     `json:"gasTankId"`
		Arg1 *time.Time `json:"startTime"`
		Arg2 *time.Time `json:"endTime"`
	}{gasTankId, startTime, endTime}
	out := struct {
