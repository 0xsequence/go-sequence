...
// Source: ../indexer (interfaces: Indexer,IndexerClient)
//
// Generated by this command:
//
//	mockgen -destination indexer.mock.go -package mock -mock_names Indexer=Indexer,IndexerClient=IndexerClient ../indexer Indexer,IndexerClient
//
