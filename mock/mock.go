...
//go:generate go run go.uber.org/mock/mockgen -destination indexer.mock.go -package mock -mock_names Indexer=Indexer,IndexerClient=IndexerClient ../indexer Indexer,IndexerClient
