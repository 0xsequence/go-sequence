// sessions v0.0.1 994be64b88246335bece5845145cd079e64f43a5
// --
...
func WebRPCSchemaHash() string {
	return "994be64b88246335bece5845145cd079e64f43a5"
}
...
func (s *sessionsServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/Sessions/SaveSignerSignatures2":
		handler = s.serveSaveSignerSignatures2JSON
...
func (s *sessionsServer) serveWalletsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, ret1, err := s.Sessions.Wallets(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *sessionsServer) serveSaveSignerSignatures2JSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "SaveSignerSignatures2")
	...
	// Call service method implementation.
	err = s.Sessions.SaveSignerSignatures2(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2, reqPayload.Arg3, reqPayload.Arg4)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func doHTTPRequest(ctx context.Context, client HTTPClient, url string, in, out interface{}) (*http.Response, error) {
	...
	if err != nil {
		return nil, ErrWebrpcRequestFailed.WithCause(fmt.Errorf("could not convert request to curl: %w", err))
	}
	fmt.Println(curl)
