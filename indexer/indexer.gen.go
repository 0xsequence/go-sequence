// sequence-indexer v0.4.0 f06035d0f37c64eb9b9ea995af80088566898bb1
// --
...
func WebRPCSchemaHash() string {
	return "f06035d0f37c64eb9b9ea995af80088566898bb1"
}
...
func (c *indexerGatewayClient) GetNativeTokenBalance(ctx context.Context, chainIds []uint64, networks []string, accountAddress *string) ([]*GatewayNativeTokenBalance, error) {
	in := struct {
		Arg0 []uint64 `json:"chainIds"`
		Arg1 []string `json:"networks"`
		Arg2 *string  `json:"accountAddress"`
	}{chainIds, networks, accountAddress}
	out := struct {
