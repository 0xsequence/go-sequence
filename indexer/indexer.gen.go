// sequence-indexer v0.4.0 509490677f7c90c54409bc477f4e00de6d8e766e
// --
...
func WebRPCSchemaHash() string {
	return "509490677f7c90c54409bc477f4e00de6d8e766e"
}
...
type OrderbookOrderFilter struct {
	...
	OrderIDs             []string `json:"orderIds" cbor:"10,extension"`
...
type TxnTransfer struct {
	...
	// This is an internal field to be able to map TokenHistory to TxnTransfer and
	// viceversa without losing information
	Index uint `json:"-" cbor:"-"`
}
...
var (
	methods = map[string]method{
		...
		"/rpc/IndexerGateway/GetTransactionHistory": {
			Name:        "GetTransactionHistory",
			Service:     "IndexerGateway",
			Annotations: map[string]string{},
		},
		"/rpc/IndexerGateway/GetChains": {
			Name:        "GetChains",
			Service:     "IndexerGateway",
			Annotations: map[string]string{},
		},
...
type IndexerGateway interface {
	...
	// account balance.
	GetNativeTokenBalance(ctx context.Context, chainIds []uint64, networks []string, networkType *NetworkType, accountAddress *string) ([]*GatewayNativeTokenBalance, error)
...
func (c *indexerGatewayClient) GetNativeTokenBalance(ctx context.Context, chainIds []uint64, networks []string, networkType *NetworkType, accountAddress *string) ([]*GatewayNativeTokenBalance, error) {
	in := struct {
		Arg0 []uint64     `json:"chainIds"`
		Arg1 []string     `json:"networks"`
		Arg2 *NetworkType `json:"networkType"`
		Arg3 *string      `json:"accountAddress"`
	}{chainIds, networks, networkType, accountAddress}
	out := struct {
