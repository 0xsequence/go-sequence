// sequence-indexer v0.4.0 42a988bcb0871f1249450f0d92967db5b47ff33e
// --
...
func WebRPCSchemaHash() string {
	return "42a988bcb0871f1249450f0d92967db5b47ff33e"
}
...
type Indexer interface {
	...
	GetOrderbookOrders(ctx context.Context, page *Page, orderbookContractAddress string, collectionAddress string, currencyAddresses []string, filter *OrderbookOrderFilter, orderStatuses []OrderStatus) (*Page, []*OrderbookOrder, error)
...
func (c *indexerClient) GetOrderbookOrders(ctx context.Context, page *Page, orderbookContractAddress string, collectionAddress string, currencyAddresses []string, filter *OrderbookOrderFilter, orderStatuses []OrderStatus) (*Page, []*OrderbookOrder, error) {
	in := struct {
		Arg0 *Page                 `json:"page"`
	...
	}{page, orderbookContractAddress, collectionAddress, currencyAddresses, filter, orderStatuses}
	out := struct {
		Ret0 *Page             `json:"page"`
