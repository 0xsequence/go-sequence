// sequence-indexer v0.4.0 b1272cb0621038e4142bd24d87ccd2cfa1ac30c9
// --
...
func WebRPCSchemaHash() string {
	return "b1272cb0621038e4142bd24d87ccd2cfa1ac30c9"
}
...
func (c *indexerClient) GetTokenBalances(ctx context.Context, accountAddress *string, contractAddress *string, tokenID *string, includeMetadata *bool, page *Page) (*Page, []*TokenBalance, error) {
	in := struct {
		Arg0 *string `json:"accountAddress"`
		...
		Arg4 *Page   `json:"page"`
	}{accountAddress, contractAddress, tokenID, includeMetadata, page}
	out := struct {
		Ret0 *Page           `json:"page"`
