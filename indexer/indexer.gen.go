// sequence-indexer v0.4.0 b4b5067fbad8ba2bb876def30b01ec32e4fe698f
// --
...
func WebRPCSchemaHash() string {
	return "b4b5067fbad8ba2bb876def30b01ec32e4fe698f"
}
...
// - 'userAddresses' or 'excludeUserAddresses'
...
type Page struct {
	...
	//
	// NOTE: PAGE NUMBERS ARE DEPRECATED, USE CURSOR INSTEAD. PAGE NUMBERS WILL BE REMOVED
	// IN THE FUTURE.
...
type IndexerGateway interface {
	...
	// account balance.
	GetNativeTokenBalance(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, accountAddress *string) ([]*GatewayNativeTokenBalance, error)
	...
	GetTokenBalances(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, accountAddress *string, contractAddress *string, tokenID *string, includeMetadata *bool, metadataOptions *MetadataOptions, includeCollectionTokens *bool, page *Page) (*Page, []*GatewayTokenBalance, error)
	...
	GetTokenBalancesSummary(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error)
	// GetTokenBalancesDetails returns a detailed balance summary for the given
	// accounts on all indexer nodes. The collection ERC721 & ERC1155 tokens are
	// represented as individual balances.
	GetTokenBalancesDetails(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error)
	...
	// represented as individual balances.
	GetTokenBalancesByContract(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, filter *TokenBalancesByContractFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayTokenBalance, error)
	// GetTokenBalances returns a balance summary/details for an specific account
	// on all indexer nodes. By default if accountAddress is left empty, it will
	// use the account from the jwt session.
	GetBalanceUpdates(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, contractAddress string, lastBlockNumber uint64, lastBlockHash *string, page *Page) (*Page, []*GatewayTokenBalance, error)
	// Ping the indexer
	Ping(ctx context.Context) (bool, error)
	// Get the current version of the indexer
	Version(ctx context.Context) (*Version, error)
...
func (c *indexerClient) GetTokenIDRanges(ctx context.Context, contractAddress string) (ContractType, []*TokenIDRange, bool, error) {
	in := struct {
		Arg0 string `json:"contractAddress"`
	}{contractAddress}
	out := struct {
...
func (c *indexerClient) SubscribeEvents(ctx context.Context, filter *EventFilter) (SubscribeEventsStreamReader, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[19], in, nil)
	if err != nil {
		if resp != nil {
			resp.Body.Close()
		}
...
func (c *indexerClient) SubscribeBalanceUpdates(ctx context.Context, contractAddress string) (SubscribeBalanceUpdatesStreamReader, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[20], in, nil)
	if err != nil {
		if resp != nil {
			resp.Body.Close()
		}
...
func (c *indexerClient) SyncBalance(ctx context.Context, accountAddress string, contractAddress string, tokenID *string) error {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[21], in, nil)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *indexerGatewayClient) GetNativeTokenBalance(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, accountAddress *string) ([]*GatewayNativeTokenBalance, error) {
	in := struct {
		Arg0 []uint64 `json:"chainIds"`
		Arg1 []string `json:"networks"`
		Arg2 *bool    `json:"testnets"`
		Arg3 *string  `json:"accountAddress"`
	}{chainIds, networks, testnets, accountAddress}
	out := struct {
...
func (c *indexerGatewayClient) GetTokenBalances(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, accountAddress *string, contractAddress *string, tokenID *string, includeMetadata *bool, metadataOptions *MetadataOptions, includeCollectionTokens *bool, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64         `json:"chainIds"`
		Arg1 []string         `json:"networks"`
		Arg2 *bool            `json:"testnets"`
		...
		Arg9 *Page            `json:"page"`
	}{chainIds, networks, testnets, accountAddress, contractAddress, tokenID, includeMetadata, metadataOptions, includeCollectionTokens, page}
	out := struct {
		Ret0 *Page                  `json:"page"`
...
func (c *indexerGatewayClient) GetTokenBalancesSummary(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64             `json:"chainIds"`
		Arg1 []string             `json:"networks"`
		Arg2 *bool                `json:"testnets"`
		...
		Arg5 *Page                `json:"page"`
	}{chainIds, networks, testnets, filter, omitMetadata, page}
	out := struct {
		Ret0 *Page                         `json:"page"`
...
func (c *indexerGatewayClient) GetTokenBalancesDetails(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64             `json:"chainIds"`
		Arg1 []string             `json:"networks"`
		Arg2 *bool                `json:"testnets"`
...
func (c *indexerGatewayClient) GetTokenBalancesByContract(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, filter *TokenBalancesByContractFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64                       `json:"chainIds"`
		Arg1 []string                       `json:"networks"`
		Arg2 *bool                          `json:"testnets"`
...
func (c *indexerGatewayClient) GetBalanceUpdates(ctx context.Context, chainIds []uint64, networks []string, testnets *bool, contractAddress string, lastBlockNumber uint64, lastBlockHash *string, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64 `json:"chainIds"`
		Arg1 []string `json:"networks"`
		Arg2 *bool    `json:"testnets"`
		...
		Arg6 *Page    `json:"page"`
	}{chainIds, networks, testnets, contractAddress, lastBlockNumber, lastBlockHash, page}
	out := struct {
		Ret0 *Page                  `json:"page"`
		Ret1 []*GatewayTokenBalance `json:"balances"`
	}{}
