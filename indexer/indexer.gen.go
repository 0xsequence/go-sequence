// sequence-indexer v0.4.0 3706bc20b567c4a87214824c1ef8d1ce1df96db2
// --
...
func WebRPCSchemaHash() string {
	return "3706bc20b567c4a87214824c1ef8d1ce1df96db2"
}
...
type GatewayNativeTokenBalances struct {
	ChainID  uint64                `json:"chainID"`
	Error    error                 `json:"error,omitempty"`
	Balances []*NativeTokenBalance `json:"balances"`
}
...
type IndexerGateway interface {
	...
	// account balance.
	GetNativeTokenBalance(ctx context.Context, chainIds []uint64, accountAddress *string) ([]*GatewayNativeTokenBalance, error)
	...
	GetTokenBalances(ctx context.Context, chainIds []uint64, accountAddress *string, contractAddress *string, tokenID *string, includeMetadata *bool, metadataOptions *MetadataOptions, includeCollectionTokens *bool, page *Page) (*Page, []*GatewayTokenBalance, error)
	...
	GetTokenBalancesSummary(ctx context.Context, chainIds []uint64, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error)
	// GetTokenBalancesDetails returns a detailed balance summary for the given
	// accounts on all indexer nodes. The collection ERC721 & ERC1155 tokens are
	// represented as individual balances.
	GetTokenBalancesDetails(ctx context.Context, chainIds []uint64, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error)
	...
	// represented as individual balances.
	GetTokenBalancesByContract(ctx context.Context, chainIds []uint64, filter *TokenBalancesByContractFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayTokenBalance, error)
	// GetTokenBalances returns a balance summary/details for an specific account
	// on all indexer nodes. By default if accountAddress is left empty, it will
	// use the account from the jwt session.
	GetBalanceUpdates(ctx context.Context, chainIds []uint64, contractAddress string, lastBlockNumber uint64, lastBlockHash *string, page *Page) (*Page, []*GatewayTokenBalance, error)
	// Ping the indexer
	Ping(ctx context.Context) (bool, error)
	// Get the current version of the indexer
	Version(ctx context.Context) (*Version, error)
...
func (c *indexerGatewayClient) GetNativeTokenBalance(ctx context.Context, chainIds []uint64, accountAddress *string) ([]*GatewayNativeTokenBalance, error) {
	in := struct {
		Arg0 []uint64 `json:"chainIds"`
		Arg1 *string  `json:"accountAddress"`
	}{chainIds, accountAddress}
	out := struct {
...
func (c *indexerGatewayClient) GetTokenBalances(ctx context.Context, chainIds []uint64, accountAddress *string, contractAddress *string, tokenID *string, includeMetadata *bool, metadataOptions *MetadataOptions, includeCollectionTokens *bool, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64         `json:"chainIds"`
		Arg1 *string          `json:"accountAddress"`
		Arg2 *string          `json:"contractAddress"`
		Arg3 *string          `json:"tokenID"`
		Arg4 *bool            `json:"includeMetadata"`
		Arg5 *MetadataOptions `json:"metadataOptions"`
		Arg6 *bool            `json:"includeCollectionTokens"`
		Arg7 *Page            `json:"page"`
	}{chainIds, accountAddress, contractAddress, tokenID, includeMetadata, metadataOptions, includeCollectionTokens, page}
	out := struct {
		Ret0 *Page                  `json:"page"`
...
func (c *indexerGatewayClient) GetTokenBalancesSummary(ctx context.Context, chainIds []uint64, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64             `json:"chainIds"`
		Arg1 *TokenBalancesFilter `json:"filter"`
		Arg2 *bool                `json:"omitMetadata"`
		Arg3 *Page                `json:"page"`
	}{chainIds, filter, omitMetadata, page}
	out := struct {
		Ret0 *Page                         `json:"page"`
...
func (c *indexerGatewayClient) GetTokenBalancesDetails(ctx context.Context, chainIds []uint64, filter *TokenBalancesFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayNativeTokenBalances, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64             `json:"chainIds"`
		Arg1 *TokenBalancesFilter `json:"filter"`
		Arg2 *bool                `json:"omitMetadata"`
...
func (c *indexerGatewayClient) GetTokenBalancesByContract(ctx context.Context, chainIds []uint64, filter *TokenBalancesByContractFilter, omitMetadata *bool, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64                       `json:"chainIds"`
		Arg1 *TokenBalancesByContractFilter `json:"filter"`
		Arg2 *bool                          `json:"omitMetadata"`
		Arg3 *Page                          `json:"page"`
	}{chainIds, filter, omitMetadata, page}
	out := struct {
...
func (c *indexerGatewayClient) GetBalanceUpdates(ctx context.Context, chainIds []uint64, contractAddress string, lastBlockNumber uint64, lastBlockHash *string, page *Page) (*Page, []*GatewayTokenBalance, error) {
	in := struct {
		Arg0 []uint64 `json:"chainIds"`
		Arg1 string   `json:"contractAddress"`
		Arg2 uint64   `json:"lastBlockNumber"`
		Arg3 *string  `json:"lastBlockHash"`
		Arg4 *Page    `json:"page"`
	}{chainIds, contractAddress, lastBlockNumber, lastBlockHash, page}
	out := struct {
		Ret0 *Page                  `json:"page"`
		Ret1 []*GatewayTokenBalance `json:"balances"`
	}{}
...
func (c *indexerGatewayClient) RuntimeStatus(ctx context.Context) (*RuntimeStatus, error) {
	out := struct {
		Ret0 *RuntimeStatus `json:"status"`
	}{}
