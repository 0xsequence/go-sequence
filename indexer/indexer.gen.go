// sequence-indexer v0.4.0 c22650bd63ac6602e52837dce7315b42b7a5698f
// --
...
func WebRPCSchemaHash() string {
	return "c22650bd63ac6602e52837dce7315b42b7a5698f"
}
...
func (x OrderStatus) MarshalJSON() ([]byte, error) {
	buf := bytes.NewBufferString(`"`)
	buf.WriteString(OrderStatus_name[uint32(x)])
	buf.WriteString(`"`)
	return buf.Bytes(), nil
}
...
func (x *OrderStatus) UnmarshalJSON(b []byte) error {
	...
	*x = OrderStatus(OrderStatus_value[j])
	return nil
}
