// trails-api v0.4.0 563242406b1457bb583d99d0c76c9e75e3f3b3f3
// --
// Code generated by webrpc-gen@v0.30.1 with golang generator. DO NOT EDIT.
//
...
func WebRPCSchemaHash() string {
	return "563242406b1457bb583d99d0c76c9e75e3f3b3f3"
}
...
type APIClient interface {
	...
	ExecuteIntent(ctx context.Context, intent *CommitIntentConfigParams) (*IntentConfig, error)
	...
	// TODOXXX: GetIntentDetails .. or another name..?
	...
	// TODOXXX: rename to GetIntentEntryTransaction
	...
	// TODOXXX: rename to GetIntentGasFeeOptions
	// Calculates fee options for intent entrypoint deposits.
	GetIntentEntrypointDepositFeeOptions(ctx context.Context, params *GetIntentEntrypointDepositFeeOptionsParams) (*GetIntentEntrypointDepositFeeOptionsResult, error)
	// TODOXXX: remove completely
	...
	QueueIntentConfigExecution(ctx context.Context, intentConfigId string) (bool, error)
	// Returns current execution status (pending/processing/executed/failed) for a given intent config.
	GetIntentConfigExecutionStatus(ctx context.Context, intentConfigId string) (string, error)
...
const (
	ExecutionStatus_created    ExecutionStatus = 0
	ExecutionStatus_pending    ExecutionStatus = 1
	ExecutionStatus_processing ExecutionStatus = 2
	ExecutionStatus_executed   ExecutionStatus = 3
	ExecutionStatus_failed     ExecutionStatus = 4
)

var ExecutionStatus_name = map[uint8]string{
	0: "created",
	1: "pending",
	2: "processing",
	3: "executed",
...
var ExecutionStatus_value = map[string]uint8{
	"created":    0,
	"pending":    1,
	"processing": 2,
	"executed":   3,
...
func (x ExecutionStatus) String() string {
	return ExecutionStatus_name[uint8(x)]
}

func (x ExecutionStatus) MarshalText() ([]byte, error) {
	return []byte(ExecutionStatus_name[uint8(x)]), nil
}

func (x *ExecutionStatus) UnmarshalText(b []byte) error {
	*x = ExecutionStatus(ExecutionStatus_value[string(b)])
	return nil
}

func (x *ExecutionStatus) Is(values ...ExecutionStatus) bool {
	if x == nil {
		return false
	}
...
type IntentConfig struct {
	...
	// TODO: This field/column seems to be unused in dev/prod DBs.
	...
	ExecutionStatus          ExecutionStatus     `json:"executionStatus" db:"execution_status,omitempty"`
	OriginMetaTxnID          prototyp.Hash       `json:"originMetaTxnId" db:"origin_meta_txn_id,omitempty"`
	DestinationMetaTxnID     prototyp.Hash       `json:"destinationMetaTxnId" db:"destination_meta_txn_id,omitempty"`
	OriginTxnHash            prototyp.Hash       `json:"originTxnHash" db:"origin_txn_hash,omitempty"`
	DestinationTxnHash       prototyp.Hash       `json:"destinationTxnHash" db:"destination_txn_hash,omitempty"`
	ProcessedAt              *time.Time          `json:"processedAt,omitempty" db:"processed_at,omitempty"`
	RetryCount               uint64              `json:"retryCount" db:"retry_count"`
...
type IntentPreconditionData struct {
	...
	// TODOXXX: this probably should be a hex string.. what does ERC
	Min uint64 `json:"min"`
}
...
var methods = map[string]method{
	...
	"/rpc/API/GetIntentEntrypointDepositFeeOptions": {
		name:        "GetIntentEntrypointDepositFeeOptions",
		service:     "API",
		annotations: map[string]string{"public": ""},
	},
...
func (c *apiClient) ExecuteIntent(ctx context.Context, intent *CommitIntentConfigParams) (*IntentConfig, error) {
	in := struct {
		Arg0 *CommitIntentConfigParams `json:"intent"`
	}{intent}
	out := struct {
...
func (c *apiClient) GetIntentEntrypointDepositFeeOptions(ctx context.Context, params *GetIntentEntrypointDepositFeeOptionsParams) (*GetIntentEntrypointDepositFeeOptionsResult, error) {
	in := struct {
		Arg0 *GetIntentEntrypointDepositFeeOptionsParams `json:"params"`
	}{params}
	out := struct {
		Ret0 *GetIntentEntrypointDepositFeeOptionsResult `json:"result"`
	}{}
...
func (c *apiClient) QueueIntentConfigExecution(ctx context.Context, intentConfigId string) (bool, error) {
	in := struct {
		Arg0 string `json:"intentConfigId"`
	}{intentConfigId}
	out := struct {
		Ret0 bool `json:"status"`
	}{}
...
func (c *apiClient) GetIntentConfigExecutionStatus(ctx context.Context, intentConfigId string) (string, error) {
	in := struct {
		Arg0 string `json:"intentConfigId"`
	}{intentConfigId}
	out := struct {
...
const WebrpcHeaderValue = "webrpc@v0.30.1;gen-golang@v0.23.1;trails-api@v0.4.0"
