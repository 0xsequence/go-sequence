// trails-api v1-26.3.11-6fd5175f 62e2846b3e249c7b54bd3e9f70da6343037999bf
// --
// Code generated by webrpc-gen@v0.36.0 with golang generator. DO NOT EDIT.
//
...
func WebRPCSchemaVersion() string {
	return "v1-26.3.11-6fd5175f"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "62e2846b3e249c7b54bd3e9f70da6343037999bf"
}
...
var CCTPTransferStatus_name = map[CCTPTransferStatus]string{
	CCTPTransferStatus_UNKNOWN:  "UNKNOWN",
	CCTPTransferStatus_ON_HOLD:  "ON_HOLD",
	CCTPTransferStatus_PENDING:  "PENDING",
	CCTPTransferStatus_FETCHING: "FETCHING",
	CCTPTransferStatus_COMPLETE: "COMPLETE",
	CCTPTransferStatus_FAILED:   "FAILED",
}

var CCTPTransferStatus_value = map[string]CCTPTransferStatus{
	"UNKNOWN":  CCTPTransferStatus_UNKNOWN,
	"ON_HOLD":  CCTPTransferStatus_ON_HOLD,
	"PENDING":  CCTPTransferStatus_PENDING,
	"FETCHING": CCTPTransferStatus_FETCHING,
	"COMPLETE": CCTPTransferStatus_COMPLETE,
	"FAILED":   CCTPTransferStatus_FAILED,
}

func (x CCTPTransferStatus) String() string {
	return CCTPTransferStatus_name[x]
}

func (x CCTPTransferStatus) MarshalText() ([]byte, error) {
	return []byte(CCTPTransferStatus_name[x]), nil
}
...
type RelayTransferStatus uint8

const (
	RelayTransferStatus_UNKNOWN RelayTransferStatus = 0
	// Waiting for origin txn to complete
	RelayTransferStatus_ON_HOLD RelayTransferStatus = 1
	// Ready to poll Relay API
	RelayTransferStatus_PENDING RelayTransferStatus = 2
	// Currently polling Relay API
	RelayTransferStatus_FETCHING RelayTransferStatus = 3
	// Relay confirmed success
	RelayTransferStatus_COMPLETE RelayTransferStatus = 4
	// Relay returned refund
	RelayTransferStatus_REFUNDED RelayTransferStatus = 5
	// Terminal failure
	RelayTransferStatus_FAILED RelayTransferStatus = 6
)

var RelayTransferStatus_name = map[RelayTransferStatus]string{
	RelayTransferStatus_UNKNOWN:  "UNKNOWN",
	RelayTransferStatus_ON_HOLD:  "ON_HOLD",
	RelayTransferStatus_PENDING:  "PENDING",
	RelayTransferStatus_FETCHING: "FETCHING",
	RelayTransferStatus_COMPLETE: "COMPLETE",
	RelayTransferStatus_REFUNDED: "REFUNDED",
	RelayTransferStatus_FAILED:   "FAILED",
}

var RelayTransferStatus_value = map[string]RelayTransferStatus{
	"UNKNOWN":  RelayTransferStatus_UNKNOWN,
	"ON_HOLD":  RelayTransferStatus_ON_HOLD,
	"PENDING":  RelayTransferStatus_PENDING,
	"FETCHING": RelayTransferStatus_FETCHING,
	"COMPLETE": RelayTransferStatus_COMPLETE,
	"REFUNDED": RelayTransferStatus_REFUNDED,
	"FAILED":   RelayTransferStatus_FAILED,
}

func (x RelayTransferStatus) String() string {
	return RelayTransferStatus_name[x]
}

func (x RelayTransferStatus) MarshalText() ([]byte, error) {
	return []byte(RelayTransferStatus_name[x]), nil
}

func (x *RelayTransferStatus) UnmarshalText(b []byte) error {
	*x = RelayTransferStatus(RelayTransferStatus_value[string(b)])
	return nil
}

func (x *RelayTransferStatus) Is(values ...RelayTransferStatus) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
func (c *trailsClient) GetEarnPools(ctx context.Context, getEarnPoolsRequest GetEarnPoolsRequest) (*GetEarnPoolsResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[21], getEarnPoolsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetIntentTransactionHistory(ctx context.Context, getIntentTransactionHistoryRequest GetIntentTransactionHistoryRequest) (*GetIntentTransactionHistoryResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[23], getIntentTransactionHistoryRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
const WebrpcHeaderValue = "webrpc@v0.36.0;gen-golang@v0.27.0;trails-api@v1-26.3.11-6fd5175f"
