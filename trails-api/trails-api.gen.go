// trails-api v1-25.12.9+7479046b 31a12dd74b56457a79a8e8b57d1766f107db8d23
// --
...
func WebRPCSchemaVersion() string {
	return "v1-25.12.9+7479046b"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "31a12dd74b56457a79a8e8b57d1766f107db8d23"
}
...
func (c *trailsClient) GetChains(ctx context.Context, getChainsRequest GetChainsRequest) (*GetChainsResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[11], getChainsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetExactOutputRoutes(ctx context.Context, getExactOutputRoutesRequest GetExactOutputRoutesRequest) (*GetExactOutputRoutesResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[12], getExactOutputRoutesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetExactInputRoutes(ctx context.Context, getExactInputRoutesRequest GetExactInputRoutesRequest) (*GetExactInputRoutesResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[13], getExactInputRoutesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetTokenList(ctx context.Context, getTokenListRequest GetTokenListRequest) (*GetTokenListResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[14], getTokenListRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetTokenPrices(ctx context.Context, getTokenPricesRequest GetTokenPricesRequest) (*GetTokenPricesResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[15], getTokenPricesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetTrailsContracts(ctx context.Context) (*TrailsContracts, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[16], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
const WebrpcHeaderValue = "webrpc@v0.31.3;gen-golang@v0.23.3;trails-api@v1-25.12.9+7479046b"
