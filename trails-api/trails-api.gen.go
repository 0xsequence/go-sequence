// trails-api v1-25.11.11+1d06160 15a812f58abc2c95e2e189e0310dacd0596a7508
// --
...
func WebRPCSchemaVersion() string {
	return "v1-25.11.11+1d06160"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "15a812f58abc2c95e2e189e0310dacd0596a7508"
}
...
type Intent struct {
	...
	DestinationCalls         *IntentCalls             `json:"destinationCalls,omitempty" db:"dest_calls,omitempty"`
	OriginPrecondition       *TransactionPrecondition `json:"originPrecondition" db:"orig_precondition"`
	DestinationPrecondition  *TransactionPrecondition `json:"destinationPrecondition,omitempty" db:"dest_precondition,omitempty"`
	OriginMetaTxn            *MetaTxn                 `json:"originMetaTxn" db:"orig_meta_txn"`
	DestinationMetaTxn       *MetaTxn                 `json:"destinationMetaTxn,omitempty" db:"dest_meta_txn,omitempty"`
...
type IntentFees struct {
	...
	DestinationGas *IntentTransactionGasFee `json:"destinationGas,omitempty"`
...
const WebrpcHeaderValue = "webrpc@v0.31.1;gen-golang@v0.23.3;trails-api@v1-25.11.11+1d06160"
