// trails-api v1-25.12.7+57f806f8 9c057baa53b644b8c8494a33ae95db08701dbed8
// --
// Code generated by webrpc-gen@v0.31.2 with golang generator. DO NOT EDIT.
//
// webrpc-gen -schema=trails-api.ridl -target=golang -pkg=trailsapi -client -service=Trails -out=./clients/trails-api.gen.go
package trailsapi
...
func WebRPCSchemaVersion() string {
	return "v1-25.12.7+57f806f8"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "9c057baa53b644b8c8494a33ae95db08701dbed8"
}
...
type AdminRequeueIntentTransactionRequest struct {
	IntentID                     prototyp.Hash    `json:"intentId"`
	Origin                       *bool            `json:"origin"`
	Destination                  *bool            `json:"destination"`
	OriginMinAmountOverride      *prototyp.BigInt `json:"originMinAmountOverride"`
	DestinationMinAmountOverride *prototyp.BigInt `json:"destinationMinAmountOverride"`
}

type AdminRequeueIntentTransactionResponse struct {
	Status  bool   `json:"status"`
	Message string `json:"message"`
}

type AdminDeployCCTPMessageWalletRequest struct {
	ChainID uint64 `json:"chainId"`
}

type AdminDeployCCTPMessageWalletResponse struct {
	ChainID          uint64         `json:"chainId"`
	WalletAddress    prototyp.Hash  `json:"walletAddress"`
	Deployed         bool           `json:"deployed"`
	DeploymentTxHash *prototyp.Hash `json:"deploymentTxHash"`
}
...
const WebrpcHeaderValue = "webrpc@v0.31.2;gen-golang@v0.23.3;trails-api@v1-25.12.7+57f806f8"
