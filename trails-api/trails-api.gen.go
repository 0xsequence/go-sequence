// trails-api v1-26.3.3-e84629de b13c5c3d8580a1ea98018b622ed6ce0d7de8371a
// --
...
func WebRPCSchemaVersion() string {
	return "v1-26.3.3-e84629de"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "b13c5c3d8580a1ea98018b622ed6ce0d7de8371a"
}
...
func (c *trailsClient) GetEarnPools(ctx context.Context, getEarnPoolsRequest GetEarnPoolsRequest) (*GetEarnPoolsResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[20], getEarnPoolsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetIntentTransactionHistory(ctx context.Context, getIntentTransactionHistoryRequest GetIntentTransactionHistoryRequest) (*GetIntentTransactionHistoryResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[22], getIntentTransactionHistoryRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
const WebrpcHeaderValue = "webrpc@v0.32.2;gen-golang@v0.24.0;trails-api@v1-26.3.3-e84629de"
