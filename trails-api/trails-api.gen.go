// trails-api v1-25.11.27+a1a7c1e 6fe7f33c211df436c7eea478f1065f46c7432656
// --
...
func WebRPCSchemaVersion() string {
	return "v1-25.11.27+a1a7c1e"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "6fe7f33c211df436c7eea478f1065f46c7432656"
}
...
type TrailsClient interface {
	...
	// GetFeaturedTokens will return a list of popular tokens based on the provided filters.
	// This is useful for populating token selection lists.
	GetFeaturedTokens(ctx context.Context, getFeaturedTokensRequest GetFeaturedTokensRequest) (*GetFeaturedTokensResponse, error)
...
func (c *trailsClient) GetFeaturedTokens(ctx context.Context, getFeaturedTokensRequest GetFeaturedTokensRequest) (*GetFeaturedTokensResponse, error) {
	out := struct {
		Ret0 *GetFeaturedTokensResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[15], getFeaturedTokensRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
const WebrpcHeaderValue = "webrpc@v0.31.2;gen-golang@v0.23.3;trails-api@v1-25.11.27+a1a7c1e"
