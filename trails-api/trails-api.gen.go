// trails-api v1.0.0 d77c84a0d98b34c7e6d3a9810cc8819aee40b978
// --
...
func WebRPCSchemaHash() string {
	return "d77c84a0d98b34c7e6d3a9810cc8819aee40b978"
}
...
const (
	...
	TransactionStatus_PROCESSING TransactionStatus = 1
	TransactionStatus_FAILED     TransactionStatus = 2
	TransactionStatus_SUCCEEDED  TransactionStatus = 3
)
...
const (
	IntentStatus_SOLVED    IntentStatus = 0
...
type Intent struct {
	...
	ExecutedAt               *time.Time            `json:"executedAt,omitempty" db:"executed_at,omitempty"`
...
type IntentReceipt struct {
	...
	UpdatedAt *string `json:"updatedAt" db:"updated_at,omitempty"`
	// timestamp of when the intent receipt was created
	CreatedAt *string `json:"createdAt" db:"created_at,omitempty"`
}
