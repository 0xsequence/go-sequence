// trails-api v1-25.12.8+e61353a7 5ea69f630985d2a31b9c42bf442ec522c75a00ae
// --
// Code generated by webrpc-gen@v0.31.3 with golang generator. DO NOT EDIT.
//
// webrpc-gen -schema=trails-api.ridl -target=golang -pkg=trailsapi -client -service=Trails -methodTreeShake -out=./clients/trails-api.gen.go
package trailsapi
...
func WebRPCSchemaVersion() string {
	return "v1-25.12.8+e61353a7"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "5ea69f630985d2a31b9c42bf442ec522c75a00ae"
}
...
type TrailsClient interface {
	...
	GetMeldCountryDefaults(ctx context.Context, getMeldCountryDefaultsRequest GetMeldCountryDefaultsRequest) (*GetMeldCountryDefaultsResponse, error)
	// GetMeldFiatCurrencies returns available fiat currencies for a country.
	GetMeldFiatCurrencies(ctx context.Context, getMeldFiatCurrenciesRequest GetMeldFiatCurrenciesRequest) (*GetMeldFiatCurrenciesResponse, error)
	// GetMeldPaymentMethods returns payment methods available for a fiat currency.
	GetMeldPaymentMethods(ctx context.Context, getMeldPaymentMethodsRequest GetMeldPaymentMethodsRequest) (*GetMeldPaymentMethodsResponse, error)
	// GetMeldCryptoCurrencies returns available cryptocurrencies for a country.
	GetMeldCryptoCurrencies(ctx context.Context, getMeldCryptoCurrenciesRequest GetMeldCryptoCurrenciesRequest) (*GetMeldCryptoCurrenciesResponse, error)
	// GetMeldPurchaseLimits returns purchase limits for all fiat currencies.
	GetMeldPurchaseLimits(ctx context.Context, getMeldPurchaseLimitsRequest GetMeldPurchaseLimitsRequest) (*GetMeldPurchaseLimitsResponse, error)
	// GetMeldQuote returns real-time quotes from multiple providers.
	GetMeldQuote(ctx context.Context, getMeldQuoteRequest GetMeldQuoteRequest) (*GetMeldQuoteResponse, error)
	// CreateMeldWidgetSession creates a widget session and returns the provider URL.
	CreateMeldWidgetSession(ctx context.Context, createMeldWidgetSessionRequest CreateMeldWidgetSessionRequest) (*CreateMeldWidgetSessionResponse, error)
	// GetMeldTransaction returns transaction details by transaction ID.
	GetMeldTransaction(ctx context.Context, getMeldTransactionRequest GetMeldTransactionRequest) (*GetMeldTransactionResponse, error)
	// SearchMeldTransactions returns transactions matching the search criteria.
	SearchMeldTransactions(ctx context.Context, searchMeldTransactionsRequest SearchMeldTransactionsRequest) (*SearchMeldTransactionsResponse, error)
	// CreateMeldBankLinkingConnection creates a bank linking connection for ACH transfers.
	CreateMeldBankLinkingConnection(ctx context.Context, createMeldBankLinkingConnectionRequest CreateMeldBankLinkingConnectionRequest) (*CreateMeldBankLinkingConnectionResponse, error)
}
...
type GetMeldCountryDefaultsRequest struct {
	CountryCode string `json:"countryCode"`
}

type GetMeldCountryDefaultsResponse struct {
	Defaults json.RawMessage `json:"defaults"`
}

type MeldCountryDefault struct {
	CountryCode           string   `json:"countryCode"`
	DefaultCurrencyCode   string   `json:"defaultCurrencyCode"`
	DefaultPaymentMethods []string `json:"defaultPaymentMethods"`
}

type GetMeldFiatCurrenciesRequest struct {
	CountryCode string `json:"countryCode"`
}

type GetMeldFiatCurrenciesResponse struct {
	FiatCurrencies json.RawMessage `json:"fiatCurrencies"`
}

type MeldFiatCurrency struct {
	CurrencyCode   string `json:"currencyCode"`
	Name           string `json:"name"`
	SymbolImageUrl string `json:"symbolImageUrl"`
}

type GetMeldPaymentMethodsRequest struct {
	FiatCurrency string `json:"fiatCurrency"`
}

type GetMeldPaymentMethodsResponse struct {
	PaymentMethods json.RawMessage `json:"paymentMethods"`
}

type MeldPaymentMethod struct {
	PaymentMethod string            `json:"paymentMethod"`
	Name          string            `json:"name"`
	PaymentType   string            `json:"paymentType"`
	Logos         *MeldPaymentLogos `json:"logos"`
}

type MeldPaymentLogos struct {
	Dark  string `json:"dark"`
	Light string `json:"light"`
}

type GetMeldCryptoCurrenciesRequest struct {
	CountryCode string `json:"countryCode"`
}

type GetMeldCryptoCurrenciesResponse struct {
	CryptoCurrencies json.RawMessage `json:"cryptoCurrencies"`
}

type MeldCryptoCurrency struct {
	CurrencyCode    string `json:"currencyCode"`
	Name            string `json:"name"`
...
type GetMeldPurchaseLimitsRequest struct {
}

type GetMeldPurchaseLimitsResponse struct {
	Limits json.RawMessage `json:"limits"`
}

type MeldCurrencyLimits struct {
	DefaultAmount float64 `json:"defaultAmount,omitempty"`
	MinimumAmount float64 `json:"minimumAmount"`
	MaximumAmount float64 `json:"maximumAmount"`
}

type GetMeldQuoteRequest struct {
...
type GetMeldQuoteResponse struct {
	QuoteResponse json.RawMessage `json:",inline"`
}
...
type CreateMeldWidgetSessionRequest struct {
	SessionData        *MeldSessionData `json:"sessionData"`
	SessionType        string           `json:"sessionType"`
	ExternalCustomerId string           `json:"externalCustomerId"`
	ExternalSessionId  string           `json:"externalSessionId"`
}

type MeldSessionData struct {
	WalletAddress           prototyp.Hash `json:"walletAddress"`
	CountryCode             string        `json:"countryCode"`
	SourceCurrencyCode      string        `json:"sourceCurrencyCode"`
	SourceAmount            string        `json:"sourceAmount"`
...
type CreateMeldWidgetSessionResponse struct {
	WidgetSession json.RawMessage `json:",inline"`
}

type GetMeldTransactionRequest struct {
	TransactionId string `json:"transactionId"`
}

type GetMeldTransactionResponse struct {
	Transaction json.RawMessage `json:"transaction"`
}

type SearchMeldTransactionsRequest struct {
	Statuses            *string `json:"statuses"`
	ExternalSessionIds  *string `json:"externalSessionIds"`
	ExternalCustomerIds *string `json:"externalCustomerIds"`
...
type SearchMeldTransactionsResponse struct {
	Transactions json.RawMessage `json:"transactions"`
}

type MeldTransaction struct {
	Id string `json:"id"`
}

type MeldTransactions struct {
	Transactions []*MeldTransaction `json:"transactions"`
}

type CreateMeldBankLinkingConnectionRequest struct {
	ExternalCustomerId        string                         `json:"externalCustomerId"`
	InstitutionId             *string                        `json:"institutionId"`
	InstitutionSearchString   *string                        `json:"institutionSearchString"`
	Products                  []string                       `json:"products"`
	OptionalProducts          []string                       `json:"optionalProducts"`
	RedirectUrl               *string                        `json:"redirectUrl"`
	Regions                   []string                       `json:"regions"`
	AccountPreferenceOverride *MeldAccountPreferenceOverride `json:"accountPreferenceOverride"`
}

type MeldAccountPreferenceOverride struct {
	AllowRedirect *bool `json:"allowRedirect"`
}

type CreateMeldBankLinkingConnectionResponse struct {
	ConnectionResponse json.RawMessage `json:",inline"`
}
...
func NewTrailsClient(addr string, client HTTPClient) TrailsClient {
	...
	urls := [28]string{
		...
		prefix + "GetMeldCountryDefaults",
		prefix + "GetMeldFiatCurrencies",
		prefix + "GetMeldPaymentMethods",
		prefix + "GetMeldCryptoCurrencies",
		prefix + "GetMeldPurchaseLimits",
		prefix + "GetMeldQuote",
		prefix + "CreateMeldWidgetSession",
		prefix + "GetMeldTransaction",
		prefix + "SearchMeldTransactions",
		prefix + "CreateMeldBankLinkingConnection",
	}
	return &trailsClient{
		client: client,
		urls:   urls,
...
func (c *trailsClient) GetTrailsContracts(ctx context.Context) (*TrailsContracts, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[17], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetMeldCountryDefaults(ctx context.Context, getMeldCountryDefaultsRequest GetMeldCountryDefaultsRequest) (*GetMeldCountryDefaultsResponse, error) {
	out := struct {
		Ret0 *GetMeldCountryDefaultsResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[18], getMeldCountryDefaultsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetMeldFiatCurrencies(ctx context.Context, getMeldFiatCurrenciesRequest GetMeldFiatCurrenciesRequest) (*GetMeldFiatCurrenciesResponse, error) {
	out := struct {
		Ret0 *GetMeldFiatCurrenciesResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[19], getMeldFiatCurrenciesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetMeldPaymentMethods(ctx context.Context, getMeldPaymentMethodsRequest GetMeldPaymentMethodsRequest) (*GetMeldPaymentMethodsResponse, error) {
	out := struct {
		Ret0 *GetMeldPaymentMethodsResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[20], getMeldPaymentMethodsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetMeldCryptoCurrencies(ctx context.Context, getMeldCryptoCurrenciesRequest GetMeldCryptoCurrenciesRequest) (*GetMeldCryptoCurrenciesResponse, error) {
	out := struct {
		Ret0 *GetMeldCryptoCurrenciesResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[21], getMeldCryptoCurrenciesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetMeldPurchaseLimits(ctx context.Context, getMeldPurchaseLimitsRequest GetMeldPurchaseLimitsRequest) (*GetMeldPurchaseLimitsResponse, error) {
	out := struct {
		Ret0 *GetMeldPurchaseLimitsResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[22], getMeldPurchaseLimitsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetMeldQuote(ctx context.Context, getMeldQuoteRequest GetMeldQuoteRequest) (*GetMeldQuoteResponse, error) {
	out := struct {
		Ret0 *GetMeldQuoteResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[23], getMeldQuoteRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) CreateMeldWidgetSession(ctx context.Context, createMeldWidgetSessionRequest CreateMeldWidgetSessionRequest) (*CreateMeldWidgetSessionResponse, error) {
	out := struct {
		Ret0 *CreateMeldWidgetSessionResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[24], createMeldWidgetSessionRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetMeldTransaction(ctx context.Context, getMeldTransactionRequest GetMeldTransactionRequest) (*GetMeldTransactionResponse, error) {
	out := struct {
		Ret0 *GetMeldTransactionResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[25], getMeldTransactionRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) SearchMeldTransactions(ctx context.Context, searchMeldTransactionsRequest SearchMeldTransactionsRequest) (*SearchMeldTransactionsResponse, error) {
	out := struct {
		Ret0 *SearchMeldTransactionsResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[26], searchMeldTransactionsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) CreateMeldBankLinkingConnection(ctx context.Context, createMeldBankLinkingConnectionRequest CreateMeldBankLinkingConnectionRequest) (*CreateMeldBankLinkingConnectionResponse, error) {
	out := struct {
		Ret0 *CreateMeldBankLinkingConnectionResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[27], createMeldBankLinkingConnectionRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
const WebrpcHeaderValue = "webrpc@v0.31.3;gen-golang@v0.23.3;trails-api@v1-25.12.8+e61353a7"
