// trails-api v1-26.4.21-349a351e 1079295f33a40260d193542e1545a2750bcda517
// --
// Code generated by webrpc-gen@v0.36.1 with golang generator. DO NOT EDIT.
//
...
func WebRPCSchemaVersion() string {
	return "v1-26.4.21-349a351e"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "1079295f33a40260d193542e1545a2750bcda517"
}
...
type TrailsClient interface {
	...
	RetryIntent(ctx context.Context, retryIntentRequest RetryIntentRequest) (*RetryIntentResponse, error)
	...
	PrepareIntentRecovery(ctx context.Context, prepareIntentRecoveryRequest PrepareIntentRecoveryRequest) (*PrepareIntentRecoveryResponse, error)
	BuildIntentRecoveryTransaction(ctx context.Context, buildIntentRecoveryTransactionRequest BuildIntentRecoveryTransactionRequest) (*BuildIntentRecoveryTransactionResponse, error)
	...
	GetCountryList(ctx context.Context) ([]*Country, error)
	// Deprecated: please use GetProtocolContracts instead
	...
	GetProtocolContracts(ctx context.Context, intentProtocol *IntentProtocolVersion) (*TrailsContracts, error)
	GetSupportedIntentProtocols(ctx context.Context) ([]IntentProtocolVersion, error)
	GetDefaultIntentProtocol(ctx context.Context) (IntentProtocolVersion, error)
	...
	GetEarnPools(ctx context.Context, getEarnPoolsRequest GetEarnPoolsRequest) (*GetEarnPoolsResponse, error)
	// YieldGetProviders returns available Yield providers.
	YieldGetProviders(ctx context.Context, getYieldProvidersRequest GetYieldProvidersRequest) (*GetYieldProvidersResponse, error)
	// YieldGetProvider returns a Yield provider by provider ID.
	YieldGetProvider(ctx context.Context, getYieldProviderRequest GetYieldProviderRequest) (*GetYieldProviderResponse, error)
	// YieldGetNetworks returns available Yield networks.
	YieldGetNetworks(ctx context.Context, getYieldNetworksRequest GetYieldNetworksRequest) (*GetYieldNetworksResponse, error)
	// YieldGetMarkets returns Yield markets with optional filters.
	YieldGetMarkets(ctx context.Context, getYieldMarketsRequest GetYieldMarketsRequest) (*GetYieldMarketsResponse, error)
	// YieldGetMarketById returns a Yield market by market ID.
	YieldGetMarketById(ctx context.Context, getYieldMarketByIdRequest GetYieldMarketByIdRequest) (*GetYieldMarketByIdResponse, error)
	// YieldCreateEnterAction returns unsigned enter-action transaction payloads.
	YieldCreateEnterAction(ctx context.Context, createYieldActionRequest CreateYieldActionRequest) (*CreateYieldActionResponse, error)
	// YieldCreateExitAction returns unsigned exit-action transaction payloads.
	YieldCreateExitAction(ctx context.Context, createYieldActionRequest CreateYieldActionRequest) (*CreateYieldActionResponse, error)
	// GetFiatCurrencyList returns the list of supported fiat currencies for display preferences.
	GetFiatCurrencyList(ctx context.Context) ([]*FiatCurrency, error)
...
const (
	...
	RouteProvider_GASZIP RouteProvider = "GASZIP"
	RouteProvider_LIFI   RouteProvider = "LIFI"
	RouteProvider_LZ_OFT RouteProvider = "LZ_OFT"
	RouteProvider_RELAY  RouteProvider = "RELAY"
	RouteProvider_SUSHI  RouteProvider = "SUSHI"
	RouteProvider_WETH   RouteProvider = "WETH"
...
const (
	RoutePreference_RECOMMENDED RoutePreference = "RECOMMENDED"
	RoutePreference_FASTEST     RoutePreference = "FASTEST"
	RoutePreference_CHEAPEST    RoutePreference = "CHEAPEST"
	RoutePreference_TRUSTLESS   RoutePreference = "TRUSTLESS"
)

func (x RoutePreference) MarshalText() ([]byte, error) {
	return []byte(x), nil
}

func (x *RoutePreference) UnmarshalText(b []byte) error {
	*x = RoutePreference(string(b))
	return nil
}

func (x *RoutePreference) Is(values ...RoutePreference) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
type FundMethod string

const (
	FundMethod_WALLET          FundMethod = "WALLET"
	FundMethod_DIRECT_TRANSFER FundMethod = "DIRECT_TRANSFER"
	FundMethod_ONRAMP_MESH     FundMethod = "ONRAMP_MESH"
	FundMethod_ONRAMP_MELD     FundMethod = "ONRAMP_MELD"
)

func (x FundMethod) MarshalText() ([]byte, error) {
	return []byte(x), nil
}

func (x *FundMethod) UnmarshalText(b []byte) error {
	*x = FundMethod(string(b))
	return nil
}

func (x *FundMethod) Is(values ...FundMethod) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
type IntentProtocolVersion string

const (
	IntentProtocolVersion_v1   IntentProtocolVersion = "v1"
	IntentProtocolVersion_v1_5 IntentProtocolVersion = "v1.5"
)

func (x IntentProtocolVersion) MarshalText() ([]byte, error) {
	return []byte(x), nil
}

func (x *IntentProtocolVersion) UnmarshalText(b []byte) error {
	*x = IntentProtocolVersion(string(b))
	return nil
}

func (x *IntentProtocolVersion) Is(values ...IntentProtocolVersion) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
const (
	...
	// done, intent execution was refunded
	IntentStatus_REFUNDED IntentStatus = 6
	// done, intent is invalid, usually due to invalid deposit/similar
	IntentStatus_INVALID IntentStatus = 7
)

var IntentStatus_name = map[IntentStatus]string{
	IntentStatus_QUOTED:    "QUOTED",
	IntentStatus_COMMITTED: "COMMITTED",
	IntentStatus_EXECUTING: "EXECUTING",
	IntentStatus_FAILED:    "FAILED",
	IntentStatus_SUCCEEDED: "SUCCEEDED",
	IntentStatus_ABORTED:   "ABORTED",
	IntentStatus_REFUNDED:  "REFUNDED",
	IntentStatus_INVALID:   "INVALID",
}

var IntentStatus_value = map[string]IntentStatus{
	"QUOTED":    IntentStatus_QUOTED,
	"COMMITTED": IntentStatus_COMMITTED,
	"EXECUTING": IntentStatus_EXECUTING,
	"FAILED":    IntentStatus_FAILED,
	"SUCCEEDED": IntentStatus_SUCCEEDED,
	"ABORTED":   IntentStatus_ABORTED,
	"REFUNDED":  IntentStatus_REFUNDED,
	"INVALID":   IntentStatus_INVALID,
}

func (x IntentStatus) String() string {
	return IntentStatus_name[x]
}

func (x IntentStatus) MarshalText() ([]byte, error) {
	return []byte(IntentStatus_name[x]), nil
}
...
const (
	...
	// Refund transaction from bridge provider (e.g., Relay refund on origin chain).
	TransactionType_REFUND TransactionType = 5
)

var TransactionType_name = map[TransactionType]string{
	TransactionType_UNKNOWN:     "UNKNOWN",
	TransactionType_DEPOSIT:     "DEPOSIT",
	TransactionType_ORIGIN:      "ORIGIN",
	TransactionType_DESTINATION: "DESTINATION",
	TransactionType_ROUTE:       "ROUTE",
	TransactionType_REFUND:      "REFUND",
}

var TransactionType_value = map[string]TransactionType{
	"UNKNOWN":     TransactionType_UNKNOWN,
	"DEPOSIT":     TransactionType_DEPOSIT,
	"ORIGIN":      TransactionType_ORIGIN,
	"DESTINATION": TransactionType_DESTINATION,
	"ROUTE":       TransactionType_ROUTE,
	"REFUND":      TransactionType_REFUND,
}

func (x TransactionType) String() string {
	return TransactionType_name[x]
}

func (x TransactionType) MarshalText() ([]byte, error) {
	return []byte(TransactionType_name[x]), nil
}
...
func (x TransactionContext) String() string {
	return TransactionContext_name[x]
}

func (x TransactionContext) MarshalText() ([]byte, error) {
	return []byte(TransactionContext_name[x]), nil
}
...
const (
	...
	// terminal state: txn mined but call reverted (refund triggered)
	TransactionStatus_REVERTED TransactionStatus = 10
)

var TransactionStatus_name = map[TransactionStatus]string{
	TransactionStatus_UNKNOWN:   "UNKNOWN",
	TransactionStatus_ON_HOLD:   "ON_HOLD",
	TransactionStatus_PENDING:   "PENDING",
	TransactionStatus_RELAYING:  "RELAYING",
	TransactionStatus_SENT:      "SENT",
	TransactionStatus_ERRORED:   "ERRORED",
	TransactionStatus_MINING:    "MINING",
	TransactionStatus_SUCCEEDED: "SUCCEEDED",
	TransactionStatus_FAILED:    "FAILED",
	TransactionStatus_ABORTED:   "ABORTED",
	TransactionStatus_REVERTED:  "REVERTED",
}

var TransactionStatus_value = map[string]TransactionStatus{
	"UNKNOWN":   TransactionStatus_UNKNOWN,
	"ON_HOLD":   TransactionStatus_ON_HOLD,
	"PENDING":   TransactionStatus_PENDING,
	"RELAYING":  TransactionStatus_RELAYING,
	"SENT":      TransactionStatus_SENT,
	"ERRORED":   TransactionStatus_ERRORED,
	"MINING":    TransactionStatus_MINING,
	"SUCCEEDED": TransactionStatus_SUCCEEDED,
	"FAILED":    TransactionStatus_FAILED,
	"ABORTED":   TransactionStatus_ABORTED,
	"REVERTED":  TransactionStatus_REVERTED,
}

func (x TransactionStatus) String() string {
	return TransactionStatus_name[x]
}

func (x TransactionStatus) MarshalText() ([]byte, error) {
	return []byte(TransactionStatus_name[x]), nil
}
...
var SortOrder_name = map[SortOrder]string{
	SortOrder_DESC: "DESC",
	SortOrder_ASC:  "ASC",
}

var SortOrder_value = map[string]SortOrder{
	"DESC": SortOrder_DESC,
	"ASC":  SortOrder_ASC,
}

func (x SortOrder) String() string {
	return SortOrder_name[x]
}

func (x SortOrder) MarshalText() ([]byte, error) {
	return []byte(SortOrder_name[x]), nil
}
...
type QuoteIntentRequest struct {
	...
	DestinationApproveAddress prototyp.Hash    `json:"destinationApproveAddress"`
	...
	// fundMethod indicates the funding method to determine passthrough eligibility.
	// If omitted, backend treats as non-wallet for passthrough gating.
	FundMethod *FundMethod `json:"fundMethod"`
...
type QuoteIntentRequestOptions struct {
	IntentProtocol IntentProtocolVersion `json:"intentProtocol,omitempty"`
	SwapProvider   RouteProvider         `json:"swapProvider,omitempty"`
	BridgeProvider RouteProvider         `json:"bridgeProvider,omitempty"`
	// swapProviderFallback, when true, retries routing with AUTO swap provider selection
	// if the specified swapProvider yields no available route.
	SwapProviderFallback bool `json:"swapProviderFallback,omitempty"`
	// bridgeProviderFallback, when true, retries routing with AUTO bridge provider selection
	// if the specified bridgeProvider yields no available route.
	BridgeProviderFallback bool `json:"bridgeProviderFallback,omitempty"`
	// preference indicates routing preference for provider selection.
...
// PassthroughInfo describes a direct transfer (passthrough) flow that bypasses
// intent execution. When eligible is true, passthroughTransaction contains the
// pre-encoded transaction the client should submit directly, and
// transactionStates holds the single-step UI state (Transfer or Execute).
// Clients should use Passthrough.TransactionStates for passthrough scenarios
// and the top-level QuoteIntentResponse.TransactionStates for intent flows.
type PassthroughInfo struct {
	Eligible               bool                    `json:"eligible"`
	PassthroughTransaction *PassThroughTransaction `json:"passthroughTransaction"`
	TransactionStates      []*TransactionStateInfo `json:"transactionStates"`
}
...
type Intent struct {
	...
	OriginTokenAddress       prototyp.Hash       `json:"originTokenAddress" db:"orig_token_address"`
	DestinationTokenAddress  prototyp.Hash       `json:"destinationTokenAddress" db:"dest_token_address"`
	...
	// passthrough indicates a direct transfer flow without intent execution
	Passthrough             *bool                    `json:"passthrough" db:"-"`
	...
	GasFeeOptions           *GasFeeOptions           `json:"gasFeeOptions" db:"gas_fee_options,omitempty"`
	TrailsVersion           string                   `json:"trailsVersion" db:"trails_version"`
	IntentProtocol          IntentProtocolVersion    `json:"intentProtocol,omitempty" db:"intent_protocol"`
...
type DepositTransaction struct {
	...
	// chainId is the chain ID where the deposit should be made.
	ChainID uint64 `json:"chainId"`
	// to is the transaction recipient address (token contract for ERC20, intent address for native).
	To prototyp.Hash `json:"to"`
	// data is the encoded transaction calldata (transfer call for ERC20, empty for native).
	Data string `json:"data"`
	// value is the ETH value to send (0 for ERC20, amount for native).
	Value prototyp.BigInt `json:"value"`
}

// PassThroughTransaction represents a direct transfer transaction that bypasses
// intent execution, sending tokens directly to the destination address.
type PassThroughTransaction struct {
	// toAddress is the final destination address where tokens are sent
	ToAddress prototyp.Hash `json:"toAddress"`
	// tokenAddress is the token being transferred
	TokenAddress prototyp.Hash `json:"tokenAddress"`
	// decimals is the number of decimals for the token
	Decimals *uint8 `json:"decimals"`
	// amount is the token amount being transferred
	Amount prototyp.BigInt `json:"amount"`
	// chainId is the chain ID where the transfer occurs
	ChainID uint64 `json:"chainId"`
	// to is the transaction recipient address (token contract for ERC20, destination for native)
	To prototyp.Hash `json:"to"`
	// data is the encoded transaction calldata (transfer call for ERC20, empty for native)
	Data string `json:"data"`
	// value is the ETH value to send (0 for ERC20, amount for native)
...
type MetaTxn struct {
	...
	// Native value (in wei) to forward with the transaction.
	// Used for bridge fees (e.g., LayerZero messaging fees) that require msg.value.
	BridgeGas *prototyp.BigInt `json:"bridgeGas"`
}
...
type IntentHistory struct {
	...
	Balances   []*IntentAddressBalance `json:"balances,omitempty"`
}

type IntentAddressBalance struct {
	IntentAddress prototyp.Hash         `json:"intentAddress"`
	ChainID       uint64                `json:"chainId"`
	Tokens        []*IntentTokenBalance `json:"tokens"`
}
...
type IntentReceipt struct {
	...
	// Refund transaction db reference and runtime type
	// NOTE: this will be populated if the intent was refunded by the bridge provider (e.g., Relay)
	RefundTransactionID *uint64               `json:"-" db:"refund_txn_id,omitempty"`
	RefundTransaction   *IntentTransaction    `json:"refundTransaction" db:"-"`
...
type IntentTransaction struct {
	...
	// Bridge gas (native msg.value) forwarded by the relayer
	BridgeGas *prototyp.BigInt `json:"bridgeGas" db:"bridge_gas"`
...
type PriceImpactDetails struct {
	// Price impact that results from gas fees on origin and destination chains
	ExecutionPriceImpact *PriceImpact `json:"executionPriceImpact"`
	// Price impact that results from slippage and pure market movement
	MarketPriceImpact *PriceImpact `json:"marketPriceImpact"`
	// Price impact that results from provider fees, excluding trails (swap + bridge)
	ProviderFeesPriceImpact *PriceImpact `json:"providerFeesPriceImpact"`
	// Price impact that results from trails fees
	TrailsFeesPriceImpact *PriceImpact `json:"trailsFeesPriceImpact"`
	// Price impact that results from net result of all fees, currently used in the final price impact shown to user
	NetPriceImpact *PriceImpact `json:"netPriceImpact"`
}
...
// the total amount is the sum of both providers.
type IntentProviderQuote struct {
	...
	// This is the net price impact (same value as priceImpactDetails.netPriceImpact)
	PriceImpact        float64             `json:"priceImpact"`
	PriceImpactUSD     float64             `json:"priceImpactUsd"`
	PriceImpactDetails *PriceImpactDetails `json:"priceImpactDetails"`
}
...
type IntentFees struct {
	...
	// @deprecated: kept for backwards compatibility here, set to `collectorFeeTotal`
	FeeTokenAmount prototyp.BigInt `json:"feeTokenAmount"`
	// @deprecated: kept for backwards compatibility here, set to `collectorFeeUsd`
	// fee token usd = gas + trails fee (amount trails' fee collector gets transferred)
	FeeTokenUSD float64 `json:"feeTokenUsd"`
	// @deprecated: kept for backwards compatibility here, set to 0
	// fee token amount = provider + trails + origin amount total
	FeeTokenTotal prototyp.BigInt `json:"feeTokenTotal"`
	// gas fee component (origin + destination gas or orchestraion fee)
	GasFeeTotal prototyp.BigInt `json:"gasFeeTotal"`
	GasFeeUSD   float64         `json:"gasFeeUsd"`
	// trails fee component
	TrailsFeeTotal prototyp.BigInt `json:"trailsFeeTotal"`
	TrailsFeeUSD   float64         `json:"trailsFeeUsd"`
	// gas + trails fee component (amount trails collects as a fee)
	CollectorFeeTotal prototyp.BigInt `json:"collectorFeeTotal"`
	CollectedFeeUSD   float64         `json:"collectorFeeUsd"`
	// provider fee component
	ProviderFeeTotal prototyp.BigInt `json:"providerFeeTotal"`
	ProviderFeeUSD   float64         `json:"providerFeeUsd"`
	// display fees (gas + trails + provider) - what user sees
...
// @deprecated: please use IntentFees instead
type IntentProviderFees struct {
	...
	TrailsFeeUSD float64         `json:"trailsFeeUsd"`
	// provider + trails (non-gas) fee totals
	QuoteProviderWithTrailsFee prototyp.BigInt `json:"quoteProviderWithTrailsFee"`
	ProviderWithTrailsFeeUSD   float64         `json:"providerWithTrailsFeeUsd"`
	// total provider fees, aka, swap + bridge + trails fees
	// @deprecated: kept for backwards compatibility here, sync w/ providerWithTrailsFee
	TotalFeeAmount prototyp.BigInt `json:"totalFeeAmount"`
	TotalFeeUSD    float64         `json:"totalFeeUsd"`
}

// DEPRECATED: please use GetIntentHistory / IntentReceiptSummary instead
// IntentSummary represents a summary view of an intent for listing purposes.
// NOTE: this type is deprecated, please use GetIntentHistory method instead
...
// ExchangeRate represents the exchange rate from USD to another currency
type ExchangeRate struct {
	// e.g., 'Canadian Dollar'
	Name string `json:"name"`
	// e.g., 'CAD'
	Symbol string `json:"symbol"`
	// e.g., 1.38705 (means 1 USD = 1.38705 CAD)
...
type DepositSignature struct {
	...
	// Optional: User nonce from Intent Entrypoint contract (fetched fresh at execute time)
...
type TrailsContracts struct {
	...
	TrailsUtilsAddress            prototyp.Hash `json:"trailsUtilsAddress"`
}
...
type ChainInfo struct {
	...
	BlockExplorer *BlockExplorer `json:"blockExplorer"`
}
...
type EarnPool struct {
	...
	ID string `json:"id"`
	// Pool name (e.g., 'USDC Market', 'DAI Vault')
	Name string `json:"name"`
	// Protocol name (e.g., 'Aave', 'Morpho')
	Protocol string `json:"protocol"`
	// Chain ID where the pool exists
	ChainID uint64 `json:"chainId"`
	// Annual percentage yield (in percentage, e.g., 5.2 for 5.2%)
	APY float64 `json:"apy"`
	// Total value locked in USD
	TVL float64 `json:"tvl"`
	// Token details
	Token *PoolTokenInfo `json:"token"`
	// Contract address to deposit funds
	DepositAddress prototyp.Hash `json:"depositAddress"`
	// Whether the pool is currently active
	IsActive bool `json:"isActive"`
	// Optional: URL to the pool on the protocol's app
	PoolURL *string `json:"poolUrl"`
	// Optional: URL to the protocol's homepage
	ProtocolURL *string `json:"protocolUrl"`
	// Optional: Wrapped token gateway address (for native token deposits on Aave)
	WrappedTokenGatewayAddress *prototyp.Hash `json:"wrappedTokenGatewayAddress"`
}
...
// CountryRegion represents a region/state/province within a country
...
// Country represents a country supported by onramp providers
type Country struct {
	...
	// URL to flag image, e.g., 'https://images-country.meld.io/US/flag.svg'
	FlagImageUrl string `json:"flagImageUrl"`
	// Optional array of regions for countries like US/Canada
	Regions []*CountryRegion `json:"regions"`
}

// FiatCurrency represents a fiat currency for display and exchange rates
type FiatCurrency struct {
	...
	Name string `json:"name"`
	// Flag emoji for country/region, e.g., '🇺🇸'
	Flag string `json:"flag"`
...
type QuoteIntentResponse struct {
	...
	OriginConfiguration      json.RawMessage         `json:"originConfiguration,omitempty"`
	...
	TransactionStates        []*TransactionStateInfo `json:"transactionStates"`
	Passthrough              *PassthroughInfo        `json:"passthrough"`
}
...
// RetryIntent repairs a failed user-submitted deposit flow by validating a
// replacement deposit transaction hash, marking the deposit leg as confirmed,
// and requeueing downstream execution.
...
type GetIntentHistoryRequest struct {
	...
	ByProjectID    uint64        `json:"byProjectId"`
	ByOwnerAddress prototyp.Hash `json:"byOwnerAddress"`
	// optional origin chain filter
	OriginChainID      uint64         `json:"originChainId"`
	OriginTokenAddress *prototyp.Hash `json:"originTokenAddress"`
	// optional destination chain filter
	DestinationChainID      uint64         `json:"destinationChainId"`
	DestinationTokenAddress *prototyp.Hash `json:"destinationTokenAddress"`
	// optional lower bound on createdAt (inclusive), unix timestamp (seconds)
	FromTime uint64 `json:"fromTime"`
	// optional upper bound on createdAt (inclusive), unix timestamp (seconds)
...
// PrepareIntentRecovery returns backend-prepared payload + typed data for client signing.
type PrepareIntentRecoveryRequest struct {
	IntentID prototyp.Hash `json:"intentId"`
	// Optional: if omitted, backend auto-selects origin/destination intent address by recoverable balance.
	IntentAddress prototyp.Hash `json:"intentAddress"`
	// Optional: defaults to owner address when omitted.
	RefundToAddress prototyp.Hash `json:"refundToAddress"`
	// Optional: constrain recovery token selection when multiple recoverable tokens exist.
	TokenAddress prototyp.Hash `json:"tokenAddress"`
}

type PrepareIntentRecoveryResponse struct {
	IntentID       prototyp.Hash         `json:"intentId"`
	IntentProtocol IntentProtocolVersion `json:"intentProtocol"`
	IntentAddress  prototyp.Hash         `json:"intentAddress"`
	ChainID        uint64                `json:"chainId"`
	// Recovery intent source: 'origin' or 'destination'.
	IntentSource   string                `json:"intentSource"`
	RecoveryTokens []*IntentTokenBalance `json:"recoveryTokens"`
	// Canonical backend payload to be signed.
	Payload interface{} `json:"payload"`
	// EIP-712 typed data corresponding to payload.
	TypedData   interface{}   `json:"typedData"`
	PayloadHash prototyp.Hash `json:"payloadHash"`
}

// BuildIntentRecoveryTransaction verifies the signed payload and returns executable tx data.
type BuildIntentRecoveryTransactionRequest struct {
	IntentID        prototyp.Hash `json:"intentId"`
	Payload         interface{}   `json:"payload"`
...
type BuildIntentRecoveryTransactionResponse struct {
	To             prototyp.Hash   `json:"to"`
	Data           string          `json:"data"`
	Value          prototyp.BigInt `json:"value"`
	ChainID        uint64          `json:"chainId"`
	IntentAddress  prototyp.Hash   `json:"intentAddress"`
	RequiresDeploy bool            `json:"requiresDeploy"`
	PayloadHash    prototyp.Hash   `json:"payloadHash"`
}
...
type GetEarnPoolsRequest struct {
	// Optional filter by chain IDs
	ChainIDs []uint64 `json:"chainIds"`
	// Optional filter by protocols (e.g., 'aave', 'morpho')
	Protocols []string `json:"protocols"`
	// Optional minimum TVL filter in USD
	MinTVL *float64 `json:"minTvl"`
	// Optional maximum APY filter in percentage
	MaxAPY *float64 `json:"maxApy"`
}

type GetEarnPoolsResponse struct {
	Pools     []*EarnPool `json:"pools"`
	Timestamp time.Time   `json:"timestamp"`
	Cached    bool        `json:"cached"`
}

type GetYieldProvidersRequest struct {
	Limit  *uint32 `json:"limit"`
	Offset *uint32 `json:"offset"`
}

type GetYieldProvidersResponse struct {
	Payload json.RawMessage `json:"payload"`
}

type GetYieldProviderRequest struct {
	ProviderId string `json:"providerId"`
}

type GetYieldProviderResponse struct {
	Payload json.RawMessage `json:"payload"`
}

type GetYieldNetworksRequest struct {
}

type GetYieldNetworksResponse struct {
	Payload json.RawMessage `json:"payload"`
}

type GetYieldMarketsRequest struct {
...
type GetYieldMarketsResponse struct {
	Payload json.RawMessage `json:"payload"`
}

type GetYieldMarketByIdRequest struct {
	MarketId string `json:"marketId"`
}

type GetYieldMarketByIdResponse struct {
	Payload json.RawMessage `json:"payload"`
}

type CreateYieldActionRequest struct {
	EarnMarketId      string       `json:"earnMarketId"`
	UserWalletAddress string       `json:"userWalletAddress"`
	Args              *interface{} `json:"args"`
}

type CreateYieldActionResponse struct {
	Payload json.RawMessage `json:"payload"`
}
...
func NewTrailsClient(addr string, client HTTPClient) TrailsClient {
	...
	urls := [36]string{
		...
		prefix + "GetIntentHistory",
		prefix + "AbortIntent",
		prefix + "PrepareIntentRecovery",
		prefix + "BuildIntentRecoveryTransaction",
		prefix + "GetChains",
		...
		prefix + "GetCountryList",
		prefix + "GetTrailsContracts",
		prefix + "GetProtocolContracts",
		prefix + "GetSupportedIntentProtocols",
		prefix + "GetDefaultIntentProtocol",
		prefix + "GetEarnPools",
		prefix + "YieldGetProviders",
		prefix + "YieldGetProvider",
		prefix + "YieldGetNetworks",
		prefix + "YieldGetMarkets",
		prefix + "YieldGetMarketById",
		prefix + "YieldCreateEnterAction",
		prefix + "YieldCreateExitAction",
		prefix + "GetFiatCurrencyList",
...
func (c *trailsClient) Ping(ctx context.Context) (string, error) {
	out := struct {
		Ret0 string `json:"version"`
	}{}
...
func (c *trailsClient) QuoteIntent(ctx context.Context, quoteIntentRequest QuoteIntentRequest) (*QuoteIntentResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[3], quoteIntentRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) CommitIntent(ctx context.Context, commitIntentRequest CommitIntentRequest) (*CommitIntentResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[4], commitIntentRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) ExecuteIntent(ctx context.Context, executeIntentRequest ExecuteIntentRequest) (*ExecuteIntentResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[5], executeIntentRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) RetryIntent(ctx context.Context, retryIntentRequest RetryIntentRequest) (*RetryIntentResponse, error) {
	out := struct {
		Ret0 *RetryIntentResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[6], retryIntentRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetIntentHistory(ctx context.Context, getIntentHistoryRequest GetIntentHistoryRequest) (*GetIntentHistoryResponse, error) {
	out := struct {
		Ret0 *GetIntentHistoryResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[11], getIntentHistoryRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) AbortIntent(ctx context.Context, abortIntentRequest AbortIntentRequest) (*AbortIntentResponse, error) {
	out := struct {
		Ret0 *AbortIntentResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[12], abortIntentRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) PrepareIntentRecovery(ctx context.Context, prepareIntentRecoveryRequest PrepareIntentRecoveryRequest) (*PrepareIntentRecoveryResponse, error) {
	out := struct {
		Ret0 *PrepareIntentRecoveryResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[13], prepareIntentRecoveryRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) BuildIntentRecoveryTransaction(ctx context.Context, buildIntentRecoveryTransactionRequest BuildIntentRecoveryTransactionRequest) (*BuildIntentRecoveryTransactionResponse, error) {
	out := struct {
		Ret0 *BuildIntentRecoveryTransactionResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[14], buildIntentRecoveryTransactionRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetChains(ctx context.Context, getChainsRequest GetChainsRequest) (*GetChainsResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[15], getChainsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetExactOutputRoutes(ctx context.Context, getExactOutputRoutesRequest GetExactOutputRoutesRequest) (*GetExactOutputRoutesResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[16], getExactOutputRoutesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetExactInputRoutes(ctx context.Context, getExactInputRoutesRequest GetExactInputRoutesRequest) (*GetExactInputRoutesResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[17], getExactInputRoutesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetTokenList(ctx context.Context, getTokenListRequest GetTokenListRequest) (*GetTokenListResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[18], getTokenListRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetTokenPrices(ctx context.Context, getTokenPricesRequest GetTokenPricesRequest) (*GetTokenPricesResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[19], getTokenPricesRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetExchangeRate(ctx context.Context, toCurrency string) (*ExchangeRate, error) {
	in := struct {
...
func (c *trailsClient) GetCountryList(ctx context.Context) ([]*Country, error) {
	out := struct {
		Ret0 []*Country `json:"countries"`
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[21], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetProtocolContracts(ctx context.Context, intentProtocol *IntentProtocolVersion) (*TrailsContracts, error) {
	in := struct {
		Arg0 *IntentProtocolVersion `json:"intentProtocol"`
	}{intentProtocol}
	out := struct {
		Ret0 *TrailsContracts `json:"TrailsContracts"`
	}{}
...
func (c *trailsClient) GetSupportedIntentProtocols(ctx context.Context) ([]IntentProtocolVersion, error) {
	out := struct {
		Ret0 []IntentProtocolVersion `json:"versions"`
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[24], nil, &out)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetDefaultIntentProtocol(ctx context.Context) (IntentProtocolVersion, error) {
	out := struct {
		Ret0 IntentProtocolVersion `json:"version"`
	}{}
...
func (c *trailsClient) GetEarnPools(ctx context.Context, getEarnPoolsRequest GetEarnPoolsRequest) (*GetEarnPoolsResponse, error) {
	out := struct {
		Ret0 *GetEarnPoolsResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[26], getEarnPoolsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) YieldGetProviders(ctx context.Context, getYieldProvidersRequest GetYieldProvidersRequest) (*GetYieldProvidersResponse, error) {
	out := struct {
		Ret0 *GetYieldProvidersResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[27], getYieldProvidersRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) YieldGetProvider(ctx context.Context, getYieldProviderRequest GetYieldProviderRequest) (*GetYieldProviderResponse, error) {
	out := struct {
		Ret0 *GetYieldProviderResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[28], getYieldProviderRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) YieldGetNetworks(ctx context.Context, getYieldNetworksRequest GetYieldNetworksRequest) (*GetYieldNetworksResponse, error) {
	out := struct {
		Ret0 *GetYieldNetworksResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[29], getYieldNetworksRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) YieldGetMarkets(ctx context.Context, getYieldMarketsRequest GetYieldMarketsRequest) (*GetYieldMarketsResponse, error) {
	out := struct {
		Ret0 *GetYieldMarketsResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[30], getYieldMarketsRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) YieldGetMarketById(ctx context.Context, getYieldMarketByIdRequest GetYieldMarketByIdRequest) (*GetYieldMarketByIdResponse, error) {
	out := struct {
		Ret0 *GetYieldMarketByIdResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[31], getYieldMarketByIdRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) YieldCreateEnterAction(ctx context.Context, createYieldActionRequest CreateYieldActionRequest) (*CreateYieldActionResponse, error) {
	out := struct {
		Ret0 *CreateYieldActionResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[32], createYieldActionRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) YieldCreateExitAction(ctx context.Context, createYieldActionRequest CreateYieldActionRequest) (*CreateYieldActionResponse, error) {
	out := struct {
		Ret0 *CreateYieldActionResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[33], createYieldActionRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
func (c *trailsClient) GetFiatCurrencyList(ctx context.Context) ([]*FiatCurrency, error) {
	out := struct {
		Ret0 []*FiatCurrency `json:"currencies"`
	}{}
...
func (c *trailsClient) GetIntentTransactionHistory(ctx context.Context, getIntentTransactionHistoryRequest GetIntentTransactionHistoryRequest) (*GetIntentTransactionHistoryResponse, error) {
	...
	resp, err := doHTTPRequest(ctx, c.client, c.urls[35], getIntentTransactionHistoryRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
var (
	...
	ErrHighPriceImpact    = WebRPCError{Code: 7002, Name: "HighPriceImpact", Message: "Quote unavailable due to high price impact", HTTPStatus: 422}
	...
	ErrChainNodeHealth    = WebRPCError{Code: 9001, Name: "ChainNodeHealth", Message: "Intent quote is unavailable due to interrupted chain node access", HTTPStatus: 503}
)

const WebrpcHeader = "Webrpc"

const WebrpcHeaderValue = "webrpc@v0.36.1;gen-golang@v0.27.0;trails-api@v1-26.4.21-349a351e"
