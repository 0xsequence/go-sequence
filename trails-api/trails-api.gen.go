// trails-api v1-25.12.5+5cd45de0 bae02d830b885452984d8a9d27273d06691354a4
// --
...
func WebRPCSchemaVersion() string {
	return "v1-25.12.5+5cd45de0"
}

// Schema hash generated from your RIDL schema
func WebRPCSchemaHash() string {
	return "bae02d830b885452984d8a9d27273d06691354a4"
}
...
type TrailsClient interface {
	...
	RequeueIntent(ctx context.Context, requeueIntentRequest RequeueIntentRequest) (*RequeueIntentResponse, error)
...
// RequeueIntent allows admins to requeue stuck/aborted intent transactions.
type RequeueIntentRequest struct {
	IntentID prototyp.Hash `json:"intentId"`
}

type RequeueIntentResponse struct {
	IntentID             prototyp.Hash `json:"intentId"`
	RequeuedTransactions int           `json:"requeuedTransactions"`
	Status               IntentStatus  `json:"status"`
}
...
func (c *trailsClient) RequeueIntent(ctx context.Context, requeueIntentRequest RequeueIntentRequest) (*RequeueIntentResponse, error) {
	out := struct {
		Ret0 *RequeueIntentResponse
	}{}

	resp, err := doHTTPRequest(ctx, c.client, c.urls[12], requeueIntentRequest, &out.Ret0)
	if resp != nil {
		cerr := resp.Body.Close()
		if err == nil && cerr != nil {
			err = ErrWebrpcRequestFailed.WithCausef("failed to close response body: %w", cerr)
...
const WebrpcHeaderValue = "webrpc@v0.31.2;gen-golang@v0.23.3;trails-api@v1-25.12.5+5cd45de0"
