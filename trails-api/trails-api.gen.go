...
func WebRPCSchemaHash() string {
	return "005a369b19dfebdb65dde9e0e5ddac91bfc04c44"
}
...
const (
	...
	TransactionStatus_MINING    TransactionStatus = 3
...
type IntentPrecondition struct {
	// TODO: value should be erc20MinAllowance to match 7795
...
type IntentReceipt struct {
	...
	DepositTransactionHash   prototyp.Hash     `json:"depositTransactionHash" db:"deposit_txn_hash"`
	DepositTransactionStatus TransactionStatus `json:"depositTransactionStatus" db:"deposit_txn_status"`
...
type IntentTransaction struct {
	...
	Calldata        prototyp.Hash       `json:"calldata" db:"calldata"`
	MetaTxnID       prototyp.Hash       `json:"metaTxnId" db:"meta_txn_id"`
	MetaTxnFeeQuote string              `json:"metaTxnFeeQuote" db:"fee_quote"`
	Preconditions   *IntentPrecondition `json:"preconditions" db:"preconditions"`
...
type IntentSummary struct {
	...
	OriginChainID            uint64         `json:"originChainId"`
	OriginChainMetadata      *ChainMetadata `json:"originChainMetadata"`
	DestinationChainID       uint64         `json:"destinationChainId"`
	DestinationChainMetadata *ChainMetadata `json:"destinationChainMetadata"`
